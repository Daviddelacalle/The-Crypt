...
Hexadecimal [16-Bits]
   ...
   4683                      33 _main::
                             ...
                             36 
   0000                      37     init
   4683 CD 5C 4A      [17]    1     call cpct_disableFirmware_asm
   4686 0E 00         [ 7]    2     ld    c, #0
   4688 CD 47 4A      [17]    3     call cpct_setVideoMode_asm
                              4 
   468B 21 44 44      [10]    5     ld hl, #_g_palette
   468E 11 10 00      [10]    6     ld de, #16
   4691 CD 85 49      [17]    7     call cpct_setPalette_asm
                             38 
                             39 
   ...
   4694                      42     loop_load::
                             43 
   4694 CD 2F 46      [17]   44      call load_control
                             45 
   4697 CD 6C 49      [17]   46      call drawMap
                             47     ;; Comienza el bucle del juego
   469A                      48     loop:
                             49 
   469A CD 2C 45      [17]   50         call bullet_inputs
                             51 
                             52         ;; UPDEIT
   469D CD 09 47      [17]   53         call enemy_update_ALL
   46A0 CD 6B 44      [17]   54         call hero_update
   46A3 CD 20 45      [17]   55         call bullet_update
                             56 
...
Hexadecimal [16-Bits]
   ...
   46A6 CD 54 4A      [17]   57         call cpct_waitVSYNC_asm
                             58 
                             59         ;; CLIAR
   46A9 CD 03 47      [17]   60         call enemy_clear_ALL
   46AC CD 26 45      [17]   61         call bullet_clear
   46AF CD 4E 49      [17]   62         call obs_clear
   46B2 CD 64 44      [17]   63         call hero_clear
                             64 
                             65         ;; DRO
   46B5 CD FD 46      [17]   66         call enemy_draw_ALL
   46B8 CD 1A 45      [17]   67         call bullet_draw
   46BB CD 47 49      [17]   68         call obs_draw
   46BE CD 5D 44      [17]   69         call hero_draw
                             70 
   46C1 18 D7         [12]   71 jr loop
