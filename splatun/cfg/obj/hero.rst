...
Hexadecimal [16-Bits]
   ...
   4461 C3 3C 46      [10]   34     jp dw_draw
                             35 
                             36 
   4464                      37 hero_clear::
   4464 DD 21 54 44   [14]   38     ld ix, #hero
   4468 C3 71 46      [10]   39     jp dw_clear
                             40 
   446B                      41 hero_update::
   ...
   4473 DD 36 05 00   [19]   44     ld e_vy(ix), #0
                             45 
                             46 
   4477 CD 86 4B      [17]   47     call cpct_scanKeyboard_asm
   447A 21 08 20      [10]   48     ld hl, #Key_A                   ;; Comprueba tecla A
   447D CD 98 49      [17]   49     call cpct_isKeyPressed_asm
...
Hexadecimal [16-Bits]
   ...
   4487 18 0D         [12]   54         jr d_no_pulsada             ;; Si se ha pulsado no compruebes la tecla D
                             55 
   4489                      56     a_no_pulsada:
                             57 
   4489 21 07 20      [10]   58         ld hl, #Key_D               ;; Comprueba tecla D
   448C CD 98 49      [17]   59         call cpct_isKeyPressed_asm
   448F 28 05         [12]   60         jr z, d_no_pulsada
   4491 06 01         [ 7]   61             ld b, #1
                             62             ;call move_camera
   4493 DD 70 04      [19]   63             ld e_vx(ix), b
                             64 
   4496                      65     d_no_pulsada:
                             66 
   4496 21 07 08      [10]   67         ld hl, #Key_W
   4499 CD 98 49      [17]   68         call cpct_isKeyPressed_asm
   449C 28 0C         [12]   69         jr z, w_no_pulsada
   449E 06 FE         [ 7]   70             ld b, #-2
                             71             ;call move_camera
   44A0 DD 70 05      [19]   72             ld e_vy(ix), b
   44A3 18 17         [12]   73             jr s_no_pulsada
   44A5 3E 00         [ 7]   74             ld a, #0
   44A7 CD 55 49      [17]   75             call inc_map_y
                             76 
   44AA                      77     w_no_pulsada:
                             78 
   44AA 21 07 10      [10]   79         ld hl, #Key_S
   44AD CD 98 49      [17]   80         call cpct_isKeyPressed_asm
   44B0 28 0A         [12]   81         jr z, s_no_pulsada
   44B2 06 02         [ 7]   82             ld b, #2
                             83             ;call move_camera
   44B4 DD 70 05      [19]   84             ld e_vy(ix), b
   44B7 3E 01         [ 7]   85             ld a, #1
   44B9 CD 55 49      [17]   86             call inc_map_y
                             87 
   44BC                      88     s_no_pulsada:
                             89 
                             90 
                             91 
   44BC C9            [10]   92 ret
                             ...
                             97 ;; DESTRUYE: A, B
                             98 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   44BD                      99 hero_get_position::
   44BD 3A 55 44      [13]  100    ld    a,    (hero_y)
   44C0 47            [ 4]  101    ld    b,    a
   44C1 3A 54 44      [13]  102    ld    a,    (hero_x)
   44C4 C9            [10]  103    ret
                            104 
                            105 ;;======================================================================
