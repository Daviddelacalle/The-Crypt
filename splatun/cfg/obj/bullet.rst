...
Hexadecimal [16-Bits]
                             ...
                             19 ;;======================================================================
                             20 ;;======================================================================
                     0005    21 vector_size = 5
                     000A    22 bullet_size = 10                    ;; Debe de ser parametrizado, CUANTO ANTES!
                             23 
   44C5 00 00                24 vector_index:  .dw #0x0000
   44C7                      25 vector_init:                        ;; Marca el inicio de vector_bullets
   44C7                      26 DefineNBullets vector_bullets, vector_size
                     0000     1    _c = 0
                              2    .rept vector_size
                              3       DefineBulletDefault vector_bullets, \_c
                              4       _c = _c + 1
                              5    .endm
   44C7                       1       DefineBulletDefault vector_bullets, \_c
   ...
   44C7 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   44C9 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   44CB                       3    DefineMovableEnt  vector_bullets0_mv, 0, 0                             ;;'
   0006                       1 vector_bullets0_mv:
   44CB 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   44CD 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   44CE 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   44CF FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0001     2       _c = _c + 1
   44D1                       1       DefineBulletDefault vector_bullets, \_c
   44D1                       1    DefineBullet vector_bullets1, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   000C                       1 vector_bullets1:
   000C                       2    DefineDrawableEnt vector_bullets1_dw, 0xAA, 0, 0, 0                       ;;'
   000C                       1 vector_bullets1_dw:
   44D1 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   44D3 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   44D5                       3    DefineMovableEnt  vector_bullets1_mv, 0, 0                             ;;'
   0010                       1 vector_bullets1_mv:
   44D5 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   44D7 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   44D8 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   44D9 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0002     2       _c = _c + 1
   44DB                       1       DefineBulletDefault vector_bullets, \_c
   44DB                       1    DefineBullet vector_bullets2, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   0016                       1 vector_bullets2:
   0016                       2    DefineDrawableEnt vector_bullets2_dw, 0xAA, 0, 0, 0                       ;;'
   0016                       1 vector_bullets2_dw:
   44DB AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 54.
Hexadecimal [16-Bits]



   44DD 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   44DF                       3    DefineMovableEnt  vector_bullets2_mv, 0, 0                             ;;'
   001A                       1 vector_bullets2_mv:
   44DF 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   44E1 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   44E2 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   44E3 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0003     2       _c = _c + 1
   44E5                       1       DefineBulletDefault vector_bullets, \_c
   44E5                       1    DefineBullet vector_bullets3, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   0020                       1 vector_bullets3:
   0020                       2    DefineDrawableEnt vector_bullets3_dw, 0xAA, 0, 0, 0                       ;;'
   0020                       1 vector_bullets3_dw:
   44E5 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   44E7 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   44E9                       3    DefineMovableEnt  vector_bullets3_mv, 0, 0                             ;;'
   0024                       1 vector_bullets3_mv:
   44E9 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   44EB 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   44EC 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   44ED FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0004     2       _c = _c + 1
   44EF                       1       DefineBulletDefault vector_bullets, \_c
   44EF                       1    DefineBullet vector_bullets4, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   002A                       1 vector_bullets4:
   002A                       2    DefineDrawableEnt vector_bullets4_dw, 0xAA, 0, 0, 0                       ;;'
   002A                       1 vector_bullets4_dw:
   44EF AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   44F1 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   44F3                       3    DefineMovableEnt  vector_bullets4_mv, 0, 0                             ;;'
   002E                       1 vector_bullets4_mv:
   44F3 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   44F5 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   44F6 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   44F7 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0005     2       _c = _c + 1
   44F9                      27 DefineBullet bullet_copy 0xFF, 0xFF, #1, #4, 0, 4, #0x0F, #20, bullet_checkUpdate
   44F9                       1 bullet_copy:
   0034                       2    DefineDrawableEnt bullet_copy_dw, 0xFF, 0xFF, #1, #4                       ;;'
   0034                       1 bullet_copy_dw:
   44F9 FF FF                 2    .db   0xFF, 0xFF      ;; Posicion    (x,y)
   44FB 01 04                 3    .db   #1, #4      ;; Dimensiones (w,h)
   44FD                       3    DefineMovableEnt  bullet_copy_mv, 0, 4                             ;;'
   0038                       1 bullet_copy_mv:
   44FD 00 04                 2    .db   0, 4    ;; Variables de la velocidad
   44FF 0F                    4    .db   #0x0F        ;; Color / Sprite (cuando haya)
   4500 14                    5    .db   #20      ;; _alive>0? Se actualiza/dibuja
   4501 10 46                 6    .dw   bullet_checkUpdate        ;; Funcion de update
                              7 
...
Hexadecimal [16-Bits]
                              ...
                              8 ;; Saber tamanyo de entidad bala
                             28 
   4503 00                   29 save_a:        .db #0x00            ;; Guarda el valor de A
   4504 00                   30 flag_init:     .db #0x00            ;; if(flag_init==1) Hay una entidad bullet que se ha inicializado
                             31 
   4505                      32 vector_keys:
   4505 00 01 68 45          33    .dw #Key_CursorUp,      #keyUp_ON      ;; Flecha de arriba
   4509 00 04 6E 45          34    .dw #Key_CursorDown,    #keyDown_ON    ;; Flecha de abajo
   450D 00 02 74 45          35    .dw #Key_CursorRight,   #keyRight_ON   ;; Flecha de derecha
   4511 01 01 7A 45          36    .dw #Key_CursorLeft,    #keyLeft_ON    ;; Flecha de izquierda
   4515 FF                   37    .db #0xFF                              ;; Fin
   4516 00                   38 flag_vx:       .db #0
   4517 00                   39 flag_vy:       .db #0
   4518 00                   40 flag_shoot:    .db #0                     ;; Solo habra un disparo por cada vez que se pulse cada tecla
   4519 00                   41 flag_key:      .db #0                     ;; Si ha pulsado alguna de las 4 teclas de disparo, flag_key = 1
                             42 
                             43 ;;======================================================================
                             44 ;;======================================================================
                             45 ;; FUNCIONES PUBLICAS
                             46 ;;======================================================================
                             47 ;;======================================================================
                             48 
                             49 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             50 ;; DIBUJADO DE LA ENTIDAD BULLET
                             51 ;; _______________________
                             52 ;; DESTRUYE: HL
                             53 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   451A                      54 bullet_draw::
   451A 21 C8 45      [10]   55    ld    hl,   #bullet_checkDraw
   451D C3 AB 45      [10]   56    jp    bullet_search                 ;; Llamada al bucle
                             57 
                             58 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             59 ;; UPDATE DE TODAS LAS BALAS INICIALIZADAS
                             60 ;; _______________________
                             61 ;; DESTRUYE: HL
                             62 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4520                      63 bullet_update::
   4520 21 03 46      [10]   64    ld    hl,   #bullet_searchUpdate
   4523 C3 AB 45      [10]   65    jp    bullet_search                 ;; Llamada al bucle
                             66 
                             67 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             68 ;; CLEAR
                             ...
                             70 ;; DESTRUYE: HL
                             71 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4526                      72 bullet_clear::
   4526 21 26 46      [10]   73    ld    hl,   #bullet_checkClear
   4529 C3 AB 45      [10]   74    jp    bullet_search
                             75 
                             76 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             77 ;; COMPRUEBA LOS INPUTS
                             78 ;; _______________________
                             79 ;; DESTRUYE: AF, BC, DE, HL, IX
                             80 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   452C                      81 bullet_inputs::
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 56.
Hexadecimal [16-Bits]



   452C CD 86 4B      [17]   82    call cpct_scanKeyboard_asm
                             83 
                             84    ;; ¡¡¡¡¡¡¡¡HAY QUE ARREGLAR ESTO!!!!!!!!
                             85    ;;ld    hl,   #vector_keys         ;; IX apunta al vector de codigos de teclado
                             86    ;;loop:
                             87    ;;   ld     a,   (hl)              ;; A = 0(ix)
                             88    ;;   cp  #0xFF                     ;; El final del vector lo marca un FF
                             89    ;;   jr     z,   end_loop          ;; Sale del bucle en caso que A == FF
                             90    ;;      push  hl
                             91    ;;      call  cpct_isKeyPressed_asm   ;; CPC
                             92    ;;      pop   hl
                             93    ;;   inc   hl                      ;; HL ++
                             94    ;;   inc   hl                      ;; HL ++
                             95    ;;   ld     c,   (hl)              ;; Guardo en BC el valor al que apunta HL
                             96    ;;   inc   hl                      ;; HL ++
                             97    ;;   ld     b,   (hl)              ;; Guardo en BC el valor al que apunta HL
                             98    ;;   inc   hl                      ;; HL ++
                             99    ;;   ld (k_custom), bc             ;;
                            100    ;;      k_custom = . + 1           ;; CARGAR LA FUNCION PROPIA DE CADA KEY
                            101    ;;      call nz, (0x0000)          ;;
                            102    ;;   jr    loop                    ;; Vuelta arriba
                            103    ;;end_loop:
                            104 
                            105    ;; Bucle mas costoso
   452F DD 21 05 45   [14]  106    ld    ix,   #vector_keys         ;; IX apunta al vector de codigos de teclado
   4533                     107    loop:
   4533 DD 7E 00      [19]  108       ld     a,   0(ix)             ;; A = 0(ix)
   4536 FE FF         [ 7]  109       cp  #0xFF                     ;; El final del vector lo marca un FF
   4538 28 23         [12]  110       jr     z,   end_loop          ;; Sale del bucle en caso que A == FF
                            111 
   453A DD 6E 00      [19]  112       ld     l,   0(ix)             ;; Cargo el codigo de la tecla en HL
   453D DD 66 01      [19]  113       ld     h,   1(ix)             ;; Cargo el codigo de la tecla en HL
   4540 CD 98 49      [17]  114       call cpct_isKeyPressed_asm    ;; CPC
   4543 DD 6E 02      [19]  115       ld     l,   2(ix)             ;; Cargo el codigo de la funcion en HL
   4546 DD 66 03      [19]  116       ld     h,   3(ix)             ;; Cargo el codigo de la funcion en HL
   4549 22 4D 45      [16]  117       ld (k_custom), hl
                     0088   118          k_custom = . + 1
   454C C4 00 00      [17]  119          call nz, (0x0000)          ;; CUSTOM
   454F 28 05         [12]  120          jr z, keep_looping         ;; Si no se ha pulsado ninguna tecla, pasa
   4551 3E 01         [ 7]  121             ld a, #1
   4553 32 19 45      [13]  122             ld (flag_key), a        ;; flag_key = ON
   4556                     123       keep_looping:
   4556 11 04 00      [10]  124       ld    de,   #4                ;; Sumo 4 para ir a la siguiente tecla
   4559 DD 19         [15]  125       add   ix,   de                ;; IX + 4
   455B 18 D6         [12]  126       jr    loop
   455D                     127    end_loop:
                            128 ;
                            129 ;   ld    ix,   #vector_keys         ;; IX apunta al vector de codigos de teclado
                            130 ;
                            131 ;
                            132 ;   ld de, #vector_keys
                            133 ;   ex de, hl
                            134 ;   ld hl, (de)
                            135 ;   loop:
                            136 ;      call cpct_isKeyPressed_asm    ;; CPC
...
Hexadecimal [16-Bits]
                            ...
                            140 ;      ld (k_custom), hl
                            141 ;         k_custom = . + 1
                            142 ;         call nz, (0x0000)          ;; CUSTOM
                            143 ;         jr z, keep_looping         ;; Si no se ha pulsado ninguna tecla, pasa
                            144 ;            ld a, #1
                            145 ;            ld (flag_key), a        ;; flag_key = ON
                            146 ;      keep_looping:
                            147 ;      inc hl
                            148 ;      inc hl
                            149 ;      ex de, hl
                            ...
                            151 ;
                            152 ;      ld     a,     l            ;; A = 0(ix)
                            153 ;      cp  #0xFF                     ;; El final del vector lo marca un FF
                            154 ;      jr     z,   end_loop          ;; Sale del bucle en caso que A == FF
                            155 ;
                            156 ;  jr    loop
                            157 ;
                            158 ;
                            159 ;   end_loop:
                            160 
   455D 3A 19 45      [13]  161    ld a, (flag_key)                 ;; A = flag_key
   4560 FE 00         [ 7]  162    cp #0                            ;; Si A == 1: SE HA PULSADO ALGUNA DE LAS 4 TECLAS DE DISPARO
   4562 C2 8C 45      [10]  163    jp nz, bullet_init               ;; Si A == 0: NO SE HA PULSADO NINGUNA TECLA DE DISPARO
                            164 
   4565 C3 86 45      [10]  165    jp flag_shoot_off                ;; Volver flag_shoot a 0
                            166 
                            167 ;;======================================================================
                            168 ;;======================================================================
                            169 ;; FUNCIONES PRIVADAS
                            170 ;;======================================================================
                            171 ;;======================================================================
                            172 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            173 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN Y
                            174 ;; _______________________
                            175 ;; DESTRUYE: A
                            176 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4568                     177 keyUp_ON:
   4568 3E FF         [ 7]  178    ld a, #-1
   456A 32 17 45      [13]  179    ld (flag_vy), a
   456D C9            [10]  180    ret
                            181 
                            182 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            183 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN Y
                            184 ;; _______________________
                            185 ;; DESTRUYE: A
                            186 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   456E                     187 keyDown_ON:
   456E 3E 01         [ 7]  188    ld a, #1
   4570 32 17 45      [13]  189    ld (flag_vy), a
   4573 C9            [10]  190    ret
                            191 
...
Hexadecimal [16-Bits]
                            ...
                            192 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            193 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN X
                            194 ;; _______________________
                            195 ;; DESTRUYE: A
                            196 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4574                     197 keyRight_ON:
   4574 3E 01         [ 7]  198    ld a, #1
   4576 32 16 45      [13]  199    ld (flag_vx), a
   4579 C9            [10]  200    ret
                            201 
                            202 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            203 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN X
                            204 ;; _______________________
                            205 ;; DESTRUYE: A
                            206 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   457A                     207 keyLeft_ON:
   457A 3E FF         [ 7]  208    ld a, #-1
   457C 32 16 45      [13]  209    ld (flag_vx), a
   457F C9            [10]  210    ret
                            211 
                            212 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            213 ;; CAMBIA flag_shoot A 1 E IMPIDE DISPARAR MAS, A MENOS QUE SUELTES LA TECLA
                            214 ;; _______________________
                            215 ;; DESTRUYE: A
                            216 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4580                     217 flag_shoot_on:
   4580 3E 01         [ 7]  218    ld a, #1
   4582 32 18 45      [13]  219    ld (flag_shoot), a
   4585 C9            [10]  220    ret
                            221 
                            222 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            223 ;; CAMBIA flag_shoot A 0 Y PERMITE DISPARAR MAS VECES AL PULSAR
                            224 ;; _______________________
                            225 ;; DESTRUYE: A
                            226 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4586                     227 flag_shoot_off:
   4586 3E 00         [ 7]  228    ld a, #0
   4588 32 18 45      [13]  229    ld (flag_shoot), a
   458B C9            [10]  230    ret
                            231 
                            232 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            233 ;; INICIALIZA UNA ENTIDAD BULLET
                            234 ;; _______________________
                            235 ;; DESTRUYE: HL, A
                            236 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   458C                     237 bullet_init:
                            238    ;; Comprueba que solo se pueda disparar una vez por cada pulsacion de tecla
   458C 3A 18 45      [13]  239    ld a, (flag_shoot)               ;; A = flag_shoot
   458F FE 00         [ 7]  240    cp #0                            ;; A - 0 = A
   4591 20 09         [12]  241    jr nz, bullet_init_end           ;; Si flag_shoot == 1, vuelve
                            242 
   4593 21 D1 45      [10]  243    ld    hl,   #bullet_checkInit
   4596 CD AB 45      [17]  244    call  bullet_search              ;; Llamada al bucle
   4599 CD 80 45      [17]  245    call  flag_shoot_on              ;; Si llega aqui, es que se ha pulsado alguna tecla, entonces flag = ON
                            246 
...
Hexadecimal [16-Bits]
   ...
   459C                     247    bullet_init_end:
                            248    ;; Reset de los flags
   459C 3E 00         [ 7]  249    ld     a,   #0
   459E 32 04 45      [13]  250       ld (flag_init), a
   45A1 32 16 45      [13]  251       ld   (flag_vx), a
   45A4 32 17 45      [13]  252       ld   (flag_vy), a
   45A7 32 19 45      [13]  253       ld  (flag_key), a
   45AA C9            [10]  254    ret
                            255 
                            256 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            257 ;; RECORRE vector_bullets
                            258 ;; _______________________
                            259 ;; ENTRADA:    HL -> Puntero a funcion custom
                            260 ;; DESTRUYE:   A, DE, IX
                            261 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   45AB                     262 bullet_search:
   45AB 3E 00         [ 7]  263    ld     a,   #0                ;; Cargo en A el valor inicial 0
   45AD DD 21 C7 44   [14]  264    ld    ix,   #vector_init      ;; IX apunta al inicio de vector_bullets (a la primera entidad)
   45B1 22 B8 45      [16]  265    ld    (f_custom), hl          ;; Cargo en el call de abajo la funcion a la que quiero llamar en cada momento determinado
   45B4                     266    search_loop:
   45B4 32 03 45      [13]  267       ld (save_a),  a            ;; Guardo el valor de A, porque la llamada a la funcion puede destruirlo
                            268 
                     00F3   269       f_custom = . +1                  ;; . apunta a 'call' y con el '+1' apunta a '(0x0000)' -> (valor arbitrario, puesto que siempre va a cambiar)
   45B7 CD 00 00      [17]  270       call (0x0000)                    ;; LLAMADA A FUNCION PERSONALIZABLE
                            271 
   45BA 11 0A 00      [10]  272       ld    de,   #bullet_size         ;; Cargo en DE el tamanyo de la entidad bullet para despues sumarlo a HL
   45BD DD 19         [15]  273       add   ix,   de                   ;; IX + DE = Apunta a la siguiente entidad bullet
                            274 
   45BF 3A 03 45      [13]  275       ld     a,   (save_a)             ;; Recupero el valor de a
   45C2 3C            [ 4]  276       inc    a                         ;; A++
   45C3 FE 05         [ 7]  277    cp #vector_size
   45C5 20 ED         [12]  278    jr nz, search_loop
   45C7 C9            [10]  279    ret
                            280 
                            281 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            282 ;; COMPROBAR SI EN LA ENTIDAD BULLET alive > 0
                            283 ;; _______________________
                            284 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            285 ;; DESTRUYE:   A
                            286 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   45C8                     287 bullet_checkDraw:
   45C8 DD 7E 07      [19]  288    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   45CB FE 00         [ 7]  289    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
   45CD C4 3C 46      [17]  290    call  nz,   #dw_draw          ;; Llama a la funcion de dibujado
   45D0 C9            [10]  291    ret
                            292 
                            293 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            294 ;; COMPROBAR SI EN LA ENTIDAD BULLET alive = 0
                            295 ;; _______________________
                            296 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            297 ;; DESTRUYE:   A, HL, DE, BC
                            298 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   45D1                     299 bullet_checkInit:
   45D1 3A 04 45      [13]  300    ld     a,   (flag_init)       ;; Si no se ha iniciado ninguna entidad bullet A==0
   45D4 FE 00         [ 7]  301    cp    #0
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 60.
Hexadecimal [16-Bits]



   45D6 C0            [11]  302    ret   nz                      ;; Si es 1 (1!=0), vuelve y no inicia mas entidades
                            303 
                            304    ;; Comprueba el atributo alive
   45D7 DD 7E 07      [19]  305    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   45DA FE 00         [ 7]  306    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1 -> INICIALIZO
   45DC C0            [11]  307    ret   nz                      ;; Si ya esta inicializada, hago ret
                            308 
                            309    ;; REALIZA UNA COPIA DE LA ENTIDAD POR DEFECTO
   45DD DD E5         [15]  310    push  ix                      ;; Guardo IX en la pila
   45DF D1            [10]  311    pop   de                      ;; Entidad DESTINO
   45E0 21 F9 44      [10]  312    ld    hl,   #bullet_copy      ;; Entidad ORIGEN
   45E3 01 0A 00      [10]  313    ld    bc,   #bullet_size      ;; Tamanyo de la entidad
   45E6 ED B0         [21]  314    ldir
                            315 
                            316    ;; Si debo cambiar algo de la entidad, aqui
   45E8 CD BD 44      [17]  317    call hero_get_position        ;; A = hero_x // B = hero_y
   45EB DD 77 00      [19]  318    ld    b_x(ix), a              ;; Asigno X
   45EE DD 70 01      [19]  319    ld    b_y(ix), b              ;; Asigno Y
                            320 
   45F1 3A 16 45      [13]  321    ld    a,    (flag_vx)         ;;
   45F4 DD 77 04      [19]  322    ld    b_vx(ix), a             ;; Asigno VX
   45F7 3A 17 45      [13]  323    ld    a,    (flag_vy)         ;;
   45FA DD 77 05      [19]  324    ld    b_vy(ix), a             ;; Asigno VX
                            325 
   45FD 3E 01         [ 7]  326    ld     a,   #1                ;; flag_init = 1
   45FF 32 04 45      [13]  327    ld (flag_init), a             ;; YA NO SE PODRA INICIALIZAR NINGUNA ENTIDAD MAS
                            328                                  ;;   EN EL RECORRIDO DE ESTE BUCLE, AHORA MISMO
   4602 C9            [10]  329    ret
                            330 
                            331 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            332 ;; LLAMA A CADA FUNCION DE ACTUALIZACION DE CADA ENTIDAD
                            333 ;; _______________________
                            334 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            335 ;; DESTRUYE:   HL, A
                            336 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4603                     337 bullet_searchUpdate:
   4603 DD 7E 07      [19]  338    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   4606 FE 00         [ 7]  339    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
   4608 C8            [11]  340    ret    z                      ;; Si no se ha inicialiado, poco podemos hacer
                            341 
   4609 DD 6E 08      [19]  342    ld l, b_up_l(ix)           ;; Carga el byte bajo en L
   460C DD 66 09      [19]  343    ld h, b_up_h(ix)           ;; Carga el byte alto en H
   460F E9            [ 4]  344    jp (hl)                    ;; Llama a la funcion propia de cada entidad
                            345 
                            346 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            347 ;; COMPROBAR SI EN LA ENTIDAD BULLET alive > 0 Y LO ACTUALIZO
                            348 ;; _______________________
                            349 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            350 ;; DESTRUYE:   A
                            351 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4610                     352 bullet_checkUpdate:
                            353    ;; UPDATE ALIVE
   4610 DD 35 07      [23]  354    dec   b_alive(ix)     ;; Decrementar el valor de alive y si llega a 1 matar la bala -> alive = 0
                            355 
                            356    ;; UPDATE POSICION
...
Hexadecimal [16-Bits]
   ...
   4613 DD 7E 00      [19]  357    ld     a,   b_x(ix)           ;; Cargo en A la posicion en X
   4616 DD 86 04      [19]  358    add b_vx(ix)                  ;; Le aumento la velocidad en X
   4619 DD 77 00      [19]  359    ld  b_x(ix), a                ;; Guardo el dato actualizado
                            360 
   461C DD 7E 01      [19]  361    ld     a,   b_y(ix)           ;; Cargo en A la posicion en Y
   461F DD 86 05      [19]  362    add b_vy(ix)                  ;; Le aumento la velocidad en Y
   4622 DD 77 01      [19]  363    ld  b_y(ix), a                ;; Guardo el dato actualizado
                            364 
   4625 C9            [10]  365    ret
                            366 
                            367 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            368 ;; CAMBIA EL COLOR DE LA BALA AL DEL FONDO (SI NO HAY SPRITES)
                            369 ;; _______________________
                            370 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            371 ;; DESTRUYE:
                            372 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4626                     373 bullet_checkClear:
   4626 DD 7E 07      [19]  374     ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   4629 FE 00         [ 7]  375     cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
   462B C4 71 46      [17]  376     call nz, dw_clear
   462E C9            [10]  377 ret
                            378 
                            379 
                            380 
