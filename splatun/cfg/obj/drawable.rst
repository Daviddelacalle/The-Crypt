...
Hexadecimal [16-Bits]
   ...
   463C                      32 dw_draw::
                             ...
                             34 
   463C 11 00 C0      [10]   35    ld    de,   #0xC000                  ;; Apunta al inicio de la memoria de video
                             36 
   463F FE FF         [ 7]   37    cp #0xFF                             ;; Compruebo si he llamado a draw desde el clear para no sumar la velocidad
   4641 20 09         [12]   38    jr nz, normal_dro                    ;; Si no he llamado desde el clear, salto
                             39     ;;Llamada desde el clear
   4643 DD 7E 00      [19]   40        ld a, e_x(ix)                    ;; Cargo la posicion X, que es del frame anterior
   4646 4F            [ 4]   41        ld     c,   a                    ;; x  [0-79]
   4647 DD 7E 01      [19]   42        ld a, e_y(ix)                    ;; Cargo la posicion Y, tambien del frame anterior
   464A 18 13         [12]   43        jr dro                           ;; Salto a dro, para ahorrar un par de bytes, ya que a partir de ahi, el codigo es igual
                             44 
   464C                      45    normal_dro:                          ;; Dro normal
   464C DD 7E 00      [19]   46    ld a, e_x(ix)                        ;; Consigue la posicion del jugador
   464F DD 86 04      [19]   47        add e_vx(ix)                     ;; Le sumo la velocidad, lo hago aqui en vez del update de jugador para evitar restar en clear
   4652 DD 77 00      [19]   48        ld e_x(ix), a                    ;; Lo guardo en su registro
   4655 4F            [ 4]   49    ld     c,   a                        ;; x  [0-79]
                             50 
   4656 DD 7E 01      [19]   51    ld a, e_y(ix)                        ;; Repito para Y
   4659 DD 86 05      [19]   52        add e_vy(ix)
   465C DD 77 01      [19]   53        ld e_y(ix), a
                             54 
   465F                      55        dro:
                             56        ;add a                            ;; Antes de guadarlo en el registro b para dibujar lo duplico, para tener más rango de scroll [-255, 255]
   465F 47            [ 4]   57    ld     b,   a                        ;; y  [0-199]
                             58 
   4660 CD 6A 4B      [17]   59    call cpct_getScreenPtr_asm
                             60    ;; SIN SPRITE
   4663 EB            [ 4]   61    ex    de,   hl          ;; Apunta a la posicion x,y
   4664 DD 7E 06      [19]   62    ld     a,   e_col(ix)    ;; Código de color
   4667 DD 4E 02      [19]   63    ld     c,   e_w(ix)      ;; Ancho
   466A DD 46 03      [19]   64    ld     b,   e_h(ix)      ;; Alto
   466D CD 91 4A      [17]   65    call cpct_drawSolidBox_asm
                             66 
...
Hexadecimal [16-Bits]
   ...
   4670 C9            [10]   73 ret
                             ...
                             77 ;==================================
   4671                      78 dw_clear::
   4671 DD 7E 06      [19]   79     ld  a, e_col(ix)
   4674 08            [ 4]   80     ex af, af'            ;'
                             81 
   4675 DD 36 06 00   [19]   82     ld  e_col(ix), #0
   4679 3E FF         [ 7]   83     ld a, #0xFF
   467B CD 3C 46      [17]   84     call dw_draw
   467E 08            [ 4]   85     ex af, af'            ;'
   467F DD 77 06      [19]   86     ld e_col(ix), a
   4682 C9            [10]   87  ret
                             88 
                             89 ;;======================================================================
                             90 ;;======================================================================
