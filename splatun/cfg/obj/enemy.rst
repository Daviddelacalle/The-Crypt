...
Hexadecimal [16-Bits]
                     ...
                     0001    18 k_max_enemies = 1
                             19 
   46C3                      20 DefineEnemy enemy_copy, 39, 50, #1, #4, #0, #0, #0x0F, #enemy_randomGoal, #0, #0, #0, #0x0000, #0x0000, #0, #0, #0x0000, #0x0000, #0x0000, #1
   46C3                       1  enemy_copy:
   0000                       2     DefineDrawableEnt enemy_copy_dw, 39, 50, #1, #4                       ;;'
   0000                       1 enemy_copy_dw:
   46C3 27 32                 2    .db   39, 50      ;; Posicion    (x,y)
   46C5 01 04                 3    .db   #1, #4      ;; Dimensiones (w,h)
   46C7                       3     DefineMovableEnt  enemy_copy_mv, #0, #0                             ;;'
   0004                       1 enemy_copy_mv:
   46C7 00 00                 2    .db   #0, #0    ;; Variables de la velocidad
                              4  ;; Si no tiene sprite
   46C9 0F                    5     .db  #0x0F        ;; Color
                              6  ;; Si tiene sprite
                              7  ;;.dw   _spr
   46CA 39 47                 8     .dw  #enemy_randomGoal        ;; Puntero a la funcion de update
   46CC 00                    9     .db  #0  ;; 0 -> No se ha
   46CD 00                   10     .db  #0     ;; X de la posicion final
   46CE 00                   11     .db  #0     ;; Y de la posicion final
                             12 
                             13     ;;BRESENHAM
   46CF 00 00                14     .dw  #0x0000     ;; Distancia en X del objetivo
   46D1 00 00                15     .dw  #0x0000     ;; Distancia en Y del objetivo
   46D3 00                   16     .db  #0       ;; Incremento recto en Y
   46D4 00                   17     .db  #0       ;; Incremento recto en X
   46D5 00 00                18     .dw  #0x0000          ;; Avance
   46D7 00 00                19     .dw  #0x0000         ;; Avance recto
   46D9 00 00                20     .dw  #0x0000         ;; Avance inclinado
   46DB 01                   21     .db  #1    ;; 1 = Esta utilizando IncYi/IncXi |------------| 0 = Esta utilizando IncYr/IncXr
   ...
   46DC                      28 vector_init:                  ;; Etiqueta de inicio del vector
                             29 ;DefineNEnemies enemy, k_max_enemies
   46DC                      30 DefineEnemy enemy1, #0x27, #0x10, #2, #8, #0, #0, #0x0F, #enemy_randomGoal, #0, #0, #0, #0x0000, #0x0000, #0, #0, #0x0000, #0x0000, #0x0000, #1
   46DC                       1  enemy1:
   0019                       2     DefineDrawableEnt enemy1_dw, #0x27, #0x10, #2, #8                       ;;'
   0019                       1 enemy1_dw:
   46DC 27 10                 2    .db   #0x27, #0x10      ;; Posicion    (x,y)
   46DE 02 08                 3    .db   #2, #8      ;; Dimensiones (w,h)
   46E0                       3     DefineMovableEnt  enemy1_mv, #0, #0                             ;;'
   001D                       1 enemy1_mv:
   46E0 00 00                 2    .db   #0, #0    ;; Variables de la velocidad
...
Hexadecimal [16-Bits]
                              ...
                              4  ;; Si no tiene sprite
   46E2 0F                    5     .db  #0x0F        ;; Color
                              6  ;; Si tiene sprite
                              7  ;;.dw   _spr
   46E3 39 47                 8     .dw  #enemy_randomGoal        ;; Puntero a la funcion de update
   46E5 00                    9     .db  #0  ;; 0 -> No se ha
   46E6 00                   10     .db  #0     ;; X de la posicion final
   46E7 00                   11     .db  #0     ;; Y de la posicion final
                             12 
                             13     ;;BRESENHAM
   46E8 00 00                14     .dw  #0x0000     ;; Distancia en X del objetivo
   46EA 00 00                15     .dw  #0x0000     ;; Distancia en Y del objetivo
   46EC 00                   16     .db  #0       ;; Incremento recto en Y
   46ED 00                   17     .db  #0       ;; Incremento recto en X
   46EE 00 00                18     .dw  #0x0000          ;; Avance
   46F0 00 00                19     .dw  #0x0000         ;; Avance recto
   46F2 00 00                20     .dw  #0x0000         ;; Avance inclinado
   46F4 01                   21     .db  #1    ;; 1 = Esta utilizando IncYi/IncXi |------------| 0 = Esta utilizando IncYr/IncXr
                             22  ;; Aqui falta saber el tamanyo de la entidad
                     0019    23  en_size = . - (enemy1)
   46F5 FF                   31 vector_end:    .db #0xFF      ;; Indico 0xFF como fin del vector
                             32 
   46F6 14                   33 flag_move:     .db #20        ;; Cambia en cada frame [0,1] -> 1 = Se mueve
                             34 
                             35 ;;======================================================================
                             36 ;;======================================================================
                             ...
                             43 ;; DESTRUYE:   HL
                             44 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   46F7                      45 enemy_create::
   46F7 21 26 47      [10]   46    ld hl, #enemy_init
   46FA C3 0F 47      [10]   47    jp enemy_search
                             48 
                             49 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             ...
                             52 ;; DESTRUYE:   HL
                             53 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   46FD                      54 enemy_draw_ALL::
   46FD 21 3C 46      [10]   55    ld hl, #dw_draw
   4700 C3 0F 47      [10]   56    jp enemy_search
                             57 
                             58 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             ...
                             61 ;; DESTRUYE:   HL
                             62 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4703                      63 enemy_clear_ALL::
   4703 21 71 46      [10]   64    ld hl, #dw_clear
   4706 C3 0F 47      [10]   65    jp enemy_search
...
Hexadecimal [16-Bits]
                             ...
                             70 ;; DESTRUYE:   HL
                             71 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4709                      72 enemy_update_ALL::
   4709 21 32 47      [10]   73    ld hl, #enemy_update
   470C C3 0F 47      [10]   74    jp enemy_search
                             75 
                             76 ;;======================================================================
                             77 ;;======================================================================
                             ...
                             85 ;; DESTRUYE:   A, DE, IX
                             86 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   470F                      87 enemy_search:
   470F DD 21 DC 46   [14]   88    ld    ix,   #vector_init      ;; IX apunta al inicio de vector_bullets (a la primera entidad)
   4713 22 1D 47      [16]   89    ld    (f_custom), hl          ;; Cargo en el call de abajo la funcion a la que quiero llamar en cada momento determinado
   4716                      90    search_loop:
   4716 DD 7E 00      [19]   91       ld     a,   0(ix)                ;; Compruebo que no he llegado al final del vector
   4719 FE FF         [ 7]   92       cp    #0xFF                      ;; A - 0xFF
   471B C8            [11]   93       ret    z                         ;; if(A==0xFF) -> Sale del vector
                             94 
                     005A    95       f_custom = . +1                  ;; . apunta a 'call' y con el '+1' apunta a '(0x0000)' -> (siempre va a cambiar)
   471C CD 00 00      [17]   96       call (0x0000)                    ;; LLAMADA A FUNCION PERSONALIZABLE
   471F 11 19 00      [10]   97       ld    de,   #enemy_size          ;; Cargo en DE el tamanyo de la entidad bullet para despues sumarlo a HL
   4722 DD 19         [15]   98       add   ix,   de                   ;; IX + DE = Apunta a la siguiente entidad bullet
   4724 18 F0         [12]   99    jr search_loop
                            100 
                            101 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            105 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4726                     106 enemy_init:
   4726 DD E5         [15]  107    push  ix                ;; El valor de IX va a la pila
   4728 D1            [10]  108    pop   de                ;; DE ahora tiene el valor de IX
   4729 21 C3 46      [10]  109    ld    hl, #enemy_copy   ;; HL apunta al destino de la copia
   472C 01 19 00      [10]  110    ld    bc, #enemy_size   ;; BC tiene el tamanyo del enemigo
   472F ED B0         [21]  111    ldir                    ;; ELEDIR
   4731 C9            [10]  112    ret
                            113 
                            114 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            118 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4732                     119 enemy_update:
   4732 DD 6E 07      [19]  120    ld    l, en_up_l(ix)     ;; Cargo el byte bajo en L
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 56.
Hexadecimal [16-Bits]



   4735 DD 66 08      [19]  121    ld    h, en_up_h(ix)     ;; Cargo el byte alto en H
   4738 E9            [ 4]  122    jp    (hl)              ;; Llamo a la funcion
                            123 
                            124 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   4739                     137 enemy_randomGoal:
   4739 3A F6 46      [13]  138    ld    a, (flag_move)          ;; Cargo en A un contador para que no busque todo el rato
   473C 3D            [ 4]  139    dec   a                       ;; A--
   473D 32 F6 46      [13]  140    ld    (flag_move), a          ;; Lo actualizo
   4740 C0            [11]  141    ret   nz                      ;; Si no ha llegado a 0 hace ret
                            142 
   4741 3E 01         [ 7]  143    ld    a, #1                  ;; Inicio de nuevo el contador para despues
   4743 32 F6 46      [13]  144    ld (flag_move), a
                            145 
                            146    ;;RESET DE LOS VALORES
   4746 DD 36 0C 00   [19]  147    ld en_dX_l(ix), #0      ;; dX
   474A DD 36 0D 00   [19]  148    ld en_dX_h(ix), #0      ;; \
   474E DD 36 0E 00   [19]  149    ld en_dY_l(ix), #0      ;; dY
   4752 DD 36 0F 00   [19]  150    ld en_dY_h(ix), #0      ;; \
   4756 DD 36 11 00   [19]  151    ld en_incXr(ix), #0     ;; IncXr
   475A DD 36 10 00   [19]  152    ld en_incYr(ix), #0     ;; IncYr
   475E DD 36 04 00   [19]  153    ld en_vx(ix),  #0       ;; vx = IncXi
   4762 DD 36 05 00   [19]  154    ld en_vy(ix),  #0       ;; vy = IncYi
   4766 DD 36 12 00   [19]  155    ld en_av_l(ix), #0      ;; av
   476A DD 36 13 00   [19]  156    ld en_av_h(ix), #0      ;; \
   476E DD 36 14 00   [19]  157    ld en_avR_l(ix), #0     ;; avR
   4772 DD 36 15 00   [19]  158    ld en_avR_h(ix), #0     ;; \
   4776 DD 36 16 00   [19]  159    ld en_avI_l(ix), #0     ;; avI
   477A DD 36 17 00   [19]  160    ld en_avI_h(ix), #0     ;; \
                            161 
                            162 
                            163 
                            164    ;; PARTE 1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            165    ;; X
   477E                     166    get_random_x:
   477E CD 6C 4A      [17]  167       call cpct_getRandom_mxor_u8_asm        ;; Lo devuelve en L
   4781 7D            [ 4]  168       ld    a,    l                          ;; Cargo en A el random que se ha cargado en L
   4782 FE 4F         [ 7]  169       cp    #x_range                         ;; Miro que este dentro del rango 0-80 (dec)
                            170 
   4784 DD 96 00      [19]  171       sub   en_x(ix)                         ;; Resto la posicion actual del enemigo
   4787 30 02         [12]  172       jr    nc, no_carry_x
   4789 2F            [ 4]  173          cpl
   478A 3C            [ 4]  174          inc a
   478B                     175       no_carry_x:
...
Hexadecimal [16-Bits]
   ...
   478B FE 14         [ 7]  177       cp    #var_r_max
   478D 30 EF         [12]  178    jr    nc, get_random_x                    ;; Si no esta dentro del rango max, lo vuelve a buscar
   478F FE 0A         [ 7]  179       cp    #var_r_min
   4791 38 EB         [12]  180    jr    c, get_random_x                     ;; Si esta dentro del rango min, lo vuelve a buscar
                            181 
   4793 DD 75 0A      [19]  182    ld en_g_x(ix), l                          ;; Cargo la posicion random en el enemigo
                            183 
                            184    ;; Saco vector VX del enemigo
   4796 7D            [ 4]  185    ld    a,    l              ;; Posicion X del objetivo
   4797 DD 96 00      [19]  186    sub   en_x(ix)             ;; Resto la posicion actual del enemigo
   479A DD 77 0C      [19]  187    ld    en_dX_l(ix), a       ;; GUARDO el valor de dX
   479D 38 06         [12]  188    jr c, vx_neg               ;; Si C==1, la distancia es negativa
   479F DD 36 04 01   [19]  189       ld    en_vx(ix), #1        ;; VX =  1
   47A3 18 0E         [12]  190       jr continua_y
   47A5                     191    vx_neg:
   47A5 DD 36 04 FF   [19]  192       ld    en_vx(ix), #-1       ;; VX = -1
   47A9 2F            [ 4]  193       cpl                        ;; Invierto bites de A, que guarda la distancia
   47AA 3C            [ 4]  194       inc   a                    ;; Le sumo 1 y entonces -> A = -A
   47AB DD 77 0C      [19]  195       ld en_dX_l(ix) , a         ;; Lo guardo de nuevo
   47AE 3E 00         [ 7]  196       ld    a,    #0x00          ;; | A = 0xFF
   47B0 DD 77 0D      [19]  197       ld en_dX_h(ix), a          ;; Ya que es negativo -> FF**
   47B3                     198    continua_y:
                            199 
                            200    ;; Y
   47B3                     201    get_random_y:
   47B3 CD 6C 4A      [17]  202       call cpct_getRandom_mxor_u8_asm        ;; Lo devuelve en L
   47B6 7D            [ 4]  203       ld    a,    l                          ;; Cargo en A el random que se ha cargado en L
   47B7 FE 64         [ 7]  204       cp    #y_range                         ;; Miro que este dentro del rango 0-200 (dec)
                            205 
   47B9 DD 96 01      [19]  206       sub   en_y(ix)                         ;; Resto la posicion actual del enemigo
   47BC 30 02         [12]  207       jr    nc, no_carry_y
   47BE 2F            [ 4]  208          cpl
   47BF 3C            [ 4]  209          inc a
   47C0                     210       no_carry_y:
                            211       ;; Ahora tengo la distancia arreglada
   47C0 FE 14         [ 7]  212       cp    #var_r_max
   47C2 30 EF         [12]  213    jr    nc, get_random_y                    ;; Si no esta dentro del rango, lo vuelve a buscar
   47C4 FE 0A         [ 7]  214       cp    #var_r_min
   47C6 38 EB         [12]  215    jr    c, get_random_y                     ;; Si esta dentro del rango min, lo vuelve a buscar
                            216 
   47C8 DD 75 0B      [19]  217    ld en_g_y(ix), l                          ;; Cargo la posicion random en el enemigo
                            218 
                            219    ;; Saco vector VY del enemigo
   47CB 7D            [ 4]  220    ld    a,    l                 ;; Posicion Y del objetivo
   47CC DD 96 01      [19]  221    sub   a, en_y(ix)             ;; Posicion Y del enemigo
   47CF DD 77 0E      [19]  222    ld    en_dY_l(ix), a          ;; Guardo el valor para despues
                            223    ;cp    #200                   ;; |
   47D2 38 06         [12]  224    jr c, vy_neg                  ;; Si C==0 la distancia es negativa -> COMPROBAR EN EJECUCION
   47D4 DD 36 05 01   [19]  225       ld    en_vy(ix), #1        ;; VY =  1
   47D8 18 0E         [12]  226       jr continua_fin
   47DA                     227    vy_neg:
   47DA DD 36 05 FF   [19]  228       ld    en_vy(ix), #-1       ;; VY = -1
   47DE 2F            [ 4]  229       cpl                        ;; Invierto bites de A, que guarda la distancia
   47DF 3C            [ 4]  230       inc   a                    ;; Le sumo 1 y entonces -> A = -A
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 58.
Hexadecimal [16-Bits]



   47E0 DD 77 0E      [19]  231       ld en_dY_l(ix), a            ;; Lo guardo de nuevo
   47E3 3E 00         [ 7]  232       ld    a,    #0x00          ;; | A = 0xFF
   47E5 DD 77 0F      [19]  233       ld en_dY_h(ix), a          ;; Ya que es negativo -> FF**
   47E8                     234    continua_fin:
                            235 
                            236    ;; PARTE 2 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            237 
                            238    ;; Primero miro si los numeros estan en un valor absoluto
   47E8 DD 6E 0E      [19]  239    ld    l, en_dY_l(ix)       ;; Cargo en HL el valor de dY
   47EB DD 66 0F      [19]  240    ld    h, en_dY_h(ix)       ;; Cargo en HL el valor de dY
   47EE CD 26 49      [17]  241    call enemy_get_positive
   47F1 EB            [ 4]  242    ex    de,   hl             ;; -- DE = dY
   47F2 DD 6E 0C      [19]  243    ld    l, en_dX_l(ix)        ;; Cargo en HL el valor de dX
   47F5 DD 66 0D      [19]  244    ld    h, en_dX_h(ix)        ;; Cargo en HL el valor de dX
   47F8 CD 26 49      [17]  245    call enemy_get_positive    ;; -- HL = dX
                            246 
   47FB 30 01         [12]  247    jr    nc, no_carry         ;; Si C = 0, no hago nada
   47FD 3F            [ 4]  248       ccf                     ;; Si entra aqui, C = 1, entonces invierto -> C = 0
   47FE                     249    no_carry:
   47FE ED 52         [15]  250    sbc   hl,   de             ;; HL - DE = dX - dY ---> AL UTILIZAR TAMBIEN EL CARRY FLAG, LO PONGO A 0 ANTES DE HACER NADA
   4800 38 0D         [12]  251    jr c, dy_es_mayor          ;; dX - dY = 0013 - 0000 = 13 -> dX ES MAYOR, C=0
                            252       ;;if dX>=dY
   4802 3E 00         [ 7]  253       ld    a,    #0          ;; A = 0
   4804 DD 77 10      [19]  254       ld en_incYr(ix), a      ;; --> IncYr = 0
   4807 DD 7E 04      [19]  255       ld    a, en_vx(ix)      ;; A = IncXi = VX
   480A DD 77 11      [19]  256       ld en_incXr(ix), a      ;; --> IncXr = IncXi ----> IncXi = VX = INCREMENTO QUE SE APLICA A LAS SECCIONES CON AVANCE INCLINADO
   480D 18 25         [12]  257       jr continua_fin2
   480F                     258    dy_es_mayor:
                            259       ;;if dY>dX
   480F 3E 00         [ 7]  260       ld    a,    #0          ;; A = 0
   4811 DD 77 11      [19]  261       ld en_incXr(ix), a      ;; -- IncXr = 0
   4814 DD 7E 05      [19]  262       ld    a, en_vy(ix)      ;; A = IncYi = VY
   4817 DD 77 10      [19]  263       ld en_incYr(ix), a      ;; -- IncYr = IncYi ----> IncYi = VY = INCREMENTO QUE SE APLICA A LAS SECCIONES CON AVANCE INCLINADO
                            264 
                            265       ;; =============================== ;;
                            ...
                            269       ;;             dY =  k             ;;
                            270       ;; =============================== ;;
   481A DD 6E 0C      [19]  271       ld    l, en_dX_l(ix)
   481D DD 66 0D      [19]  272       ld    h, en_dX_h(ix)
   4820 EB            [ 4]  273       ex    de,   hl
   4821 DD 6E 0E      [19]  274       ld    l, en_dY_l(ix)
   4824 DD 66 0F      [19]  275       ld    h, en_dY_h(ix)
   4827 DD 75 0C      [19]  276       ld en_dX_l(ix), l
   482A DD 74 0D      [19]  277       ld en_dX_h(ix), h
   482D EB            [ 4]  278       ex    de,   hl
   482E DD 75 0E      [19]  279       ld en_dY_l(ix), l
   4831 DD 74 0F      [19]  280       ld en_dY_h(ix), h
                            281 
   4834                     282    continua_fin2:
                            283 
                            284    ;; INICIALIZAR VALORES RAROS
   4834 DD 6E 0E      [19]  285    ld    l, en_dY_l(ix)       ;; HL = dY
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 59.
Hexadecimal [16-Bits]



   4837 DD 66 0F      [19]  286    ld    h, en_dY_h(ix)       ;; |
   483A 29            [11]  287    add   hl,   hl             ;; HL + HL = 2 * dY
   483B DD 75 14      [19]  288    ld en_avR_l(ix), l         ;; --> avR = (2 * dY)
   483E DD 74 15      [19]  289    ld en_avR_h(ix), h         ;; |
                            290 
                            291    ;; Hay que negar dX y luego sumarlo
                            292    ;; En DE tendre el valor de dX y en HL ya he conseguido el valor de avR
                            293    ;; av = (HL + (-DE))
                            294    ;; av = (avR - dX)
   4841 DD 6E 0C      [19]  295    ld    l, en_dX_l(ix)       ;; HL =  dX
   4844 DD 66 0D      [19]  296    ld    h, en_dX_h(ix)       ;; |
   4847 CD 31 49      [17]  297    call enemy_get_negative    ;; HL = -dX
   484A EB            [ 4]  298    ex    de,   hl             ;; -- DE = -dX
   484B DD 6E 14      [19]  299    ld    l, en_avR_l(ix)      ;; -- HL = avR
   484E DD 66 15      [19]  300    ld    h, en_avR_h(ix)      ;; |
   4851 19            [11]  301    add   hl,   de             ;; HL + DE = avR - dX
   4852 DD 75 12      [19]  302    ld en_av_l(ix), l          ;; av = avR - dX
   4855 DD 74 13      [19]  303    ld en_av_h(ix), h          ;; |
                            304 
                            305    ;; En HL ya tengo av y en DE tengo -dX
                            306    ;; Solo tengo que sumarlo
   4858 19            [11]  307    add   hl,   de             ;; av + -(dX)
   4859 DD 75 16      [19]  308    ld en_avI_l(ix), l         ;; --> avI = (av - dX)
   485C DD 74 17      [19]  309    ld en_avI_h(ix), h         ;; |
                            310 
                            311 
                            312 
                            313    ;; 'DEBUG'
   485F 11 00 C0      [10]  314    ld    de, #0xC000          ;;Comienzo memoria de video
   4862 DD 4E 0A      [19]  315    ld     c, en_g_x(ix)       ;; C = Entity X
   4865 DD 46 0B      [19]  316    ld     b, en_g_y(ix)    ;; B = Entity Y
   4868 CD 6A 4B      [17]  317    call cpct_getScreenPtr_asm
                            318    ;; SIN SPRITE
   486B EB            [ 4]  319    ex    de,   hl             ;; Apunta a la posicion x,y
   486C 3E EE         [ 7]  320    ld     a,   #0xEE          ;; Código de color
   486E 0E 01         [ 7]  321    ld     c,   #1             ;; Ancho
   4870 06 04         [ 7]  322    ld     b,   #4             ;; Alto
   4872 CD 91 4A      [17]  323    call cpct_drawSolidBox_asm
                            324 
                            325 
                            326 
                            327    ;;; Cambio update
   4875 21 81 48      [10]  328    ld hl, #enemy_checkGoal
   4878 DD 74 08      [19]  329    ld en_up_h(ix), h
   487B DD 75 07      [19]  330    ld en_up_l(ix), l
                            331 
   487E C3 81 48      [10]  332    jp enemy_checkGoal
                            333 
                            334 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
   ...
   4881 DD 7E 0A      [19]  342    ld    a,    en_g_x(ix)           ;; Cargo la posicion del goal
   4884 DD BE 00      [19]  343    cp    en_x(ix)                   ;; Le resto la posicion del enemigo
   4887 20 12         [12]  344    jr nz, no_goal_yet
   4889 DD 36 04 00   [19]  345       ld en_vx(ix),  #0          ;; Pongo a 0 -> RESET
   488D DD 36 05 00   [19]  346       ld en_vy(ix),  #0          ;; Pongo a 0 -> RESET
                            347 
   4891 21 39 47      [10]  348       ld hl, #enemy_randomGoal      ;; Vuelvo a cambiar el update del enemigo
   4894 DD 74 08      [19]  349       ld en_up_h(ix), h
   4897 DD 75 07      [19]  350       ld en_up_l(ix), l
   489A C9            [10]  351       ret
   489B                     352    no_goal_yet:
                            353    ;; El spaghetti code de @daNNi
                            354    ;; THE FINAL BOSS: Actualizo Bresenham
                            355 
   489B DD 6E 12      [19]  356    ld    l, en_av_l(ix)       ;; HL = av
   489E DD 66 13      [19]  357    ld    h, en_av_h(ix)       ;; |
   48A1 11 00 80      [10]  358    ld    de,   #0x8000        ;; DE = 7FFF
   48A4 30 01         [12]  359    jr    nc, no_carry2        ;; Si C = 0, no hago nada
   48A6 3F            [ 4]  360       ccf                     ;; Si entra aqui, C = 1, entonces invierto -> C = 0
   48A7                     361    no_carry2:
   48A7 ED 52         [15]  362    sbc   hl,   de
   48A9 30 3E         [12]  363    jr    nc,    av_negativo
                            364       ;; Aqui av, es positivo o 0
   48AB DD 7E 18      [19]  365       ld    a,    en_flagVel(ix)
   48AE FE 01         [ 7]  366       cp    #1
   48B0 28 21         [12]  367       jr    z, utiliza_i      ;; NECESITA UTILIZAR i
                            368          ;; Cambiar de r a i
                            369          ;; CAMBIO DE LAS Y
   48B2 DD 7E 10      [19]  370          ld    a,    en_incYr(ix)   ;; A = IncYr
   48B5 47            [ 4]  371          ld    b,    a              ;; B = A = IncYr
   48B6 DD 7E 05      [19]  372          ld    a,    en_vy(ix)      ;; A = IncYi
   48B9 DD 77 10      [19]  373          ld en_incYr(ix), a         ;; Intercambio 1
   48BC 78            [ 4]  374          ld    a,    b              ;; A = B = IncYr
   48BD DD 77 05      [19]  375          ld en_vy(ix), a            ;; Intercambio 2
                            376 
                            377          ;; CAMBIO DE LAS X
   48C0 DD 7E 11      [19]  378          ld    a,    en_incXr(ix)   ;; A = IncXr
   48C3 47            [ 4]  379          ld    b,    a              ;; B = A = IncXr
   48C4 DD 7E 04      [19]  380          ld    a,    en_vx(ix)      ;; A = IncXi
   48C7 DD 77 11      [19]  381          ld en_incXr(ix), a         ;; Intercambio 1
   48CA 78            [ 4]  382          ld    a,    b              ;; A = B = IncXr
   48CB DD 77 04      [19]  383          ld en_vx(ix), a            ;; Intercambio 2
                            384 
   48CE 3E 01         [ 7]  385          ld    a,    #1             ;; Finalmente cambio el flag de la velocidad
   48D0 DD 77 18      [19]  386          ld en_flagVel(ix), a       ;; flag_vel = 1
   48D3                     387       utiliza_i:
                            388          ;; Aqui no hace falta cambiar ninguna velocidad
   48D3 DD 6E 12      [19]  389          ld    l, en_av_l(ix)       ;; HL = av
   48D6 DD 66 13      [19]  390          ld    h, en_av_h(ix)       ;; |
   48D9 EB            [ 4]  391          ex    de,   hl             ;; -- DE = av
   48DA DD 6E 16      [19]  392          ld    l, en_avI_l(ix)      ;; -- HL = avI
   48DD DD 66 17      [19]  393          ld    h, en_avI_h(ix)      ;; |
   48E0 19            [11]  394          add   hl,   de             ;; DE + HL
   48E1 DD 75 12      [19]  395          ld en_av_l(ix), l          ;; -- av = (av + avI)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 61.
Hexadecimal [16-Bits]



   48E4 DD 74 13      [19]  396          ld en_av_h(ix), h          ;; |
   48E7 18 3C         [12]  397       jr end_if
   48E9                     398    av_negativo:
                            399       ;; Aqui av, es negativo
                            400       ;;     X = (X + IncXr)     // X aumenta en recto.
                            401       ;;     Y = (Y + IncYr)     // Y aumenta en recto.
                            402       ;;     av = (av + avR)     // Avance Recto
   48E9 DD 7E 18      [19]  403       ld    a,    en_flagVel(ix)
   48EC FE 00         [ 7]  404       cp    #0
   48EE 28 21         [12]  405       jr    z, utiliza_r      ;; NECESITA UTILIZAR r
                            406          ;; Cambiar de i a r
                            407          ;; CAMBIO DE LAS Y
   48F0 DD 7E 10      [19]  408          ld    a,    en_incYr(ix)   ;; A = IncYr
   48F3 47            [ 4]  409          ld    b,    a              ;; B = A = IncYr
   48F4 DD 7E 05      [19]  410          ld    a,    en_vy(ix)      ;; A = IncYi
   48F7 DD 77 10      [19]  411          ld en_incYr(ix), a         ;; Intercambio 1
   48FA 78            [ 4]  412          ld    a,    b              ;; A = B = IncYr
   48FB DD 77 05      [19]  413          ld en_vy(ix), a            ;; Intercambio 2
                            414 
                            415          ;; CAMBIO DE LAS X
   48FE DD 7E 11      [19]  416          ld    a,    en_incXr(ix)   ;; A = IncXr
   4901 47            [ 4]  417          ld    b,    a              ;; B = A = IncXr
   4902 DD 7E 04      [19]  418          ld    a,    en_vx(ix)      ;; A = IncXi
   4905 DD 77 11      [19]  419          ld en_incXr(ix), a         ;; Intercambio 1
   4908 78            [ 4]  420          ld    a,    b              ;; A = B = IncXr
   4909 DD 77 04      [19]  421          ld en_vx(ix), a            ;; Intercambio 2
                            422 
   490C 3E 00         [ 7]  423          ld    a,    #0             ;; Finalmente cambio el flag de la velocidad
   490E DD 77 18      [19]  424          ld en_flagVel(ix), a       ;; flag_vel = 0
   4911                     425       utiliza_r:
                            426          ;; Aqui no hace falta cambiar ninguna velocidad
   4911 DD 6E 12      [19]  427          ld    l, en_av_l(ix)       ;; HL = av
   4914 DD 66 13      [19]  428          ld    h, en_av_h(ix)       ;; |
   4917 EB            [ 4]  429          ex    de,   hl             ;; -- DE = av
   4918 DD 6E 14      [19]  430          ld    l, en_avR_l(ix)      ;; -- HL = avI
   491B DD 66 15      [19]  431          ld    h, en_avR_h(ix)      ;; |
   491E 19            [11]  432          add   hl,   de             ;; DE + HL
   491F DD 75 12      [19]  433          ld en_av_l(ix), l          ;; -- av = (av + avI)
   4922 DD 74 13      [19]  434          ld en_av_h(ix), h          ;; |
   4925                     435    end_if:
   4925 C9            [10]  436    ret
                            437 
                            438 
   ...
   4926                     442 enemy_get_positive:
   4926 7C            [ 4]  443    ld     a, h                ;; A = 00/FF
   4927 FE 00         [ 7]  444    cp    #0                   ;; |
   4929 C8            [11]  445    ret     z
   492A 7D            [ 4]  446       ld    a, l              ;; A = -dY
   492B 2F            [ 4]  447       cpl
   492C 3C            [ 4]  448       inc a                   ;; A =  dY -> Aqui ya tengo dY en positivo
   492D 26 00         [ 7]  449       ld    h, #0             ;; H = 00
   492F 6F            [ 4]  450       ld    l, a              ;; L = dY --> HL = 00**, donde ** = dY
...
Hexadecimal [16-Bits]
   ...
   4931                     454 enemy_get_negative:
   4931 7C            [ 4]  455    ld    a, h                ;; A = FF/00
   4932 FE FF         [ 7]  456    cp    #0xFF               ;; |
   4934 C8            [11]  457    ret   z
   4935 7D            [ 4]  458       ld    a,    l          ;; A = -dY
   4936 2F            [ 4]  459       cpl
   4937 3C            [ 4]  460       inc   a                ;; A =  dY -> Aqui ya tengo dY en positivo
   4938 26 FF         [ 7]  461       ld    h,    #0xFF      ;; H = FF
   493A 6F            [ 4]  462       ld    l,    a          ;; L = dY --> HL = FF**, donde ** = dY
   493B C9            [10]  463    ret
                            464 
                            465 
                            466 
