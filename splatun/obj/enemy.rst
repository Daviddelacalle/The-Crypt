...
Hexadecimal [16-Bits]
                     ...
                     0001    18 k_max_enemies = 1
                             19 
   9A01                      20 DefineEnemy enemy_copy, 39, 50, #1, #4, #0, #0, #0x0F, #enemy_randomGoal, #0, #0, #0, #0x0000, #0x0000, #0, #0, #0x0000, #0x0000, #0x0000, #1
   9A01                       1  enemy_copy:
   0000                       2     DefineDrawableEnt enemy_copy_dw, 39, 50, #1, #4                       ;;'
   0000                       1 enemy_copy_dw:
   9A01 27 32                 2    .db   39, 50      ;; Posicion    (x,y)
   9A03 01 04                 3    .db   #1, #4      ;; Dimensiones (w,h)
   9A05                       3     DefineMovableEnt  enemy_copy_mv, #0, #0                             ;;'
   0004                       1 enemy_copy_mv:
   9A05 00 00                 2    .db   #0, #0    ;; Variables de la velocidad
                              4  ;; Si no tiene sprite
   9A07 0F                    5     .db  #0x0F        ;; Color
                              6  ;; Si tiene sprite
                              7  ;;.dw   _spr
   9A08 77 9A                 8     .dw  #enemy_randomGoal        ;; Puntero a la funcion de update
   9A0A 00                    9     .db  #0  ;; 0 -> No se ha
   9A0B 00                   10     .db  #0     ;; X de la posicion final
   9A0C 00                   11     .db  #0     ;; Y de la posicion final
                             12 
                             13     ;;BRESENHAM
   9A0D 00 00                14     .dw  #0x0000     ;; Distancia en X del objetivo
   9A0F 00 00                15     .dw  #0x0000     ;; Distancia en Y del objetivo
   9A11 00                   16     .db  #0       ;; Incremento recto en Y
   9A12 00                   17     .db  #0       ;; Incremento recto en X
   9A13 00 00                18     .dw  #0x0000          ;; Avance
   9A15 00 00                19     .dw  #0x0000         ;; Avance recto
   9A17 00 00                20     .dw  #0x0000         ;; Avance inclinado
   9A19 01                   21     .db  #1    ;; 1 = Esta utilizando IncYi/IncXi |------------| 0 = Esta utilizando IncYr/IncXr
                     ...
                     004F    24 x_range  = 79
                     0064    25 y_range  = 100
                     0014    26 var_r_max    = 20
                     000A    27 var_r_min    = 10
   9A1A                      28 vector_init:                  ;; Etiqueta de inicio del vector
                             29 ;DefineNEnemies enemy, k_max_enemies
   9A1A                      30 DefineEnemy enemy1, #0x27, #0x10, #2, #8, #0, #0, #0x0F, #enemy_randomGoal, #0, #0, #0, #0x0000, #0x0000, #0, #0, #0x0000, #0x0000, #0x0000, #1
   9A1A                       1  enemy1:
   0019                       2     DefineDrawableEnt enemy1_dw, #0x27, #0x10, #2, #8                       ;;'
   0019                       1 enemy1_dw:
   9A1A 27 10                 2    .db   #0x27, #0x10      ;; Posicion    (x,y)
   9A1C 02 08                 3    .db   #2, #8      ;; Dimensiones (w,h)
   9A1E                       3     DefineMovableEnt  enemy1_mv, #0, #0                             ;;'
   001D                       1 enemy1_mv:
   9A1E 00 00                 2    .db   #0, #0    ;; Variables de la velocidad
...
Hexadecimal [16-Bits]
                              ...
                              4  ;; Si no tiene sprite
   9A20 0F                    5     .db  #0x0F        ;; Color
                              6  ;; Si tiene sprite
                              7  ;;.dw   _spr
   9A21 77 9A                 8     .dw  #enemy_randomGoal        ;; Puntero a la funcion de update
   9A23 00                    9     .db  #0  ;; 0 -> No se ha
   9A24 00                   10     .db  #0     ;; X de la posicion final
   9A25 00                   11     .db  #0     ;; Y de la posicion final
                             12 
                             13     ;;BRESENHAM
   9A26 00 00                14     .dw  #0x0000     ;; Distancia en X del objetivo
   9A28 00 00                15     .dw  #0x0000     ;; Distancia en Y del objetivo
   9A2A 00                   16     .db  #0       ;; Incremento recto en Y
   9A2B 00                   17     .db  #0       ;; Incremento recto en X
   9A2C 00 00                18     .dw  #0x0000          ;; Avance
   9A2E 00 00                19     .dw  #0x0000         ;; Avance recto
   9A30 00 00                20     .dw  #0x0000         ;; Avance inclinado
   9A32 01                   21     .db  #1    ;; 1 = Esta utilizando IncYi/IncXi |------------| 0 = Esta utilizando IncYr/IncXr
                             22  ;; Aqui falta saber el tamanyo de la entidad
                     0019    23  en_size = . - (enemy1)
   9A33 FF                   31 vector_end:    .db #0xFF      ;; Indico 0xFF como fin del vector
                             32 
   9A34 14                   33 flag_move:     .db #20        ;; Cambia en cada frame [0,1] -> 1 = Se mueve
                             34 
                             35 ;;======================================================================
                             36 ;;======================================================================
                             37 ;; FUNCIONES PUBLICAS
                             38 ;;======================================================================
                             39 ;;======================================================================
                             40 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             41 ;; COPIA LOS ENEMIGOS DEL BUCLE CON UNA ENTIDAD "MODELO"
                             42 ;; _______________________
                             43 ;; DESTRUYE:   HL
                             44 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9A35                      45 enemy_create::
   9A35 21 64 9A      [10]   46    ld hl, #enemy_init
   9A38 C3 4D 9A      [10]   47    jp enemy_search
                             48 
                             49 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             50 ;; ASIGNA LA FUNCION DE DIBUJADO EN HL Y RECORRE EL BUCLE
                             51 ;; _______________________
                             52 ;; DESTRUYE:   HL
                             53 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9A3B                      54 enemy_draw_ALL::
   9A3B 21 75 99      [10]   55    ld hl, #dw_draw
   9A3E C3 4D 9A      [10]   56    jp enemy_search
                             57 
                             58 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             59 ;; ASIGNA LA FUNCION DE CLEAR EN HL Y RECORRE EL BUCLE
                             60 ;; _______________________
                             61 ;; DESTRUYE:   HL
                             62 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9A41                      63 enemy_clear_ALL::
   9A41 21 AA 99      [10]   64    ld hl, #dw_clear
   9A44 C3 4D 9A      [10]   65    jp enemy_search
...
Hexadecimal [16-Bits]
                             ...
                             66 
                             67 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             68 ;; ASIGNA LA FUNCION DE UPDATE EN HL Y RECORRE EL BUCLE
                             69 ;; _______________________
                             70 ;; DESTRUYE:   HL
                             71 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9A47                      72 enemy_update_ALL::
   9A47 21 70 9A      [10]   73    ld hl, #enemy_update
   9A4A C3 4D 9A      [10]   74    jp enemy_search
                             75 
                             76 ;;======================================================================
                             77 ;;======================================================================
                             ...
                             80 ;;======================================================================
                             81 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             82 ;; RECORRE EL BUCLE DE ENEMIGOS
                             83 ;; _______________________
                             84 ;; ENTRADA:    HL -> Puntero a funcion custom
                             85 ;; DESTRUYE:   A, DE, IX
                             86 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9A4D                      87 enemy_search:
   9A4D DD 21 1A 9A   [14]   88    ld    ix,   #vector_init      ;; IX apunta al inicio de vector_bullets (a la primera entidad)
   9A51 22 5B 9A      [16]   89    ld    (f_custom), hl          ;; Cargo en el call de abajo la funcion a la que quiero llamar en cada momento determinado
   9A54                      90    search_loop:
   9A54 DD 7E 00      [19]   91       ld     a,   0(ix)                ;; Compruebo que no he llegado al final del vector
   9A57 FE FF         [ 7]   92       cp    #0xFF                      ;; A - 0xFF
   9A59 C8            [11]   93       ret    z                         ;; if(A==0xFF) -> Sale del vector
                             94 
                     005A    95       f_custom = . +1                  ;; . apunta a 'call' y con el '+1' apunta a '(0x0000)' -> (siempre va a cambiar)
   9A5A CD 00 00      [17]   96       call (0x0000)                    ;; LLAMADA A FUNCION PERSONALIZABLE
   9A5D 11 19 00      [10]   97       ld    de,   #enemy_size          ;; Cargo en DE el tamanyo de la entidad bullet para despues sumarlo a HL
   9A60 DD 19         [15]   98       add   ix,   de                   ;; IX + DE = Apunta a la siguiente entidad bullet
   9A62 18 F0         [12]   99    jr search_loop
                            100 
                            101 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            102 ;; COPIA LA ENTIDAD EN IX CON EL ENEMIGO POR DEFECTO
                            103 ;; _______________________
                            104 ;; ENTRADA:    IX -> Puntero a entidad enemigo del bucle
                            105 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9A64                     106 enemy_init:
   9A64 DD E5         [15]  107    push  ix                ;; El valor de IX va a la pila
   9A66 D1            [10]  108    pop   de                ;; DE ahora tiene el valor de IX
   9A67 21 01 9A      [10]  109    ld    hl, #enemy_copy   ;; HL apunta al destino de la copia
   9A6A 01 19 00      [10]  110    ld    bc, #enemy_size   ;; BC tiene el tamanyo del enemigo
   9A6D ED B0         [21]  111    ldir                    ;; ELEDIR
   9A6F C9            [10]  112    ret
                            113 
                            114 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            115 ;; LLAMA A LA FUNCION PROPIA DE UPDATE DE CADA ENEMIGO
                            116 ;; _______________________
                            117 ;; ENTRADA:    IX -> Puntero a entidad enemigo del bucle
                            118 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9A70                     119 enemy_update:
   9A70 DD 6E 07      [19]  120    ld    l, en_up_l(ix)     ;; Cargo el byte bajo en L
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 56.
Hexadecimal [16-Bits]



   9A73 DD 66 08      [19]  121    ld    h, en_up_h(ix)     ;; Cargo el byte alto en H
   9A76 E9            [ 4]  122    jp    (hl)              ;; Llamo a la funcion
                            123 
                            124 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            125 ;; BUSCA UN PUNTO ALEATORIO PARA IR HACIA ALLI
                            126 ;; _______________________
                            127 ;; ENTRADA:    IX -> Puntero a entidad enemigo del bucle
                            128 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            129 ; save_dX:    .dw #0x0000    ;; Para Bresenham
                            130 ; save_dY:    .dw #0x0000    ;; Para Bresenham
                            131 ; IncYr:      .db #0x00      ;; Serian el contrario de las VY de la entidad --> LLEVAR A DATOS PARAMETRIZABLES!!
                            132 ; IncXr:      .db #0x00      ;; Serian el contrario de las VX de la entidad --> LLEVAR A DATOS PARAMETRIZABLES!!
                            133 ; av:         .dw #0x0000    ;; VALORES DE INICIALIZACION DEL ALGORITMO
                            134 ; avR:        .dw #0x0000    ;; VALORES DE INICIALIZACION DEL ALGORITMO
                            135 ; avI:        .dw #0x0000    ;; VALORES DE INICIALIZACION DEL ALGORITMO
                            136 ; flag_vel:   .db #0x01      ;; 1 = Esta utilizando IncYi/IncXi |------------| 0 = Esta utilizando IncYr/IncXr
   9A77                     137 enemy_randomGoal:
   9A77 3A 34 9A      [13]  138    ld    a, (flag_move)          ;; Cargo en A un contador para que no busque todo el rato
   9A7A 3D            [ 4]  139    dec   a                       ;; A--
   9A7B 32 34 9A      [13]  140    ld    (flag_move), a          ;; Lo actualizo
   9A7E C0            [11]  141    ret   nz                      ;; Si no ha llegado a 0 hace ret
                            142 
   9A7F 3E 01         [ 7]  143    ld    a, #1                  ;; Inicio de nuevo el contador para despues
   9A81 32 34 9A      [13]  144    ld (flag_move), a
                            145 
                            146    ;;RESET DE LOS VALORES
   9A84 DD 36 0C 00   [19]  147    ld en_dX_l(ix), #0      ;; dX
   9A88 DD 36 0D 00   [19]  148    ld en_dX_h(ix), #0      ;; \
   9A8C DD 36 0E 00   [19]  149    ld en_dY_l(ix), #0      ;; dY
   9A90 DD 36 0F 00   [19]  150    ld en_dY_h(ix), #0      ;; \
   9A94 DD 36 11 00   [19]  151    ld en_incXr(ix), #0     ;; IncXr
   9A98 DD 36 10 00   [19]  152    ld en_incYr(ix), #0     ;; IncYr
   9A9C DD 36 04 00   [19]  153    ld en_vx(ix),  #0       ;; vx = IncXi
   9AA0 DD 36 05 00   [19]  154    ld en_vy(ix),  #0       ;; vy = IncYi
   9AA4 DD 36 12 00   [19]  155    ld en_av_l(ix), #0      ;; av
   9AA8 DD 36 13 00   [19]  156    ld en_av_h(ix), #0      ;; \
   9AAC DD 36 14 00   [19]  157    ld en_avR_l(ix), #0     ;; avR
   9AB0 DD 36 15 00   [19]  158    ld en_avR_h(ix), #0     ;; \
   9AB4 DD 36 16 00   [19]  159    ld en_avI_l(ix), #0     ;; avI
   9AB8 DD 36 17 00   [19]  160    ld en_avI_h(ix), #0     ;; \
                            161 
                            162 
                            163 
                            164    ;; PARTE 1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            165    ;; X
   9ABC                     166    get_random_x:
   9ABC CD 4A 9E      [17]  167       call cpct_getRandom_mxor_u8_asm        ;; Lo devuelve en L
   9ABF 7D            [ 4]  168       ld    a,    l                          ;; Cargo en A el random que se ha cargado en L
   9AC0 FE 4F         [ 7]  169       cp    #x_range                         ;; Miro que este dentro del rango 0-80 (dec)
                            170 
   9AC2 DD 96 00      [19]  171       sub   en_x(ix)                         ;; Resto la posicion actual del enemigo
   9AC5 30 02         [12]  172       jr    nc, no_carry_x
   9AC7 2F            [ 4]  173          cpl
   9AC8 3C            [ 4]  174          inc a
   9AC9                     175       no_carry_x:
...
Hexadecimal [16-Bits]
                            ...
                            176       ;; Ahora tengo la distancia arreglada
   9AC9 FE 14         [ 7]  177       cp    #var_r_max
   9ACB 30 EF         [12]  178    jr    nc, get_random_x                    ;; Si no esta dentro del rango max, lo vuelve a buscar
   9ACD FE 0A         [ 7]  179       cp    #var_r_min
   9ACF 38 EB         [12]  180    jr    c, get_random_x                     ;; Si esta dentro del rango min, lo vuelve a buscar
                            181 
   9AD1 DD 75 0A      [19]  182    ld en_g_x(ix), l                          ;; Cargo la posicion random en el enemigo
                            183 
                            184    ;; Saco vector VX del enemigo
   9AD4 7D            [ 4]  185    ld    a,    l              ;; Posicion X del objetivo
   9AD5 DD 96 00      [19]  186    sub   en_x(ix)             ;; Resto la posicion actual del enemigo
   9AD8 DD 77 0C      [19]  187    ld    en_dX_l(ix), a       ;; GUARDO el valor de dX
   9ADB 38 06         [12]  188    jr c, vx_neg               ;; Si C==1, la distancia es negativa
   9ADD DD 36 04 01   [19]  189       ld    en_vx(ix), #1        ;; VX =  1
   9AE1 18 0E         [12]  190       jr continua_y
   9AE3                     191    vx_neg:
   9AE3 DD 36 04 FF   [19]  192       ld    en_vx(ix), #-1       ;; VX = -1
   9AE7 2F            [ 4]  193       cpl                        ;; Invierto bites de A, que guarda la distancia
   9AE8 3C            [ 4]  194       inc   a                    ;; Le sumo 1 y entonces -> A = -A
   9AE9 DD 77 0C      [19]  195       ld en_dX_l(ix) , a         ;; Lo guardo de nuevo
   9AEC 3E 00         [ 7]  196       ld    a,    #0x00          ;; | A = 0xFF
   9AEE DD 77 0D      [19]  197       ld en_dX_h(ix), a          ;; Ya que es negativo -> FF**
   9AF1                     198    continua_y:
                            199 
                            200    ;; Y
   9AF1                     201    get_random_y:
   9AF1 CD 4A 9E      [17]  202       call cpct_getRandom_mxor_u8_asm        ;; Lo devuelve en L
   9AF4 7D            [ 4]  203       ld    a,    l                          ;; Cargo en A el random que se ha cargado en L
   9AF5 FE 64         [ 7]  204       cp    #y_range                         ;; Miro que este dentro del rango 0-200 (dec)
                            205 
   9AF7 DD 96 01      [19]  206       sub   en_y(ix)                         ;; Resto la posicion actual del enemigo
   9AFA 30 02         [12]  207       jr    nc, no_carry_y
   9AFC 2F            [ 4]  208          cpl
   9AFD 3C            [ 4]  209          inc a
   9AFE                     210       no_carry_y:
                            211       ;; Ahora tengo la distancia arreglada
   9AFE FE 14         [ 7]  212       cp    #var_r_max
   9B00 30 EF         [12]  213    jr    nc, get_random_y                    ;; Si no esta dentro del rango, lo vuelve a buscar
   9B02 FE 0A         [ 7]  214       cp    #var_r_min
   9B04 38 EB         [12]  215    jr    c, get_random_y                     ;; Si esta dentro del rango min, lo vuelve a buscar
                            216 
   9B06 DD 75 0B      [19]  217    ld en_g_y(ix), l                          ;; Cargo la posicion random en el enemigo
                            218 
                            219    ;; Saco vector VY del enemigo
   9B09 7D            [ 4]  220    ld    a,    l                 ;; Posicion Y del objetivo
   9B0A DD 96 01      [19]  221    sub   a, en_y(ix)             ;; Posicion Y del enemigo
   9B0D DD 77 0E      [19]  222    ld    en_dY_l(ix), a          ;; Guardo el valor para despues
                            223    ;cp    #200                   ;; |
   9B10 38 06         [12]  224    jr c, vy_neg                  ;; Si C==0 la distancia es negativa -> COMPROBAR EN EJECUCION
   9B12 DD 36 05 01   [19]  225       ld    en_vy(ix), #1        ;; VY =  1
   9B16 18 0E         [12]  226       jr continua_fin
   9B18                     227    vy_neg:
   9B18 DD 36 05 FF   [19]  228       ld    en_vy(ix), #-1       ;; VY = -1
   9B1C 2F            [ 4]  229       cpl                        ;; Invierto bites de A, que guarda la distancia
   9B1D 3C            [ 4]  230       inc   a                    ;; Le sumo 1 y entonces -> A = -A
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 58.
Hexadecimal [16-Bits]



   9B1E DD 77 0E      [19]  231       ld en_dY_l(ix), a            ;; Lo guardo de nuevo
   9B21 3E 00         [ 7]  232       ld    a,    #0x00          ;; | A = 0xFF
   9B23 DD 77 0F      [19]  233       ld en_dY_h(ix), a          ;; Ya que es negativo -> FF**
   9B26                     234    continua_fin:
                            235 
                            236    ;; PARTE 2 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            237 
                            238    ;; Primero miro si los numeros estan en un valor absoluto
   9B26 DD 6E 0E      [19]  239    ld    l, en_dY_l(ix)       ;; Cargo en HL el valor de dY
   9B29 DD 66 0F      [19]  240    ld    h, en_dY_h(ix)       ;; Cargo en HL el valor de dY
   9B2C CD 64 9C      [17]  241    call enemy_get_positive
   9B2F EB            [ 4]  242    ex    de,   hl             ;; -- DE = dY
   9B30 DD 6E 0C      [19]  243    ld    l, en_dX_l(ix)        ;; Cargo en HL el valor de dX
   9B33 DD 66 0D      [19]  244    ld    h, en_dX_h(ix)        ;; Cargo en HL el valor de dX
   9B36 CD 64 9C      [17]  245    call enemy_get_positive    ;; -- HL = dX
                            246 
   9B39 30 01         [12]  247    jr    nc, no_carry         ;; Si C = 0, no hago nada
   9B3B 3F            [ 4]  248       ccf                     ;; Si entra aqui, C = 1, entonces invierto -> C = 0
   9B3C                     249    no_carry:
   9B3C ED 52         [15]  250    sbc   hl,   de             ;; HL - DE = dX - dY ---> AL UTILIZAR TAMBIEN EL CARRY FLAG, LO PONGO A 0 ANTES DE HACER NADA
   9B3E 38 0D         [12]  251    jr c, dy_es_mayor          ;; dX - dY = 0013 - 0000 = 13 -> dX ES MAYOR, C=0
                            252       ;;if dX>=dY
   9B40 3E 00         [ 7]  253       ld    a,    #0          ;; A = 0
   9B42 DD 77 10      [19]  254       ld en_incYr(ix), a      ;; --> IncYr = 0
   9B45 DD 7E 04      [19]  255       ld    a, en_vx(ix)      ;; A = IncXi = VX
   9B48 DD 77 11      [19]  256       ld en_incXr(ix), a      ;; --> IncXr = IncXi ----> IncXi = VX = INCREMENTO QUE SE APLICA A LAS SECCIONES CON AVANCE INCLINADO
   9B4B 18 25         [12]  257       jr continua_fin2
   9B4D                     258    dy_es_mayor:
                            259       ;;if dY>dX
   9B4D 3E 00         [ 7]  260       ld    a,    #0          ;; A = 0
   9B4F DD 77 11      [19]  261       ld en_incXr(ix), a      ;; -- IncXr = 0
   9B52 DD 7E 05      [19]  262       ld    a, en_vy(ix)      ;; A = IncYi = VY
   9B55 DD 77 10      [19]  263       ld en_incYr(ix), a      ;; -- IncYr = IncYi ----> IncYi = VY = INCREMENTO QUE SE APLICA A LAS SECCIONES CON AVANCE INCLINADO
                            264 
                            265       ;; =============================== ;;
                            266       ;; INTERCAMBIO LOS VALORES dX y dY ;;
                            267       ;;             k  = dX             ;;
                            268       ;;             dX = dY             ;;
                            269       ;;             dY =  k             ;;
                            270       ;; =============================== ;;
   9B58 DD 6E 0C      [19]  271       ld    l, en_dX_l(ix)
   9B5B DD 66 0D      [19]  272       ld    h, en_dX_h(ix)
   9B5E EB            [ 4]  273       ex    de,   hl
   9B5F DD 6E 0E      [19]  274       ld    l, en_dY_l(ix)
   9B62 DD 66 0F      [19]  275       ld    h, en_dY_h(ix)
   9B65 DD 75 0C      [19]  276       ld en_dX_l(ix), l
   9B68 DD 74 0D      [19]  277       ld en_dX_h(ix), h
   9B6B EB            [ 4]  278       ex    de,   hl
   9B6C DD 75 0E      [19]  279       ld en_dY_l(ix), l
   9B6F DD 74 0F      [19]  280       ld en_dY_h(ix), h
                            281 
   9B72                     282    continua_fin2:
                            283 
                            284    ;; INICIALIZAR VALORES RAROS
   9B72 DD 6E 0E      [19]  285    ld    l, en_dY_l(ix)       ;; HL = dY
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 59.
Hexadecimal [16-Bits]



   9B75 DD 66 0F      [19]  286    ld    h, en_dY_h(ix)       ;; |
   9B78 29            [11]  287    add   hl,   hl             ;; HL + HL = 2 * dY
   9B79 DD 75 14      [19]  288    ld en_avR_l(ix), l         ;; --> avR = (2 * dY)
   9B7C DD 74 15      [19]  289    ld en_avR_h(ix), h         ;; |
                            290 
                            291    ;; Hay que negar dX y luego sumarlo
                            292    ;; En DE tendre el valor de dX y en HL ya he conseguido el valor de avR
                            293    ;; av = (HL + (-DE))
                            294    ;; av = (avR - dX)
   9B7F DD 6E 0C      [19]  295    ld    l, en_dX_l(ix)       ;; HL =  dX
   9B82 DD 66 0D      [19]  296    ld    h, en_dX_h(ix)       ;; |
   9B85 CD 6F 9C      [17]  297    call enemy_get_negative    ;; HL = -dX
   9B88 EB            [ 4]  298    ex    de,   hl             ;; -- DE = -dX
   9B89 DD 6E 14      [19]  299    ld    l, en_avR_l(ix)      ;; -- HL = avR
   9B8C DD 66 15      [19]  300    ld    h, en_avR_h(ix)      ;; |
   9B8F 19            [11]  301    add   hl,   de             ;; HL + DE = avR - dX
   9B90 DD 75 12      [19]  302    ld en_av_l(ix), l          ;; av = avR - dX
   9B93 DD 74 13      [19]  303    ld en_av_h(ix), h          ;; |
                            304 
                            305    ;; En HL ya tengo av y en DE tengo -dX
                            306    ;; Solo tengo que sumarlo
   9B96 19            [11]  307    add   hl,   de             ;; av + -(dX)
   9B97 DD 75 16      [19]  308    ld en_avI_l(ix), l         ;; --> avI = (av - dX)
   9B9A DD 74 17      [19]  309    ld en_avI_h(ix), h         ;; |
                            310 
                            311 
                            312 
                            313    ;; 'DEBUG'
   9B9D 11 00 C0      [10]  314    ld    de, #0xC000          ;;Comienzo memoria de video
   9BA0 DD 4E 0A      [19]  315    ld     c, en_g_x(ix)       ;; C = Entity X
   9BA3 DD 46 0B      [19]  316    ld     b, en_g_y(ix)    ;; B = Entity Y
   9BA6 CD 48 9F      [17]  317    call cpct_getScreenPtr_asm
                            318    ;; SIN SPRITE
   9BA9 EB            [ 4]  319    ex    de,   hl             ;; Apunta a la posicion x,y
   9BAA 3E EE         [ 7]  320    ld     a,   #0xEE          ;; Código de color
   9BAC 0E 01         [ 7]  321    ld     c,   #1             ;; Ancho
   9BAE 06 04         [ 7]  322    ld     b,   #4             ;; Alto
   9BB0 CD 6F 9E      [17]  323    call cpct_drawSolidBox_asm
                            324 
                            325 
                            326 
                            327    ;;; Cambio update
   9BB3 21 BF 9B      [10]  328    ld hl, #enemy_checkGoal
   9BB6 DD 74 08      [19]  329    ld en_up_h(ix), h
   9BB9 DD 75 07      [19]  330    ld en_up_l(ix), l
                            331 
   9BBC C3 BF 9B      [10]  332    jp enemy_checkGoal
                            333 
                            334 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            335 ;; CHECKEA SI HA LLEGADO A SU DESTINO
                            336 ;; _______________________
                            337 ;; ENTRADA:    IX -> Puntero a entidad enemigo del bucle
                            338 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9BBF                     339 enemy_checkGoal:
                            340    ;; Si ha llegado al destino -> NO MUEVO
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 60.
Hexadecimal [16-Bits]



                            341    ;; COMPROBACION EN X ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9BBF DD 7E 0A      [19]  342    ld    a,    en_g_x(ix)           ;; Cargo la posicion del goal
   9BC2 DD BE 00      [19]  343    cp    en_x(ix)                   ;; Le resto la posicion del enemigo
   9BC5 20 12         [12]  344    jr nz, no_goal_yet
   9BC7 DD 36 04 00   [19]  345       ld en_vx(ix),  #0          ;; Pongo a 0 -> RESET
   9BCB DD 36 05 00   [19]  346       ld en_vy(ix),  #0          ;; Pongo a 0 -> RESET
                            347 
   9BCF 21 77 9A      [10]  348       ld hl, #enemy_randomGoal      ;; Vuelvo a cambiar el update del enemigo
   9BD2 DD 74 08      [19]  349       ld en_up_h(ix), h
   9BD5 DD 75 07      [19]  350       ld en_up_l(ix), l
   9BD8 C9            [10]  351       ret
   9BD9                     352    no_goal_yet:
                            353    ;; El spaghetti code de @daNNi
                            354    ;; THE FINAL BOSS: Actualizo Bresenham
                            355 
   9BD9 DD 6E 12      [19]  356    ld    l, en_av_l(ix)       ;; HL = av
   9BDC DD 66 13      [19]  357    ld    h, en_av_h(ix)       ;; |
   9BDF 11 00 80      [10]  358    ld    de,   #0x8000        ;; DE = 7FFF
   9BE2 30 01         [12]  359    jr    nc, no_carry2        ;; Si C = 0, no hago nada
   9BE4 3F            [ 4]  360       ccf                     ;; Si entra aqui, C = 1, entonces invierto -> C = 0
   9BE5                     361    no_carry2:
   9BE5 ED 52         [15]  362    sbc   hl,   de
   9BE7 30 3E         [12]  363    jr    nc,    av_negativo
                            364       ;; Aqui av, es positivo o 0
   9BE9 DD 7E 18      [19]  365       ld    a,    en_flagVel(ix)
   9BEC FE 01         [ 7]  366       cp    #1
   9BEE 28 21         [12]  367       jr    z, utiliza_i      ;; NECESITA UTILIZAR i
                            368          ;; Cambiar de r a i
                            369          ;; CAMBIO DE LAS Y
   9BF0 DD 7E 10      [19]  370          ld    a,    en_incYr(ix)   ;; A = IncYr
   9BF3 47            [ 4]  371          ld    b,    a              ;; B = A = IncYr
   9BF4 DD 7E 05      [19]  372          ld    a,    en_vy(ix)      ;; A = IncYi
   9BF7 DD 77 10      [19]  373          ld en_incYr(ix), a         ;; Intercambio 1
   9BFA 78            [ 4]  374          ld    a,    b              ;; A = B = IncYr
   9BFB DD 77 05      [19]  375          ld en_vy(ix), a            ;; Intercambio 2
                            376 
                            377          ;; CAMBIO DE LAS X
   9BFE DD 7E 11      [19]  378          ld    a,    en_incXr(ix)   ;; A = IncXr
   9C01 47            [ 4]  379          ld    b,    a              ;; B = A = IncXr
   9C02 DD 7E 04      [19]  380          ld    a,    en_vx(ix)      ;; A = IncXi
   9C05 DD 77 11      [19]  381          ld en_incXr(ix), a         ;; Intercambio 1
   9C08 78            [ 4]  382          ld    a,    b              ;; A = B = IncXr
   9C09 DD 77 04      [19]  383          ld en_vx(ix), a            ;; Intercambio 2
                            384 
   9C0C 3E 01         [ 7]  385          ld    a,    #1             ;; Finalmente cambio el flag de la velocidad
   9C0E DD 77 18      [19]  386          ld en_flagVel(ix), a       ;; flag_vel = 1
   9C11                     387       utiliza_i:
                            388          ;; Aqui no hace falta cambiar ninguna velocidad
   9C11 DD 6E 12      [19]  389          ld    l, en_av_l(ix)       ;; HL = av
   9C14 DD 66 13      [19]  390          ld    h, en_av_h(ix)       ;; |
   9C17 EB            [ 4]  391          ex    de,   hl             ;; -- DE = av
   9C18 DD 6E 16      [19]  392          ld    l, en_avI_l(ix)      ;; -- HL = avI
   9C1B DD 66 17      [19]  393          ld    h, en_avI_h(ix)      ;; |
   9C1E 19            [11]  394          add   hl,   de             ;; DE + HL
   9C1F DD 75 12      [19]  395          ld en_av_l(ix), l          ;; -- av = (av + avI)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 61.
Hexadecimal [16-Bits]



   9C22 DD 74 13      [19]  396          ld en_av_h(ix), h          ;; |
   9C25 18 3C         [12]  397       jr end_if
   9C27                     398    av_negativo:
                            399       ;; Aqui av, es negativo
                            400       ;;     X = (X + IncXr)     // X aumenta en recto.
                            401       ;;     Y = (Y + IncYr)     // Y aumenta en recto.
                            402       ;;     av = (av + avR)     // Avance Recto
   9C27 DD 7E 18      [19]  403       ld    a,    en_flagVel(ix)
   9C2A FE 00         [ 7]  404       cp    #0
   9C2C 28 21         [12]  405       jr    z, utiliza_r      ;; NECESITA UTILIZAR r
                            406          ;; Cambiar de i a r
                            407          ;; CAMBIO DE LAS Y
   9C2E DD 7E 10      [19]  408          ld    a,    en_incYr(ix)   ;; A = IncYr
   9C31 47            [ 4]  409          ld    b,    a              ;; B = A = IncYr
   9C32 DD 7E 05      [19]  410          ld    a,    en_vy(ix)      ;; A = IncYi
   9C35 DD 77 10      [19]  411          ld en_incYr(ix), a         ;; Intercambio 1
   9C38 78            [ 4]  412          ld    a,    b              ;; A = B = IncYr
   9C39 DD 77 05      [19]  413          ld en_vy(ix), a            ;; Intercambio 2
                            414 
                            415          ;; CAMBIO DE LAS X
   9C3C DD 7E 11      [19]  416          ld    a,    en_incXr(ix)   ;; A = IncXr
   9C3F 47            [ 4]  417          ld    b,    a              ;; B = A = IncXr
   9C40 DD 7E 04      [19]  418          ld    a,    en_vx(ix)      ;; A = IncXi
   9C43 DD 77 11      [19]  419          ld en_incXr(ix), a         ;; Intercambio 1
   9C46 78            [ 4]  420          ld    a,    b              ;; A = B = IncXr
   9C47 DD 77 04      [19]  421          ld en_vx(ix), a            ;; Intercambio 2
                            422 
   9C4A 3E 00         [ 7]  423          ld    a,    #0             ;; Finalmente cambio el flag de la velocidad
   9C4C DD 77 18      [19]  424          ld en_flagVel(ix), a       ;; flag_vel = 0
   9C4F                     425       utiliza_r:
                            426          ;; Aqui no hace falta cambiar ninguna velocidad
   9C4F DD 6E 12      [19]  427          ld    l, en_av_l(ix)       ;; HL = av
   9C52 DD 66 13      [19]  428          ld    h, en_av_h(ix)       ;; |
   9C55 EB            [ 4]  429          ex    de,   hl             ;; -- DE = av
   9C56 DD 6E 14      [19]  430          ld    l, en_avR_l(ix)      ;; -- HL = avI
   9C59 DD 66 15      [19]  431          ld    h, en_avR_h(ix)      ;; |
   9C5C 19            [11]  432          add   hl,   de             ;; DE + HL
   9C5D DD 75 12      [19]  433          ld en_av_l(ix), l          ;; -- av = (av + avI)
   9C60 DD 74 13      [19]  434          ld en_av_h(ix), h          ;; |
   9C63                     435    end_if:
   9C63 C9            [10]  436    ret
                            437 
                            438 
                            439 ;; ENTRADA:    HL -> Valor de 2 bytes a llevar a valor positivo, en caso que sea negativo
                            440 ;; DESTRUYE:   A, HL
                            441 ;; SALIDA:     HL -> Valor negativo negado = valor positivo
   9C64                     442 enemy_get_positive:
   9C64 7C            [ 4]  443    ld     a, h                ;; A = 00/FF
   9C65 FE 00         [ 7]  444    cp    #0                   ;; |
   9C67 C8            [11]  445    ret     z
   9C68 7D            [ 4]  446       ld    a, l              ;; A = -dY
   9C69 2F            [ 4]  447       cpl
   9C6A 3C            [ 4]  448       inc a                   ;; A =  dY -> Aqui ya tengo dY en positivo
   9C6B 26 00         [ 7]  449       ld    h, #0             ;; H = 00
   9C6D 6F            [ 4]  450       ld    l, a              ;; L = dY --> HL = 00**, donde ** = dY
...
Hexadecimal [16-Bits]
   ...
   9C6E C9            [10]  451    ret
                            452 
                            453 ;; Lo mismo que enemy_get_positive pero con negativos
   9C6F                     454 enemy_get_negative:
   9C6F 7C            [ 4]  455    ld    a, h                ;; A = FF/00
   9C70 FE FF         [ 7]  456    cp    #0xFF               ;; |
   9C72 C8            [11]  457    ret   z
   9C73 7D            [ 4]  458       ld    a,    l          ;; A = -dY
   9C74 2F            [ 4]  459       cpl
   9C75 3C            [ 4]  460       inc   a                ;; A =  dY -> Aqui ya tengo dY en positivo
   9C76 26 FF         [ 7]  461       ld    h,    #0xFF      ;; H = FF
   9C78 6F            [ 4]  462       ld    l,    a          ;; L = dY --> HL = FF**, donde ** = dY
   9C79 C9            [10]  463    ret
                            464 
                            465 
                            466 
