...
Hexadecimal [16-Bits]
                             ...
                             15 ;;======================================================================
                             16 ;;======================================================================
                     0009    17 enemy_size = e_size           ;; Tamanyo parametrizado
                     0001    18 k_max_enemies = 1
                             19 
   470B                      20 DefineEntity enemy_copy, #10, #10, #1, #4, #0, #0, #0x0F, #enemy_randomGoal
   470B                       1 enemy_copy:
   0000                       2    DefineDrawableEnt enemy_copy_dw, #10, #10, #1, #4                       ;;'
   0000                       1 enemy_copy_dw:
   470B 0A 0A                 2    .db   #10, #10      ;; Posicion    (x,y)
   470D 01 04                 3    .db   #1, #4      ;; Dimensiones (w,h)
   470F                       3    DefineMovableEnt  enemy_copy_mv, #0, #0                             ;;'
   0004                       1 enemy_copy_mv:
   470F 00 00                 2    .db   #0, #0    ;; Variables de la velocidad
                              4 ;; Si no tiene sprite
   4711 0F                    5    .db   #0x0F        ;; Color
                              6 ;; Si tiene sprite
                              7 ;;.dw   _spr
   4712 60 47                 8    .dw   #enemy_randomGoal        ;; Puntero a la funcion de update
                              9 
                             10 ;; Aqui falta saber el tamanyo de la entidad
                     0009    11 e_size = . - (enemy_copy)
                             21 
   4714                      22 vector_init:                  ;; Etiqueta de inicio del vector
   4714                      23 DefineNEntities enemy, k_max_enemies
                     0000     1    _c = 0
                              2    .rept k_max_enemies
                              3       DefineEntityDefault enemy, \_c
                              4       _c = _c + 1
                              5    .endm
   4714                       1       DefineEntityDefault enemy, \_c
   0009                       1    DefineEntity enemy0, 0xAA, 0, 0, 0, 0, 0, 0, 0xFFFF           ;;'
   0009                       1 enemy0:
   0009                       2    DefineDrawableEnt enemy0_dw, 0xAA, 0, 0, 0                       ;;'
   0009                       1 enemy0_dw:
   4714 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   4716 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   4718                       3    DefineMovableEnt  enemy0_mv, 0, 0                             ;;'
   000D                       1 enemy0_mv:
   4718 00 00                 2    .db   0, 0    ;; Variables de la velocidad
                              4 ;; Si no tiene sprite
   471A 00                    5    .db   0        ;; Color
                              6 ;; Si tiene sprite
                              7 ;;.dw   _spr
   471B FF FF                 8    .dw   0xFFFF        ;; Puntero a la funcion de update
                              9 
                             10 ;; Aqui falta saber el tamanyo de la entidad
                     0009    11 e_size = . - (enemy0)
                     0001     2       _c = _c + 1
   471D FF                   24 vector_end:    .db #0xFF      ;; Indico 0xFF como fin del vector
                             25 
                             26 ;;======================================================================
...
Hexadecimal [16-Bits]
                             ...
                             30 ;;======================================================================
                             31 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             32 ;; COPIA LOS ENEMIGOS DEL BUCLE CON UNA ENTIDAD "MODELO"
                             33 ;; _______________________
                             34 ;; DESTRUYE:   HL
                             35 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   471E                      36 enemy_create::
   471E 21 4D 47      [10]   37    ld hl, #enemy_init
   4721 C3 36 47      [10]   38    jp enemy_search
                             39 
                             40 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             41 ;; ASIGNA LA FUNCION DE DIBUJADO EN HL Y RECORRE EL BUCLE
                             42 ;; _______________________
                             43 ;; DESTRUYE:   HL
                             44 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4724                      45 enemy_draw_ALL::
   4724 21 BF 45      [10]   46    ld hl, #dw_draw
   4727 C3 36 47      [10]   47    jp enemy_search
                             48 
                             49 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             50 ;; ASIGNA LA FUNCION DE CLEAR EN HL Y RECORRE EL BUCLE
                             51 ;; _______________________
                             52 ;; DESTRUYE:   HL
                             53 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   472A                      54 enemy_clear_ALL::
   472A 21 EA 45      [10]   55    ld hl, #dw_clear
   472D C3 36 47      [10]   56    jp enemy_search
                             57 
                             58 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             59 ;; ASIGNA LA FUNCION DE UPDATE EN HL Y RECORRE EL BUCLE
                             60 ;; _______________________
                             61 ;; DESTRUYE:   HL
                             62 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4730                      63 enemy_update_ALL::
   4730 21 59 47      [10]   64    ld hl, #enemy_update
   4733 C3 36 47      [10]   65    jp enemy_search
                             66 
                             67 ;;======================================================================
                             68 ;;======================================================================
                             69 ;; FUNCIONES PRIVADAS
                             70 ;;======================================================================
                             71 ;;======================================================================
                             72 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             73 ;; RECORRE EL BUCLE DE ENEMIGOS
                             74 ;; _______________________
                             75 ;; ENTRADA:    HL -> Puntero a funcion custom
                             76 ;; DESTRUYE:   A, DE, IX
                             77 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4736                      78 enemy_search:
   4736 DD 21 14 47   [14]   79    ld    ix,   #vector_init      ;; IX apunta al inicio de vector_bullets (a la primera entidad)
   473A 22 44 47      [16]   80    ld    (f_custom), hl          ;; Cargo en el call de abajo la funcion a la que quiero llamar en cada momento determinado
   473D                      81    search_loop:
...
Hexadecimal [16-Bits]
   ...
   473D DD 7E 00      [19]   82       ld     a,   0(ix)                ;; Compruebo que no he llegado al final del vector
   4740 FE FF         [ 7]   83       cp    #0xFF                      ;; A - 0xFF
   4742 C8            [11]   84       ret    z                         ;; if(A==0xFF) -> Sale del vector
                             85 
                     0039    86       f_custom = . +1                  ;; . apunta a 'call' y con el '+1' apunta a '(0x0000)' -> (siempre va a cambiar)
   4743 CD 00 00      [17]   87       call (0x0000)                    ;; LLAMADA A FUNCION PERSONALIZABLE
   4746 11 09 00      [10]   88       ld    de,   #enemy_size          ;; Cargo en DE el tamanyo de la entidad bullet para despues sumarlo a HL
   4749 DD 19         [15]   89       add   ix,   de                   ;; IX + DE = Apunta a la siguiente entidad bullet
   474B 18 F0         [12]   90    jr search_loop
                             91 
                             92 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             93 ;; COPIA LA ENTIDAD EN IX CON EL ENEMIGO POR DEFECTO
                             94 ;; _______________________
                             95 ;; ENTRADA:    IX -> Puntero a entidad enemigo del bucle
                             96 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   474D                      97 enemy_init:
   474D DD E5         [15]   98    push  ix                ;; El valor de IX va a la pila
   474F D1            [10]   99    pop   de                ;; DE ahora tiene el valor de IX
   4750 21 0B 47      [10]  100    ld    hl, #enemy_copy   ;; HL apunta al destino de la copia
   4753 01 09 00      [10]  101    ld    bc, #enemy_size   ;; BC tiene el tamanyo del enemigo
   4756 ED B0         [21]  102    ldir                    ;; ELEDIR
   4758 C9            [10]  103    ret
                            104 
                            105 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            106 ;; LLAMA A LA FUNCION PROPIA DE UPDATE DE CADA ENEMIGO
                            107 ;; _______________________
                            108 ;; ENTRADA:    IX -> Puntero a entidad enemigo del bucle
                            109 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4759                     110 enemy_update:
   4759 DD 6E 07      [19]  111    ld    l, e_up_l(ix)     ;; Cargo el byte bajo en L
   475C DD 66 08      [19]  112    ld    h, e_up_h(ix)     ;; Cargo el byte alto en H
   475F E9            [ 4]  113    jp    (hl)              ;; Llamo a la funcion
                            114 
                            115 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            116 ;; BUSCA UN PUNTO ALEATORIO PARA IR HACIA ALLI
                            117 ;; _______________________
                            118 ;; ENTRADA:    IX -> Puntero a entidad enemigo del bucle
                            119 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4760                     120 enemy_randomGoal:
                            121    ;call cpct_getRandom_mxor_u16_asm        ;; Lo devuelve en HL
   4760 C9            [10]  122    ret
                            123 
                            124 
                            125 
