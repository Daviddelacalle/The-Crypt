...
Hexadecimal [16-Bits]
                             ...
                             21 
                             22 
   994F                      23 load_control::
   994F CD 64 9F      [17]   24   call cpct_scanKeyboard_asm   ;;scanear el teclado para ver si hay alguna tecla pulsada
   9952 21 08 20      [10]   25   ld 		hl, #Key_A 			 ;; Cargamos en el registro HL la tecla que quermos comprobar
   9955 CD D6 9C      [17]   26   call cpct_isKeyPressed_asm
   9958 20 7B         [12]   27   jr nz, map_start
                             28 
                             29 
   995A                      30   drawMenu::
                             31       ;;ld hl, #_m_000
                             ...
                             33       ;;ld b, #25      ;100
                             34       ;;ld de, #22
                             35       ;;call cpct_etm_setDrawTilemap4x8_ag_asm
                             36 
                             37       ;;ld hl, #0xC000
                             38       ;;ld de, (menu_ptr)
                             39       ;;call cpct_etm_drawTilemap4x8_ag_asm
                             40 
   995A 21 84 43      [10]   41       ld hl,#_m_PRESSA2_0
   995D 11 80 C2      [10]   42       ld de,#0xC280
   9960 0E 28         [ 7]   43       ld c, #40
   9962 06 42         [ 7]   44       ld b, #66
   9964 CD E2 9C      [17]   45       call cpct_drawSprite_asm
   9967 21 D4 4D      [10]   46       ld hl,#_m_PRESSA2_1
   996A 11 A8 C2      [10]   47       ld de, #0xC2A8
   996D 0E 28         [ 7]   48       ld c, #40
   996F 06 42         [ 7]   49       ld b, #66
   9971 CD E2 9C      [17]   50       call cpct_drawSprite_asm
                             51 
                             52 
   9974 C9            [10]   53   ret
