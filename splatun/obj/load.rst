...
Hexadecimal [16-Bits]
                             ...
                             21 
                             22 
   38F3                      23 load_control::
   38F3 CD 93 41      [17]   24   call cpct_scanKeyboard_asm   ;;scanear el teclado para ver si hay alguna tecla pulsada
   38F6 21 08 20      [10]   25   ld 		hl, #Key_A 			 ;; Cargamos en el registro HL la tecla que quermos comprobar
   38F9 CD BC 3E      [17]   26   call cpct_isKeyPressed_asm
   38FC C2 14 3A      [10]   27   jp nz, map_start
                             28 
                             29 
   38FF                      30   drawMenu::
                             31 
                             ...
                             34       ;;ld b, #25      ;100
                             35       ;;ld de, #22
                             36       ;;call cpct_etm_setDrawTilemap4x8_ag_asm
                             37 
                             38       ;;ld hl, #0xC000
                             39       ;;ld de, (menu_ptr)
                             40       ;;call cpct_etm_drawTilemap4x8_ag_asm
                             41 
   38FF 21 40 00      [10]   42       ld hl,#decompress_buffer
   3902 11 80 C2      [10]   43       ld de,#0xC280
   3905 0E 28         [ 7]   44       ld c, #40
   3907 06 42         [ 7]   45       ld b, #66
   3909 CD C8 3E      [17]   46       call cpct_drawSprite_asm  ;; Inicio del buffer de descompresión ¬
   390C 21 90 0A      [10]   47       ld hl,#0xA90              ;;              Offeset = 2640 + 64 (0x40) = 2704 = 0xA90
   390F 11 A8 C2      [10]   48       ld de, #0xC2A8
   3912 0E 28         [ 7]   49       ld c, #40
   3914 06 42         [ 7]   50       ld b, #66
   3916 CD C8 3E      [17]   51       call cpct_drawSprite_asm
                             52 
                             53 
   3919 C9            [10]   54   ret
