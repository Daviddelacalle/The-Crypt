...
Hexadecimal [16-Bits]
                             ...
                             14 
                             15 ;==========================================================;
                             16 ;   Disable firmware to avoid configuration override
                             17 ;   Load custom palette
                             18 ;==========================================================;
                             19 .macro init
                             20     call cpct_disableFirmware_asm
                             21     ld    c, #0
                             22     call cpct_setVideoMode_asm
                             23 
                             24     ld hl, #_g_palette
                             25     ld de, #16
                             26     call cpct_setPalette_asm
                             27 
                             28     ;; Clean 16K: 0x8000 -> 0xC000
                             29     ld  hl,  #0x8000
                             30     ld (hl), #0
                             31     ld  de,  #0x8000 + 1
                             32     ld  bc,  #0x4000 - 1
                             ...
                             35 .endm
                             36 
   2D3D 05                   37 unavariable: .db #5
                             38 
   2D3E                      39 isr:
                             40 
   2D3E 08            [ 4]   41   ex af,af';'
   2D3F D9            [ 4]   42   exx
                             43 
   2D40 DD E5         [15]   44   push ix
   2D42 F5            [11]   45   push af
   2D43 C5            [11]   46   push bc
   2D44 D5            [11]   47   push de
   2D45 E5            [11]   48   push hl
   2D46 FD E5         [15]   49   push iy
                             50 
   2D48 3A 3D 2D      [13]   51   ld a, (unavariable)
   2D4B 3D            [ 4]   52   dec a
   2D4C 32 3D 2D      [13]   53   ld (unavariable), a
   2D4F 20 08         [12]   54   jr nz, return
                             55 
   2D51 CC 00 35      [17]   56   call z, cpct_akp_musicPlay_asm
   2D54 3E 05         [ 7]   57   ld a, #5
   2D56 32 3D 2D      [13]   58   ld (unavariable), a
                             59 
   2D59                      60   return:
                             61     ; ld a, #_cpct_akp_songLoopTimes
                             62     ; cp #1
                             63     ; jr nz, noparar
...
Hexadecimal [16-Bits]
                             ...
                             64     ; call cpct_akp_stop_asm
                             65     ; noparar:
   2D59 FD E1         [14]   66     pop iy
   2D5B E1            [10]   67     pop hl
   2D5C D1            [10]   68     pop de
   2D5D C1            [10]   69     pop bc
   2D5E F1            [10]   70     pop af
   2D5F DD E1         [14]   71     pop ix
                             72 
   2D61 D9            [ 4]   73     exx
   2D62 08            [ 4]   74     ex af,af';'
                             75 
   2D63 C9            [10]   76 ret
                             77 
                             78 
                             79 ;; Punto de entrada de la funcion main
   2D64                      80 _main::
                             81     ; --> Realocate stack memory <-- ;
   2D64 31 00 80      [10]   82     ld sp, #0x8000
                             83 
   002A                      84     init
   2D67 CD E6 3E      [17]    1     call cpct_disableFirmware_asm
   2D6A 0E 00         [ 7]    2     ld    c, #0
   2D6C CD 80 3E      [17]    3     call cpct_setVideoMode_asm
                              4 
   2D6F 21 F7 0C      [10]    5     ld hl, #_g_palette
   2D72 11 10 00      [10]    6     ld de, #16
   2D75 CD DF 34      [17]    7     call cpct_setPalette_asm
                              8 
                              9     ;; Clean 16K: 0x8000 -> 0xC000
   2D78 21 00 80      [10]   10     ld  hl,  #0x8000
   2D7B 36 00         [10]   11     ld (hl), #0
   2D7D 11 01 80      [10]   12     ld  de,  #0x8000 + 1
   2D80 01 FF 3F      [10]   13     ld  bc,  #0x4000 - 1
   2D83 ED B0         [21]   14     ldir
                             15 
   2D85 21 3E 2D      [10]   85     ld hl, #isr
   2D88 CD B7 34      [17]   86     call cpct_setInterruptHandler_asm
                             87 
   2D8B 11 1F 01      [10]   88     ld de, #_sfx
   2D8E CD 96 3C      [17]   89     call cpct_akp_SFXInit_asm
                             90 
   2D91                      91     menu::
   2D91 11 40 00      [10]   92     ld de, #_song_ingame
   2D94 CD 0A 3C      [17]   93     call cpct_akp_musicInit_asm
   2D97 CD 9F 2C      [17]   94     call loadMenu
                             95 
   2D9A 21 24 09      [10]   96     ld hl, #SEED    ;; SEED
   2D9D 11 A3 2D      [10]   97     ld de, #map_start
   2DA0 CD 1E 2E      [17]   98     call waitInput  ;; In util.s
   2DA3                      99     map_start::
                            100 
   2DA3 CD 87 33      [17]  101         call recalculateCameraOffset
   2DA6 CD 93 34      [17]  102         call drawHud
   2DA9 CD 9A 2B      [17]  103         call dw_drawHearts
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 52.
Hexadecimal [16-Bits]



                            104         ;; Switch buffers and draw the same
   2DAC CD 0E 2B      [17]  105         call swapBuffers
   2DAF CD 93 34      [17]  106         call drawHud
   2DB2 CD 9A 2B      [17]  107         call dw_drawHearts
                            108         ;; Back to the original buffer
   2DB5 CD 0E 2B      [17]  109         call swapBuffers
                            110 
   2DB8 CD 10 2E      [17]  111         call resetTilemap
                            112 
   2DBB CD 21 2A      [17]  113         call loadLevel1       ;; Loads level 1
                            114 
                            115     ;; GAME LOOP
   2DBE                     116     loop::
                            117 
                            118         ;; DRO
   2DBE CD 84 34      [17]  119         call drawMap
   2DC1 CD BC 2F      [17]  120         call enemy_draw_ALL
   2DC4 CD FA 27      [17]  121         call bullet_draw
   2DC7 CD 4E 26      [17]  122         call hero_draw
                            123 
                            124         ;; UPDEIT
   2DCA CD FC 2F      [17]  125         call enemy_update_ALL
   2DCD CD 55 26      [17]  126         call hero_update
   2DD0 CD 16 28      [17]  127         call bullet_inputs
   2DD3 CD 00 28      [17]  128         call bullet_update
                            129 
   2DD6 CD CD 3E      [17]  130         call cpct_waitVSYNC_asm
   2DD9 CD 0E 2B      [17]  131         call swapBuffers
   2DDC 18 E0         [12]  132 jr loop
