...
Hexadecimal [16-Bits]
                             ...
                             15 
                             16 
                     0040    17 decompress_buffer       == 0x040
                     14A0    18 imageMaxSize             = 0x14A0
                     14DF    19 buffer_end_img = decompress_buffer + imageMaxSize - 1
                             20 
                             21 ;==========================================================;
                             22 ;   Disable firmware to avoid configuration override
                             23 ;   Load custom palette
                             24 ;==========================================================;
                             25 .macro init
                             26     call cpct_disableFirmware_asm
                             27     ld    c, #0
                             28     call cpct_setVideoMode_asm
                             29 
                             30     ld hl, #_g_palette
                             31     ld de, #16
                             32     call cpct_setPalette_asm
                             33 
                             34     ;; Clean 16K: 0x8000 -> 0xC000
                             35     ld  hl,  #0x8000
                             36     ld (hl), #0
                             37     ld  de,  #0x8000 + 1
                             38     ld  bc,  #0x4000 - 1
                             ...
                             40 
                             41     ld hl, #_g_00
                             42     ld c, #VIEWPORT_WIDTH        ;; Ancho
                             43     ld b, #VIEWPORT_HEIGHT        ;; Alto
                             44     ld de, #30
                             45     call cpct_etm_setDrawTilemap4x8_ag_asm
                             46 .endm
                             47 
                             48 ;; Punto de entrada de la funcion main
   39D5                      49 _main::
                             50     ; --> Realocate stack memory <-- ;
   39D5 31 00 80      [10]   51     ld sp, #0x8000
                             52 
   0003                      53     init
   39D8 CD 69 40      [17]    1     call cpct_disableFirmware_asm
   39DB 0E 00         [ 7]    2     ld    c, #0
   39DD CD 14 40      [17]    3     call cpct_setVideoMode_asm
                              4 
   39E0 21 E0 18      [10]    5     ld hl, #_g_palette
   39E3 11 10 00      [10]    6     ld de, #16
   39E6 CD A9 3E      [17]    7     call cpct_setPalette_asm
                              8 
                              9     ;; Clean 16K: 0x8000 -> 0xC000
   39E9 21 00 80      [10]   10     ld  hl,  #0x8000
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 51.
Hexadecimal [16-Bits]



   39EC 36 00         [10]   11     ld (hl), #0
   39EE 11 01 80      [10]   12     ld  de,  #0x8000 + 1
   39F1 01 FF 3F      [10]   13     ld  bc,  #0x4000 - 1
   39F4 ED B0         [21]   14     ldir
                             15 
   39F6 21 E0 14      [10]   16     ld hl, #_g_00
   39F9 0E 10         [ 7]   17     ld c, #VIEWPORT_WIDTH        ;; Ancho
   39FB 06 10         [ 7]   18     ld b, #VIEWPORT_HEIGHT        ;; Alto
   39FD 11 1E 00      [10]   19     ld de, #30
   3A00 CD 4B 41      [17]   20     call cpct_etm_setDrawTilemap4x8_ag_asm
   3A03 CD FF 38      [17]   54     call drawMenu
                             55 
   3A06 21 F3 1B      [10]   56     ld hl, #_titleScreen_end
   3A09 11 DF 14      [10]   57     ld de, #buffer_end_img
   3A0C CD 21 40      [17]   58     call cpct_zx7b_decrunch_s_asm
                             59 
   3A0F                      60     loop_load::
                             61 
   3A0F CD F3 38      [17]   62       call load_control
   3A12 18 FB         [12]   63       jr loop_load
   3A14                      64       map_start::
                             65 
   3A14 CD 8D 38      [17]   66       call loadLevel1       ;; Cargo el nivel 1
   3A17 CD 99 3E      [17]   67       call drawMap
                             68 
                             69     ;; Comienza el bucle del juego
   3A1A                      70     loop::
                             71 
                             72         ;; CLIAR
                             73         ;call bullet_clear
                             74         ;call obs_clear
                             75         ;call enemy_clear_ALL
                             76         ;call hero_clear
                             77 
                             78         ;; DRO
   3A1A CD 99 3E      [17]   79         call drawMap
   3A1D CD 79 36      [17]   80         call bullet_draw
   3A20 CD 93 3A      [17]   81         call enemy_draw_ALL
   3A23 CD 21 35      [17]   82         call hero_draw
                             83 
                             84         ;; UPDEIT
   3A26 CD 9E 3A      [17]   85         call enemy_update_ALL
   3A29 CD 28 35      [17]   86         call hero_update
   3A2C CD 9B 36      [17]   87         call bullet_inputs
   3A2F CD 7F 36      [17]   88         call bullet_update
                             89 
   3A32 CD 61 40      [17]   90         call cpct_waitVSYNC_asm
   3A35 CD 1C 39      [17]   91         call swapBuffers
   3A38 CD 9F 3D      [17]   92         call kill
   3A3B 18 DD         [12]   93 jr loop
