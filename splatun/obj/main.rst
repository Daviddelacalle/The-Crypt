...
Hexadecimal [16-Bits]
   ...
   99BC                      33 _main::
                             ...
                             36 
   0000                      37     init
   99BC CD 3A 9E      [17]    1     call cpct_disableFirmware_asm
   99BF 0E 00         [ 7]    2     ld    c, #0
   99C1 CD 25 9E      [17]    3     call cpct_setVideoMode_asm
                              4 
   99C4 21 E4 58      [10]    5     ld hl, #_g_palette
   99C7 11 10 00      [10]    6     ld de, #16
   99CA CD C3 9C      [17]    7     call cpct_setPalette_asm
   99CD CD 5A 99      [17]   38     call drawMenu
                             39 
                             40     ;call enemy_create
                             41 
   99D0                      42     loop_load::
                             43 
   99D0 CD 4F 99      [17]   44      call load_control
   99D3 18 FB         [12]   45      jr loop_load
   99D5                      46      map_start::
   99D5 CD AA 9C      [17]   47         call drawMap
                             48     ;; Comienza el bucle del juego
   99D8                      49     loop::
                             50 
   99D8 CD 4C 98      [17]   51         call bullet_inputs
                             52 
                             53         ;; UPDEIT
   99DB CD 47 9A      [17]   54         call enemy_update_ALL
   99DE CD 8B 97      [17]   55         call hero_update
   99E1 CD 40 98      [17]   56         call bullet_update
...
Hexadecimal [16-Bits]
                             ...
                             57 
   99E4 CD 32 9E      [17]   58         call cpct_waitVSYNC_asm
                             59 
                             60         ;; CLIAR
   99E7 CD 41 9A      [17]   61         call enemy_clear_ALL
   99EA CD 46 98      [17]   62         call bullet_clear
   99ED CD 8C 9C      [17]   63         call obs_clear
   99F0 CD 84 97      [17]   64         call hero_clear
                             65 
                             66         ;; DRO
   99F3 CD 3B 9A      [17]   67         call enemy_draw_ALL
   99F6 CD 3A 98      [17]   68         call bullet_draw
   99F9 CD 85 9C      [17]   69         call obs_draw
   99FC CD 7D 97      [17]   70         call hero_draw
                             71 
   99FF 18 D7         [12]   72 jr loop
