...
Hexadecimal [16-Bits]
                              ...
                              7 
                              8 ;; ================================================================================================ ;;
                              9 ;; HAY QUE CAMBIAR LAS OPCIONES DE COMPILADO, PARA LOS .globl, Y EL INICIO DEL PROGRAMA A LA 0x0040 ;;
                             10 ;; ================================================================================================ ;;
                             11 
...
Hexadecimal [16-Bits]
                             ...
                             23 
                             24 ;==========================================================;
                             25 ;   Disable firmware to avoid configuration override
                             26 ;   Load custom palette
                             27 ;==========================================================;
                             28 .macro init
                             29     call cpct_disableFirmware_asm
                             30     ld    c, #0
                             31     call cpct_setVideoMode_asm
                             32 
                             33     ld hl, #_g_palette
                             34     ld de, #16
                             35     call cpct_setPalette_asm
                             36 .endm
                             37 
                             38 ;==========================================================;
                             39 ;   Draws the complete map
                             40 ;==========================================================;
   46B7                      41 drawMap:
   46B7 21 84 43      [10]   42     ld hl, #_g_0
   46BA 0E 14         [ 7]   43     ld c, #20       ;40
   46BC 06 19         [ 7]   44     ld b, #25      ;100
   46BE 11 1E 00      [10]   45     ld de, #30
   46C1 CD 50 49      [17]   46     call cpct_etm_setDrawTilemap4x8_ag_asm
                             47 
   46C4 21 00 C0      [10]   48     ld hl, #0xC000
   46C7 11 00 40      [10]   49     ld de, #_nivel1
   46CA CD 81 47      [17]   50     call cpct_etm_drawTilemap4x8_ag_asm
   46CD C9            [10]   51 ret
                             52 
                             53 
                             54 ;; Punto de entrada de la funcion main
   46CE                      55 _main::
                             56     ; --> Realocate stack memory <-- ;
                             57     ;ld sp, #0x8000
                             58 
   0017                      59     init
   46CE CD 46 48      [17]    1     call cpct_disableFirmware_asm
   46D1 0E 00         [ 7]    2     ld    c, #0
   46D3 CD 31 48      [17]    3     call cpct_setVideoMode_asm
                              4 
   46D6 21 44 44      [10]    5     ld hl, #_g_palette
   46D9 11 10 00      [10]    6     ld de, #16
   46DC CD 6E 47      [17]    7     call cpct_setPalette_asm
                             60     ;;call drawMap
   46DF CD 1E 47      [17]   61     call enemy_create
                             62 
                             63     ;; Comienza el bucle del juego
   46E2                      64     loop:
...
Hexadecimal [16-Bits]
   ...
   46E2 CD BB 44      [17]   65         call bullet_inputs
                             66 
                             67         ;; CLIAR
   46E5 CD 2A 47      [17]   68         call enemy_clear_ALL
   46E8 CD B5 44      [17]   69         call bullet_clear
   46EB CD 8C 46      [17]   70         call obs_clear
   46EE CD 0A 46      [17]   71         call hero_clear
                             72 
                             73         ;; UPDEIT
   46F1 CD 30 47      [17]   74         call enemy_update_ALL
   46F4 CD 11 46      [17]   75         call hero_update
   46F7 CD AF 44      [17]   76         call bullet_update
                             77 
                             78         ;; DRO
   46FA CD 24 47      [17]   79         call enemy_draw_ALL
   46FD CD 03 46      [17]   80         call hero_draw
   4700 CD A9 44      [17]   81         call bullet_draw
   4703 CD 85 46      [17]   82         call obs_draw
                             83 
   4706 CD 3E 48      [17]   84         call cpct_waitVSYNC_asm
   4709 18 D7         [12]   85 jr loop
