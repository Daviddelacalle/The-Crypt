...
Hexadecimal [16-Bits]
                             ...
                             15 
                             16 ;menu_ptr:    .dw #_g_tile_tileset
                             17 
                             18 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             19 ;; BUCLE PARA EL MENU
                             20 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             21 
                     01DB    22 decompress_buffer       == 0x1DB
                     071C    23 imageMaxSize             = 0x71C
                     08F6    24 buffer_end_menu = decompress_buffer + imageMaxSize - 1
                             25 
                             26 
   2C9F                      27 loadMenu::
                             28 
   2C9F CD 20 2D      [17]   29     call clearUpperMenuZone
                             30 
   2CA2 21 32 26      [10]   31     ld hl, #_Menu_1_end
   2CA5 CD 19 2D      [17]   32     call uncompress
   2CA8 11 A0 10      [10]   33     ld de, #0x10A0
   2CAB CD 06 2D      [17]   34     call drawMenu
                             35 
   2CAE 21 2D 25      [10]   36     ld hl, #_Menu_2_end
   2CB1 CD 19 2D      [17]   37     call uncompress
   2CB4 11 B4 10      [10]   38     ld de, #0x10B4
   2CB7 CD 06 2D      [17]   39     call drawMenu
                             40 
   2CBA 21 DA 22      [10]   41     ld hl, #_Menu_3_end
   2CBD CD 19 2D      [17]   42     call uncompress
   2CC0 11 C8 10      [10]   43     ld de, #0x10C8
   2CC3 CD 06 2D      [17]   44     call drawMenu
                             45 
   2CC6 21 90 20      [10]   46     ld hl, #_Menu_4_end
   2CC9 CD 19 2D      [17]   47     call uncompress
   2CCC 11 DC 10      [10]   48     ld de, #0x10DC
   2CCF CD 06 2D      [17]   49     call drawMenu
                             50     ;==========
   2CD2 21 BF 1F      [10]   51     ld hl, #_Menu_5_end
   2CD5 CD 19 2D      [17]   52     call uncompress
   2CD8 11 10 2C      [10]   53     ld de, #0x2C10
   2CDB CD 06 2D      [17]   54     call drawMenu
                             55 
   2CDE 21 29 1F      [10]   56     ld hl, #_Menu_6_end
   2CE1 CD 19 2D      [17]   57     call uncompress
   2CE4 11 24 2C      [10]   58     ld de, #0x2C24
   2CE7 CD 06 2D      [17]   59     call drawMenu
                             60 
   2CEA 21 86 1D      [10]   61     ld hl, #_Menu_7_end
   2CED CD 19 2D      [17]   62     call uncompress
   2CF0 11 38 2C      [10]   63     ld de, #0x2C38
   2CF3 CD 06 2D      [17]   64     call drawMenu
                             65 
   2CF6 21 3E 1C      [10]   66     ld hl, #_Menu_8_end
   2CF9 CD 19 2D      [17]   67     call uncompress
   2CFC 11 4C 2C      [10]   68     ld de, #0x2C4C
   2CFF CD 06 2D      [17]   69     call drawMenu
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 54.
Hexadecimal [16-Bits]



   2D02 CD 0E 2B      [17]   70     call swapBuffers
   2D05 C9            [10]   71 ret
                             72 
                             73 ;; 0x50 + 0x50 + 0x800 + 0x800 = 0x10A0
                             74 ;; 0x50 * 0xD + 0x800 * 0x5 = 2C10
                             75 
   2D06                      76 drawMenu:
   2D06 3A EB 2A      [13]   77     ld a, (back_buffer)
   2D09 67            [ 4]   78     ld h, a
   2D0A 2E 00         [ 7]   79     ld l, #0x00
   2D0C 19            [11]   80     add hl, de
   2D0D EB            [ 4]   81     ex de, hl
   2D0E 0E 14         [ 7]   82     ld c, #20
   2D10 06 5B         [ 7]   83     ld b, #91
   2D12 21 DB 01      [10]   84     ld hl,#decompress_buffer
   2D15 CD 27 3D      [17]   85     call cpct_drawSprite_asm  ;; Inicio del buffer de descompresión ¬
   2D18 C9            [10]   86 ret
                             87 
                             88 
                             89 
   2D19                      90 uncompress:
   2D19 11 F6 08      [10]   91     ld de, #buffer_end_menu
   2D1C CD 8D 3E      [17]   92     call cpct_zx7b_decrunch_s_asm
   2D1F C9            [10]   93 ret
                             94 
   2D20                      95 clearUpperMenuZone:
                             96 
   2D20 CD B8 2A      [17]   97     call fillAlternativeBuffer
   2D23 21 F7 08      [10]   98     ld hl, #_g_00
   2D26 11 1E 00      [10]   99     ld de, #30
   2D29 06 03         [ 7]  100     ld b, #3
   2D2B 0E 14         [ 7]  101     ld c, #20
   2D2D CD 38 3F      [17]  102     call cpct_etm_setDrawTilemap4x8_ag_asm
                            103 
   2D30 11 6E 05      [10]  104     ld de, #alternative_buffer
   2D33 3A EB 2A      [13]  105     ld a, (back_buffer)
   2D36 67            [ 4]  106     ld h, a
   2D37 2E 00         [ 7]  107     ld l, #0x00
                            108 
   2D39 CD C7 3D      [17]  109     call cpct_etm_drawTilemap4x8_ag_asm
                            110 
   2D3C C9            [10]  111 ret
