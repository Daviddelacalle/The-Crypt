...
Hexadecimal [16-Bits]
   ...
   45BF                      34 dw_draw::
                             ...
                             36 
   45BF 11 00 C0      [10]   37    ld    de,   #0xC000                  ;; Apunta al inicio de la memoria de video
                             38 
   45C2 DD 7E 00      [19]   39    ld a, e_x(ix)                        ;; Consigue la posicion del jugador
   45C5 21 7A 46      [10]   40    ld hl, #CameraMinMax                 ;; Cargo en HL la coordenada minima en X
   45C8 96            [ 7]   41    sub (hl)                             ;; Le resto a A, esta coordenada
   45C9 FE 50         [ 7]   42    cp #80                               ;; Compruebo que esté entre 0 y 80
   45CB D0            [11]   43    ret nc                               ;; Si está fuera del límite no la dibujo
   45CC 4F            [ 4]   44    ld     c,   a      ;; x  [0-79]
                             45 
   45CD DD 7E 01      [19]   46    ld a, e_y(ix)
   45D0 21 7B 46      [10]   47    ld hl, #CameraMinMax+1
   45D3 96            [ 7]   48    sub (hl)
   45D4 FE 64         [ 7]   49    cp #100
   45D6 D0            [11]   50    ret nc
   45D7 87            [ 4]   51    add a
   45D8 47            [ 4]   52    ld     b,   a      ;; y  [0-199]
   45D9 CD 03 49      [17]   53    call cpct_getScreenPtr_asm
                             54 
                             55    ;; SIN SPRITE
   45DC EB            [ 4]   56    ex    de,   hl          ;; Apunta a la posicion x,y
   45DD DD 7E 06      [19]   57    ld     a,   e_col(ix)    ;; Código de color
   45E0 DD 4E 02      [19]   58    ld     c,   e_w(ix)      ;; Ancho
   45E3 DD 46 03      [19]   59    ld     b,   e_h(ix)      ;; Alto
   45E6 CD 56 48      [17]   60    call cpct_drawSolidBox_asm
                             61 
                             62    ;; CON SPRITE
...
Hexadecimal [16-Bits]
   ...
   45E9 C9            [10]   68    ret
                             ...
                             72 ;==================================
   45EA                      73 dw_clear::
   45EA DD 7E 06      [19]   74   ld  a, e_col(ix)
   45ED 08            [ 4]   75   ex af, af'            ;'
                             76 
   45EE DD 36 06 00   [19]   77   ld  e_col(ix), #0
                             78 
   45F2 CD BF 45      [17]   79   call dw_draw
   45F5 08            [ 4]   80   ex af, af'            ;'
   45F6 DD 77 06      [19]   81   ld e_col(ix), a
                             82 
   45F9 C9            [10]   83  ret
                             84 
                             85 ;;======================================================================
