...
Hexadecimal [16-Bits]
                             ...
                             13 
   391A C0                   14 front_buffer:   .db 0xC0
   391B 80                   15 back_buffer::   .db 0x80
                             16 
                             17 ;;======================================================================
                             18 ;;======================================================================
                             19 ;; DATOS PRIVADOS
                             ...
                             29 
   391C                      30 swapBuffers::
   391C 3A 1B 39      [13]   31     ld a, (back_buffer)
   391F 47            [ 4]   32     ld b, a
   3920 3A 1A 39      [13]   33     ld a, (front_buffer)
   3923 32 1B 39      [13]   34     ld (back_buffer), a
   3926 78            [ 4]   35     ld a, b
   3927 32 1A 39      [13]   36     ld (front_buffer), a
                             37 
   392A CB 38         [ 8]   38     srl b
   392C CB 38         [ 8]   39     srl b
   392E 68            [ 4]   40     ld l, b
   392F C3 0B 40      [10]   41     jp cpct_setVideoMemoryPage_asm
                             42 
                             43 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             44 ;; DIBUJADO DE UNA ENTIDAD
                             45 ;; _______________________
                             46 ;; ENTRADA: IX -> Puntero a entidad
                             47 ;; DESTRUYE: AF, BC, DE, HL
                             48 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   3932                      49 dw_draw::
                             50    ;; Funcion dibujado de las entidades que cuelgan de drawable.s
                             51 
                             52    ;; Si A == AA -> LAS COORDENADAS DEL OBJETO AL QUE APUNTA IX ESTAN EN TILES
                             53    ;; Si lo es, entonces -> pasar a coordenadas de MAPA y ver si hay que dibujarlo
                             54 
                             55    ;; Primero se checkea si A == AA
   3932 FE AA         [ 7]   56    cp    #0xAA
   3934 20 20         [12]   57    jr nz, normal_dro
                             58 
                             59    ;; OPERACIONES EN COORDENADAS DE TILES, NO EN COORDENADAS DE MAPA
   3936 2A DE 3D      [16]   60    ld    hl, (cam_max)
   3939 EB            [ 4]   61    ex    de, hl            ;; E = X, D = Y -> Coordenadas maximas
   393A 2A DC 3D      [16]   62    ld    hl, (cam_min)     ;; L = X, H = Y -> Coordenadas minimas
                             63 
   393D DD 7E 00      [19]   64    ld    a, e_x(ix)        ;; A = enemy_x
   3940 BD            [ 4]   65    cp    l                 ;; Ver si X es mayor que la coordenada X minima
   3941 D8            [11]   66    ret   c                    ;; Si A > x_min <----> C = 0
   3942 BB            [ 4]   67    cp    e                 ;; Ver si X es menor que la coordenada X maxima
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 56.
Hexadecimal [16-Bits]



   3943 D0            [11]   68    ret   nc                   ;; Si A < x_max <----> C = 1
                             69 
   3944 DD 7E 01      [19]   70    ld    a, e_y(ix)        ;; A = enemy_y
   3947 BC            [ 4]   71    cp    h                 ;; Ver si X es mayor que la coordenada Y minima
   3948 D8            [11]   72    ret   c                    ;; Si A > y_min <----> C = 0
   3949 BA            [ 4]   73    cp    d                 ;; Ver si X es menor que la coordenada Y maxima
   394A D0            [11]   74    ret   nc                   ;; Si A < y_max <----> C = 1
                             75 
                             76    ;; Si llega aqui significa que esta dentro de los limites
                             77    ;; Corregir offset de la camara
                             78       ;; HAY QUE COGER UNAS COORDENADAS RELATIVAS A LA POSICION DE LA CAMARA
                             79       ;; SINO SIEMPRE LA CAMARA ESTARA EN min(0,0) Y max(20,20)
                             80 
                             81    ;; Cargar las coordenadas en HL
   394B DD 6E 00      [19]   82    ld l, e_x(ix)           ;; L = X
   394E DD 66 01      [19]   83    ld h, e_y(ix)           ;; H = Y
                             84 
                             85    ;; ============================================================== ;;
                             86    ;;                  SOBRE EL OFFSET DE LA CAMARA                  ;;
                             87    ;; ______________________________________________________________ ;;
                             88    ;; La camara empieza con el borde arriba-izquierda a (0,0)        ;;
                             89    ;; Si la camara es movida una vez hacia la derecha                ;;
                             90    ;; entonces el offset offset sube a (1,1).                        ;;
                             91    ;; - La posicion de comprobación de coordenadas se hace con esto  ;;
                             92    ;; - Hay que restarle este offset a las posiciones en tiles       ;;
                             93    ;;   de la entidad que se le pase en IX                           ;;
                             94    ;; ============================================================== ;;
                             95 
                             96    ;; HAY QUE COMENTAR CABRONES!! @dani @dd
                             97 
   3951 CD 8D 39      [17]   98    call tile_a_mapa     ;; INFO COMPLETA EN LA FUNCION
                             99 
   3954 18 10         [12]  100    jr sigue_con_el_dro
   3956                     101    normal_dro:
                            102 
                            103    ;; Aqui solo entra si las coordenadas de la entidad IX NO ESTAN EN TILES
   3956 21 E0 3D      [10]  104    ld hl, #CoordMapMin
   3959 DD 7E 00      [19]  105    ld a, e_x(ix)                        ;; Consigue la posicion del jugador
   395C 96            [ 7]  106    sub (hl)
   395D 4F            [ 4]  107    ld     c,   a                        ;; x  [0-79]
                            108 
   395E 21 E1 3D      [10]  109    ld hl, #CoordMapMin+1
   3961 DD 7E 01      [19]  110    ld a, e_y(ix)                        ;; Repito para Y
   3964 96            [ 7]  111    sub (hl)
   3965 47            [ 4]  112    ld     b,   a                        ;; y  [0-199]
                            113 
                            114 
   3966                     115    sigue_con_el_dro:
                            116 
   3966 3A 1B 39      [13]  117    ld a, (back_buffer)                  ;; Apunta al inicio de la memoria de video
   3969 57            [ 4]  118    ld d, a
   396A 1E 00         [ 7]  119    ld e, #00
                            120 
   396C CD 77 41      [17]  121    call cpct_getScreenPtr_asm
                            122    ;; SIN SPRITE
...
Hexadecimal [16-Bits]
   ...
   396F EB            [ 4]  123    ex    de,   hl          ;; Apunta a la posicion x,y
   3970 DD 7E 06      [19]  124    ld     a,   e_col(ix)    ;; Código de color
   3973 DD 4E 02      [19]  125    ld     c,   e_w(ix)      ;; Ancho
   3976 DD 46 03      [19]  126    ld     b,   e_h(ix)      ;; Alto
   3979 CD 9E 40      [17]  127    call cpct_drawSolidBox_asm
                            128 
                            129    ;; CON SPRITE
                            ...
                            134    ;; cpct_drawSprite_asm
   397C C9            [10]  135 ret
                            136 
                            137 ;==================================
                            138 ; Clears the sprite (squeare now)
                            139 ;==================================
   397D                     140 dw_clear::
   397D DD 7E 06      [19]  141     ld  a, e_col(ix)
   3980 08            [ 4]  142     ex af, af'            ;'
                            143 
   3981 DD 36 06 00   [19]  144     ld  e_col(ix), #0
   3985 CD 32 39      [17]  145     call dw_draw
   3988 08            [ 4]  146     ex af, af'            ;'
   3989 DD 77 06      [19]  147     ld e_col(ix), a
                            148 
   398C C9            [10]  149  ret
                            150 
                            151 ;;======================================================================
                            152 ;;======================================================================
                            153 ;; FUNCIONES PRIVADAS
                            154 ;;======================================================================
                            155 ;;======================================================================
                            156 
                            157 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            158 ;; PASA LAS COORDENADAS DE TILE A COORDENADAS DE MAPA
                            159 ;; __________________________________________________
                            160 ;; ENTRADA:    L -> Coordenada de TILE en X
                            161 ;;             H -> Coordenada de TILE en Y
                            162 ;; SALIDA:     C -> Coordenada de MAPA en X
                            163 ;;             B -> Coordenada de MAPA en Y
                            164 ;; DESTRUYE:   A,D,BC
                            165 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   398D                     166 tile_a_mapa::
   398D 3A DC 3D      [13]  167    ld a, (cam_min)
   3990 ED 44         [ 8]  168    neg                  ;; Tengo el negativo de A
   3992 85            [ 4]  169    add   l
   3993 6F            [ 4]  170    ld    l,    a        ;; L tiene la coordenada X corregida
                            171 
                            172    ;; Hay offset en Y?
   3994 3A DD 3D      [13]  173    ld a, (cam_min+1)
   3997 ED 44         [ 8]  174    neg                  ;; Tengo el negativo de A
   3999 84            [ 4]  175    add   h
   399A 67            [ 4]  176    ld    h,    a        ;; H tiene la coordenada Y corregida
                            177 
...
Hexadecimal [16-Bits]
                            ...
                            178    ;; Paso Y
   399B 7C            [ 4]  179    ld    a,    h           ;; A = Y
   399C C6 04         [ 7]  180    add   #OFFSET_CAMERA_POS_Y
   399E 0E 07         [ 7]  181    ld    c,    #7          ;; Iteraciones del loop
   39A0 57            [ 4]  182    ld    d,    a           ;; D = Y
   39A1                     183    loop_y_tm:
   39A1 82            [ 4]  184       add a, d          ;; A = A + D = A + A_inicial
   39A2 0D            [ 4]  185       dec c             ;; C--
   39A3 20 FC         [12]  186    jr nz, loop_y_tm
                            187 
   39A5 47            [ 4]  188    ld b, a              ;; En B guardo la Y
                            189 
                            190    ;; Paso X
   39A6 7D            [ 4]  191    ld    a, l                    ;; ======================= ;;
   39A7 C6 02         [ 7]  192    add   #OFFSET_CAMERA_POS_X
   39A9 0E 03         [ 7]  193    ld    c, #3                   ;;                         ;;
   39AB 57            [ 4]  194    ld    d, a                    ;; Hago lo mismo que antes ;;
   39AC                     195    loop_x_tm:                    ;;      pero con la X      ;;
   39AC 82            [ 4]  196       add a, d                   ;;                         ;;
   39AD 0D            [ 4]  197       dec c                      ;; ======================= ;;
   39AE 20 FC         [12]  198    jr nz, loop_x_tm
                            199 
   39B0 4F            [ 4]  200    ld c, a              ;; En C guardo la X
   39B1 C9            [10]  201    ret
                            202 
                            203 ;; Misma ejecucion que tile_a_mapa
   39B2                     204 mapa_a_tile::
                            205    ;; Paso Y
   39B2 7C            [ 4]  206    ld    a, h           ;; A = Y
   39B3 C6 E0         [ 7]  207    add   #-OFFSET_CAMERA_POS_Y_PANT
   39B5 16 08         [ 7]  208    ld    d, #8          ;; D = 8 -> Tamanyo en Y de cada tile en bytes
   39B7 0E 00         [ 7]  209    ld    c, #0          ;; C = 0
   39B9                     210    loop_y_mt:
   39B9 BA            [ 4]  211       cp d
   39BA 38 06         [12]  212       jr c, end_loop_y_mt
                            213 
   39BC 0C            [ 4]  214       inc c
   39BD 92            [ 4]  215       sub d             ;; A = A - D
   39BE 30 F9         [12]  216    jr nc, loop_y_mt
   39C0 28 F7         [12]  217    jr z, loop_y_mt
   39C2                     218    end_loop_y_mt:
   39C2 79            [ 4]  219    ld    a,    c
   39C3 47            [ 4]  220    ld    b,    a        ;; En B guardo la Y
                            221 
                            222    ;; Paso X
   39C4 7D            [ 4]  223    ld    a, l           ;; A = X
   39C5 C6 F8         [ 7]  224    add   #-OFFSET_CAMERA_POS_X_PANT
   39C7 16 04         [ 7]  225    ld    d, #4          ;; D = 4 -> Tamanyo en X de cada tile en bytes
   39C9 0E 00         [ 7]  226    ld    c, #0          ;; C = 0
   39CB                     227    loop_x_mt:
   39CB BA            [ 4]  228       cp d
   39CC 38 06         [12]  229       jr c, end_loop_x_mt
                            230 
   39CE 0C            [ 4]  231       inc c
   39CF 92            [ 4]  232       sub d             ;; A = A - D
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 59.
Hexadecimal [16-Bits]



   39D0 30 F9         [12]  233    jr nc, loop_x_mt
   39D2 28 F7         [12]  234    jr z, loop_x_mt
   39D4                     235    end_loop_x_mt:
                            236    ;; En C ya tengo guardada la X debido al bucle
   39D4 C9            [10]  237    ret
                            238 
                            239 
                            240 
