...
Hexadecimal [16-Bits]
   ...
   9975                      32 dw_draw::
                             ...
                             34 
   9975 11 00 C0      [10]   35    ld    de,   #0xC000                  ;; Apunta al inicio de la memoria de video
                             36 
   9978 FE FF         [ 7]   37    cp #0xFF                             ;; Compruebo si he llamado a draw desde el clear para no sumar la velocidad
   997A 20 09         [12]   38    jr nz, normal_dro                    ;; Si no he llamado desde el clear, salto
                             39     ;;Llamada desde el clear
   997C DD 7E 00      [19]   40        ld a, e_x(ix)                    ;; Cargo la posicion X, que es del frame anterior
   997F 4F            [ 4]   41        ld     c,   a                    ;; x  [0-79]
   9980 DD 7E 01      [19]   42        ld a, e_y(ix)                    ;; Cargo la posicion Y, tambien del frame anterior
   9983 18 13         [12]   43        jr dro                           ;; Salto a dro, para ahorrar un par de bytes, ya que a partir de ahi, el codigo es igual
                             44 
   9985                      45    normal_dro:                          ;; Dro normal
   9985 DD 7E 00      [19]   46    ld a, e_x(ix)                        ;; Consigue la posicion del jugador
   9988 DD 86 04      [19]   47        add e_vx(ix)                     ;; Le sumo la velocidad, lo hago aqui en vez del update de jugador para evitar restar en clear
   998B DD 77 00      [19]   48        ld e_x(ix), a                    ;; Lo guardo en su registro
   998E 4F            [ 4]   49    ld     c,   a                        ;; x  [0-79]
                             50 
   998F DD 7E 01      [19]   51    ld a, e_y(ix)                        ;; Repito para Y
   9992 DD 86 05      [19]   52        add e_vy(ix)
   9995 DD 77 01      [19]   53        ld e_y(ix), a
                             54 
   9998                      55        dro:
                             56        ;add a                            ;; Antes de guadarlo en el registro b para dibujar lo duplico, para tener más rango de scroll [-255, 255]
   9998 47            [ 4]   57    ld     b,   a                        ;; y  [0-199]
                             58 
   9999 CD 48 9F      [17]   59    call cpct_getScreenPtr_asm
                             60    ;; SIN SPRITE
   999C EB            [ 4]   61    ex    de,   hl          ;; Apunta a la posicion x,y
   999D DD 7E 06      [19]   62    ld     a,   e_col(ix)    ;; Código de color
   99A0 DD 4E 02      [19]   63    ld     c,   e_w(ix)      ;; Ancho
   99A3 DD 46 03      [19]   64    ld     b,   e_h(ix)      ;; Alto
   99A6 CD 6F 9E      [17]   65    call cpct_drawSolidBox_asm
                             66 
...
Hexadecimal [16-Bits]
   ...
   99A9 C9            [10]   73 ret
                             ...
                             77 ;==================================
   99AA                      78 dw_clear::
   99AA DD 7E 06      [19]   79     ld  a, e_col(ix)
   99AD 08            [ 4]   80     ex af, af'            ;'
                             81 
   99AE DD 36 06 00   [19]   82     ld  e_col(ix), #0
   99B2 3E FF         [ 7]   83     ld a, #0xFF
   99B4 CD 75 99      [17]   84     call dw_draw
   99B7 08            [ 4]   85     ex af, af'            ;'
   99B8 DD 77 06      [19]   86     ld e_col(ix), a
   99BB C9            [10]   87  ret
                             88 
                             89 ;;======================================================================
                             90 ;;======================================================================
