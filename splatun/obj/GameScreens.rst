...
Hexadecimal [16-Bits]
                              ...
                              3 
   2E30                       4 drawGameOver::
                              5     ;; Reinicio las vidas del jugador
   2E30 3E 05         [ 7]    6     ld a, #K_HERO_LIVES
   2E32 32 4D 26      [13]    7     ld (HERO_LIVES), a
                              8 
   2E35 11 75 01      [10]    9     ld de, #_GameOver
   2E38 CD 0A 3C      [17]   10     call cpct_akp_musicInit_asm
                             11 
   2E3B CD B8 2A      [17]   12     call fillAlternativeBuffer      ;; Lleno con #29 un "buffer" alternativo
                             13 
   2E3E 21 6E 05      [10]   14     ld hl, #alternative_buffer      ;; Le digo a la funcion que pinta por columnas
   2E41 22 DB 2A      [16]   15     ld (map), hl                    ;; dónde está mi "mapa" lleno de #29
   2E44 CD C6 2A      [17]   16     call clearPlayableAreaAlt
                             17     ;; Pintar GAMEOVER
                             18 
                             19     ;;
   2E47 C9            [10]   20 ret
                             21 
   2E48                      22 drawVictory::
                             23     ;; Reinicio las vidas del jugador
   2E48 3E 05         [ 7]   24     ld a, #K_HERO_LIVES
   2E4A 32 4D 26      [13]   25     ld (HERO_LIVES), a
                             26 
   2E4D 11 75 01      [10]   27     ld de, #_GameOver
   2E50 CD 0A 3C      [17]   28     call cpct_akp_musicInit_asm
                             29 
   2E53 CD B8 2A      [17]   30     call fillAlternativeBuffer      ;; Lleno con #29 un "buffer" alternativo
                             31 
   2E56 21 6E 05      [10]   32     ld hl, #alternative_buffer      ;; Le digo a la funcion que pinta por columnas
   2E59 22 DB 2A      [16]   33     ld (map), hl                    ;; dónde está mi "mapa" lleno de #29
   2E5C CD C6 2A      [17]   34     call clearPlayableAreaAlt
                             35 
   2E5F C9            [10]   36 ret
