...
Hexadecimal [16-Bits]
                              ...
                              5 
   9C7A 00 40                 6 map_ptr:    .dw #_nivel1
                              7                 ;   X    Y     W     H       VX     VY    COL
   9C7C                       8 DefineEntity _obs, #10, #40, #0x04, #0x08, #0x00, #0x00, #0xFF, #0x0000
   9C7C                       1 _obs:
   0002                       2    DefineDrawableEnt _obs_dw, #10, #40, #0x04, #0x08                       ;;'
   0002                       1 _obs_dw:
   9C7C 0A 28                 2    .db   #10, #40      ;; Posicion    (x,y)
   9C7E 04 08                 3    .db   #0x04, #0x08      ;; Dimensiones (w,h)
   9C80                       3    DefineMovableEnt  _obs_mv, #0x00, #0x00                             ;;'
   0006                       1 _obs_mv:
   9C80 00 00                 2    .db   #0x00, #0x00    ;; Variables de la velocidad
                              4 ;; Si no tiene sprite
   9C82 FF                    5    .db   #0xFF        ;; Color
                              6 ;; Si tiene sprite
                              7 ;;.dw   _spr
   9C83 00 00                 8    .dw   #0x0000        ;; Puntero a la funcion de update
                              9 
   ...
   9C85                      12 obs_draw::
   9C85 DD 21 7C 9C   [14]   13     ld ix, #_obs
   9C89 C3 75 99      [10]   14     jp dw_draw
                             15 
   9C8C                      16 obs_clear::
   9C8C DD 21 7C 9C   [14]   17     ld ix, #_obs
   9C90 C3 AA 99      [10]   18     jp dw_clear
                             19 
                             20 ;========================================================================;
   ...
   9C93                      23 inc_map_y::
                             24 
   9C93 2A 7A 9C      [16]   25     ld hl, (map_ptr)
                             26 
   9C96 FE 01         [ 7]   27     cp #1
   9C98 20 05         [12]   28     jr nz, up
   9C9A 11 3C 00      [10]   29         ld de, #60
   9C9D 18 03         [12]   30         jr continue
   9C9F                      31     up:
   9C9F 11 C4 FF      [10]   32     ld de, #-60
                             33 
   9CA2                      34     continue:
   9CA2 19            [11]   35         add hl, de
   9CA3 22 7A 9C      [16]   36     ld (map_ptr), hl
   9CA6 CD AA 9C      [17]   37     call drawMap
   9CA9 C9            [10]   38 ret
                             39 
                             40 ;========================================================================;
...
Hexadecimal [16-Bits]
   ...
   9CAA 21 24 58      [10]   44     ld hl, #_g_0
   9CAD 0E 14         [ 7]   45     ld c, #20       ;40
   9CAF 06 19         [ 7]   46     ld b, #25      ;100
   9CB1 11 1E 00      [10]   47     ld de, #30
   9CB4 CD 1C 9F      [17]   48     call cpct_etm_setDrawTilemap4x8_ag_asm
                             49 
   9CB7 21 00 C0      [10]   50     ld hl, #0xC000
   9CBA ED 5B 7A 9C   [20]   51     ld de, (map_ptr)
   9CBE CD 82 9D      [17]   52     call cpct_etm_drawTilemap4x8_ag_asm
   9CC1 C9            [10]   53 ret
