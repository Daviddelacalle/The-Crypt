...
Hexadecimal [16-Bits]
                             ...
                             18 ;;======================================================================
                             19 ;;======================================================================
   401A                      20 DefineEntity hero, 0x28, 0x66, 0x04, 0x10, 0x00, 0x00, 0x0F, 0x0000
   401A                       1 hero:
   0000                       2    DefineDrawableEnt hero_dw, 0x28, 0x66, 0x04, 0x10                    ;;'
   0000                       1 hero_dw:
   401A 28 66                 2    .db   0x28, 0x66      ;; Posicion    (x,y)
   401C 04 10                 3    .db   0x04, 0x10      ;; Dimensiones (w,h)
                              4 
                              5 ;; Aqui falta saber el tamanyo de la entidad
   401E                       3    DefineMovableEnt heromv, 0x00, 0x00                            ;;'
   0004                       1 heromv:
   401E 00 00                 2    .db   0x00, 0x00    ;; Variables de la velocidad
                              4 ;; Si no tiene sprite
   4020 0F                    5    .db   0x0F        ;; Color
                              6 ;; Si tiene sprite
                              7 ;;.dw   _spr
   4021 00 00                 8    .dw   0x0000        ;; Puntero a la funcion de update
                              9 
                             ...
                             26 ;;======================================================================
   4023                      27 hero_draw::
   4023 DD 21 1A 40   [14]   28    ld    ix,   #hero    ;; ix apunta a los datos del heroe
   4027 C3 00 40      [10]   29    jp dw_draw           ;; Llamo al draw de drawable
                             30 
                             31 ;;======================================================================
                             32 ;;======================================================================
