...
Hexadecimal [16-Bits]
                     ...
                     0000    22 hero_x = .
                     0001    23 hero_y = . + 1
   3518                      24 DefineEntity hero, #INIT_X, #INIT_Y, 0x02, 0x08, 0x00, 0x00, 0x0F, 0x0000
   3518                       1 hero:
   0000                       2    DefineDrawableEnt hero_dw, #INIT_X, #INIT_Y, 0x02, 0x08                       ;;'
   0000                       1 hero_dw:
   3518 34 40                 2    .db   #INIT_X, #INIT_Y      ;; Posicion    (x,y)
   351A 02 08                 3    .db   0x02, 0x08      ;; Dimensiones (w,h)
   351C                       3    DefineMovableEnt  hero_mv, 0x00, 0x00                             ;;'
   0004                       1 hero_mv:
   351C 00 00                 2    .db   0x00, 0x00    ;; Variables de la velocidad
                              4 ;; Si no tiene sprite
   351E 0F                    5    .db   0x0F        ;; Color
                              6 ;; Si tiene sprite
                              7 ;;.dw   _spr
   351F 00 00                 8    .dw   0x0000        ;; Puntero a la funcion de update
                              9 
                     ...
                     0009    11 e_size = . - (hero)
                             ...
                             33 
                             34 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             35 ;; DIBUJADO DE LA ENTIDAD HERO
                             36 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   3521                      37 hero_draw::
   3521 DD 21 18 35   [14]   38     ld   ix,   #hero    ;; ix apunta a los datos del heroe
                             39     ; ld   a, #0         ;; Por si las moscas
   3525 C3 32 39      [10]   40     jp dw_draw
                             41 
   3528                      42 hero_update::
   3528 DD 21 18 35   [14]   43     ld    ix,   #hero   ; Se puede borrar si hero es el ultimo en hacer dro
   352C DD 36 04 00   [19]   44     ld e_vx(ix), #0
   3530 DD 36 05 00   [19]   45     ld e_vy(ix), #0
                             46 
   3534 CD 93 41      [17]   47     call cpct_scanKeyboard_asm
                             48 
                             49 
   3537 21 08 20      [10]   50     ld hl, #Key_A                           ;; Check Key A
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 54.
Hexadecimal [16-Bits]



   353A CD BC 3E      [17]   51     call cpct_isKeyPressed_asm
                             52 
   353D 28 1E         [12]   53     jr z, a_no_pulsada
                             54 
   353F 21 E0 3D      [10]   55         ld hl, #CoordMapMin
   3542 DD 7E 00      [19]   56         ld a, e_x(ix)                       ;; Pruebo la primera condicion
   3545 96            [ 7]   57         sub (hl)
   3546 FE 14         [ 7]   58         cp #LEFT
   3548 20 0C         [12]   59         jr nz, move_the_character_A         ;; Si no estoy en el centro, muevo el jugador
                             60 
   354A 3A DC 3D      [13]   61         ld a, (cam_min)                    ;;
   354D FE 00         [ 7]   62         cp #0                               ;; Borde izquierdo (0)
   354F 28 05         [12]   63         jr z, move_the_character_A          ;; Si se ha pulsado la A y no estoy en el borde
                             64                                             ;; muevo el mapa
                             65         ;;  Set Camera Target X
   3551 06 FD         [ 7]   66             ld b, #-CAMERA_TARGET_X
   3553 CD FB 3D      [17]   67             call setTargetX
                             68 
   3556                      69         move_the_character_A:
   3556 06 FF         [ 7]   70             ld b, #-1                       ;; Cambio la velocidad del jugador a 2
   3558 DD 70 04      [19]   71             ld e_vx(ix), b
                             72 
                             73 
                             74 
   355B 18 26         [12]   75     jr d_no_pulsada             ;; Si se ha pulsado no compruebes la tecla D
                             76 
   355D                      77     a_no_pulsada:
   355D 21 07 20      [10]   78         ld hl, #Key_D               ;; Comprueba tecla D
   3560 CD BC 3E      [17]   79         call cpct_isKeyPressed_asm
   3563 28 1E         [12]   80         jr z, d_no_pulsada
                             81 
   3565 21 E0 3D      [10]   82             ld hl, #CoordMapMin             ;; Le resto el borde izq de la cámara
   3568 DD 7E 00      [19]   83             ld a, e_x(ix)
   356B 96            [ 7]   84             sub (hl)
   356C FE 3C         [ 7]   85             cp #RIGHT                       ;; Para comprobar si está en el punto dónde debe hacer scroll
   356E 20 0C         [12]   86             jr nz, move_the_character_D     ;; Si no es ese punto, simplemente mueve el personaje
                             87 
   3570 3A DC 3D      [13]   88             ld a, (cam_min)                 ;; Estamos en el punto!
   3573 FE 0E         [ 7]   89             cp #LimitRight                  ;; Comprobemos ahora si la cámara no está en el borde ya
   3575 28 05         [12]   90             jr z, move_the_character_D      ;; Estamos en el borde!, simplemente mueve el personaje
                             91 
                             92             ;;  Set Camera Target X         ;; Estamos en el punto y la cámara no está en el borde
   3577 06 03         [ 7]   93                 ld b, #CAMERA_TARGET_X      ;; Mueve la cámara 3 tiles a la derecha
   3579 CD FB 3D      [17]   94                 call setTargetX
                             95 
   357C                      96             move_the_character_D:
   357C 06 01         [ 7]   97                 ld b, #1                    ;; Creo que esto no necesita explicación
   357E DD 70 04      [19]   98                 ld e_vx(ix), b              ;; Simplmente pon la velocidad a 1
   3581 18 00         [12]   99             jr d_no_pulsada
                            100 
                            101 
                            102 
   3583                     103     d_no_pulsada:
   3583 21 07 08      [10]  104         ld hl, #Key_W
   3586 CD BC 3E      [17]  105         call cpct_isKeyPressed_asm
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 55.
Hexadecimal [16-Bits]



   3589 28 1E         [12]  106         jr z, w_no_pulsada
                            107 
   358B 21 E1 3D      [10]  108             ld hl, #CoordMapMin+1
   358E DD 7E 01      [19]  109             ld a, e_y(ix)
   3591 96            [ 7]  110             sub (hl)
                            111 
   3592 FE 40         [ 7]  112             cp #TOP
   3594 20 0C         [12]  113             jr nz, move_the_character_W
                            114 
   3596 3A DD 3D      [13]  115             ld a, (cam_min+1)
   3599 FE 00         [ 7]  116             cp #0
   359B 28 05         [12]  117             jr z, move_the_character_W
                            118 
                            119             ;;  Set Camera Target Y
   359D 06 FB         [ 7]  120                 ld b, #-CAMERA_TARGET_Y
   359F CD 03 3E      [17]  121                 call setTargetY
                            122 
   35A2                     123             move_the_character_W:
   35A2 06 FC         [ 7]  124                 ld b, #-4
   35A4 DD 70 05      [19]  125                 ld e_vy(ix), b
                            126 
   35A7 18 26         [12]  127         jr s_no_pulsada
                            128 
   35A9                     129     w_no_pulsada:
   35A9 21 07 10      [10]  130         ld hl, #Key_S
   35AC CD BC 3E      [17]  131         call cpct_isKeyPressed_asm
   35AF 28 1E         [12]  132         jr z, s_no_pulsada
                            133 
   35B1 21 E1 3D      [10]  134             ld hl, #CoordMapMin+1
   35B4 DD 7E 01      [19]  135             ld a, e_y(ix)
   35B7 96            [ 7]  136             sub (hl)
                            137 
   35B8 FE 80         [ 7]  138             cp #BOTTOM
   35BA 20 0C         [12]  139             jr nz, move_the_character_S
                            140 
   35BC 3A DD 3D      [13]  141             ld a, (cam_min+1)
   35BF FE 0E         [ 7]  142             cp #LimitDown
   35C1 28 05         [12]  143             jr z, move_the_character_S
                            144 
                            145             ;;  Set Camera Target Y
   35C3 06 05         [ 7]  146                 ld b, #CAMERA_TARGET_Y
   35C5 CD 03 3E      [17]  147                 call setTargetY
                            148 
   35C8                     149             move_the_character_S:
   35C8 06 04         [ 7]  150                 ld b, #4
   35CA DD 70 05      [19]  151                 ld e_vy(ix), b
                            152 
   35CD 18 00         [12]  153             jr s_no_pulsada
   35CF                     154     s_no_pulsada:
                            155 
   35CF DD 7E 00      [19]  156     ld a, e_x(ix)                   ;; Consigue la posicion del jugador
   35D2 DD 86 04      [19]  157     add e_vx(ix)                    ;; Le sumo la velocidad, lo hago aqui en vez del update de jugador para evitar restar en clear
   35D5 DD 77 00      [19]  158     ld e_x(ix), a                   ;; Lo guardo en su registro
                            159 
   35D8 DD 7E 01      [19]  160     ld a, e_y(ix)                   ;; Repito para Y
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 56.
Hexadecimal [16-Bits]



   35DB DD 86 05      [19]  161     add e_vy(ix)
   35DE DD 77 01      [19]  162     ld e_y(ix), a
                            163 
   35E1 C3 0B 3E      [10]  164     jp update_cam                   ;; Recusión de cola! Actualiza la cámara
                            165 
                            166 
                            167 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            168 ;; CARGA EN LOS REGISTROS A,B LOS VALORES DE X,Y
                            169 ;; _______________________
                            170 ;; DESTRUYE: A, B
                            171 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   35E4                     172 hero_get_position::
   35E4 3A 19 35      [13]  173    ld    a,    (hero_y)
   35E7 47            [ 4]  174    ld    b,    a
   35E8 3A 18 35      [13]  175    ld    a,    (hero_x)
   35EB C9            [10]  176    ret
                            177 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            178 ;; CARGA EN IY EL VECTOR DEL HEROE
                            179 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            180 
   35EC                     181 hero_get_iy::
   35EC FD 21 18 35   [14]  182   ld iy, #hero
   35F0 C9            [10]  183 ret
                            184 ;;======================================================================
                            185 ;;======================================================================
                            186 ;; FUNCIONES PRIVADAS
                            187 ;;======================================================================
                            188 ;;======================================================================
