...
Hexadecimal [16-Bits]
                     ...
                     0000    19 hero_x = .
                     0001    20 hero_y = . + 1
   9774                      21 DefineEntity hero, #40, #50, 0x02, 0x08, 0x00, 0x00, 0x0F, 0x0000
   9774                       1 hero:
   0000                       2    DefineDrawableEnt hero_dw, #40, #50, 0x02, 0x08                       ;;'
   0000                       1 hero_dw:
   9774 28 32                 2    .db   #40, #50      ;; Posicion    (x,y)
   9776 02 08                 3    .db   0x02, 0x08      ;; Dimensiones (w,h)
   9778                       3    DefineMovableEnt  hero_mv, 0x00, 0x00                             ;;'
   0004                       1 hero_mv:
   9778 00 00                 2    .db   0x00, 0x00    ;; Variables de la velocidad
                              4 ;; Si no tiene sprite
   977A 0F                    5    .db   0x0F        ;; Color
                              6 ;; Si tiene sprite
                              7 ;;.dw   _spr
   977B 00 00                 8    .dw   0x0000        ;; Puntero a la funcion de update
                              9 
                     ...
                     0009    11 e_size = . - (hero)
                             ...
                             31 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   977D                      32 hero_draw::
   977D DD 21 74 97   [14]   33     ld    ix,   #hero    ;; ix apunta a los datos del heroe
   9781 C3 75 99      [10]   34     jp dw_draw
                             35 
                             36 
   9784                      37 hero_clear::
   9784 DD 21 74 97   [14]   38     ld ix, #hero
   9788 C3 AA 99      [10]   39     jp dw_clear
                             40 
   978B                      41 hero_update::
   978B DD 21 74 97   [14]   42     ld    ix,   #hero   ; Se puede borrar si hero es el ultimo en hacer dro
   978F DD 36 04 00   [19]   43     ld e_vx(ix), #0
   9793 DD 36 05 00   [19]   44     ld e_vy(ix), #0
                             45 
                             46 
   9797 CD 64 9F      [17]   47     call cpct_scanKeyboard_asm
   979A 21 08 20      [10]   48     ld hl, #Key_A                   ;; Comprueba tecla A
   979D CD D6 9C      [17]   49     call cpct_isKeyPressed_asm
   97A0 28 07         [12]   50     jr z, a_no_pulsada
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 54.
Hexadecimal [16-Bits]



   97A2 06 FF         [ 7]   51         ld b, #-1
                             52         ;call move_camera
   97A4 DD 70 04      [19]   53         ld e_vx(ix), b
   97A7 18 0D         [12]   54         jr d_no_pulsada             ;; Si se ha pulsado no compruebes la tecla D
                             55 
   97A9                      56     a_no_pulsada:
                             57 
   97A9 21 07 20      [10]   58         ld hl, #Key_D               ;; Comprueba tecla D
   97AC CD D6 9C      [17]   59         call cpct_isKeyPressed_asm
   97AF 28 05         [12]   60         jr z, d_no_pulsada
   97B1 06 01         [ 7]   61             ld b, #1
                             62             ;call move_camera
   97B3 DD 70 04      [19]   63             ld e_vx(ix), b
                             64 
   97B6                      65     d_no_pulsada:
                             66 
   97B6 21 07 08      [10]   67         ld hl, #Key_W
   97B9 CD D6 9C      [17]   68         call cpct_isKeyPressed_asm
   97BC 28 0C         [12]   69         jr z, w_no_pulsada
   97BE 06 FE         [ 7]   70             ld b, #-2
                             71             ;call move_camera
   97C0 DD 70 05      [19]   72             ld e_vy(ix), b
   97C3 18 17         [12]   73             jr s_no_pulsada
   97C5 3E 00         [ 7]   74             ld a, #0
   97C7 CD 93 9C      [17]   75             call inc_map_y
                             76 
   97CA                      77     w_no_pulsada:
                             78 
   97CA 21 07 10      [10]   79         ld hl, #Key_S
   97CD CD D6 9C      [17]   80         call cpct_isKeyPressed_asm
   97D0 28 0A         [12]   81         jr z, s_no_pulsada
   97D2 06 02         [ 7]   82             ld b, #2
                             83             ;call move_camera
   97D4 DD 70 05      [19]   84             ld e_vy(ix), b
   97D7 3E 01         [ 7]   85             ld a, #1
   97D9 CD 93 9C      [17]   86             call inc_map_y
                             87 
   97DC                      88     s_no_pulsada:
                             89 
                             90 
                             91 
   97DC C9            [10]   92 ret
                             ...
                             97 ;; DESTRUYE: A, B
                             98 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   97DD                      99 hero_get_position::
   97DD 3A 75 97      [13]  100    ld    a,    (hero_y)
   97E0 47            [ 4]  101    ld    b,    a
   97E1 3A 74 97      [13]  102    ld    a,    (hero_x)
   97E4 C9            [10]  103    ret
                            104 
                            105 ;;======================================================================
