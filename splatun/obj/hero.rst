...
Hexadecimal [16-Bits]
                             ...
                             17 ;;======================================================================
                             18 
                     0003    19 CAMERA_TARGET_X = 3
                     0005    20 CAMERA_TARGET_Y = 5
                             21 
                     0000    22 hero_x = .
                     0001    23 hero_y = . + 1
   2643                      24 DefineEntity hero, #INIT_X, #INIT_Y, #4, #8, 0x00, 0x00, #_sp_hero_00, 0x0000
   2643                       1 hero:
   0000                       2     DefineDrawableEnt hero_dw, #INIT_X, #INIT_Y, #4, #8                       ;;'
   0000                       1 hero_dw:
   2643 0C 40                 2    .db   #INIT_X, #INIT_Y      ;; Posicion    (x,y)
   2645 04 08                 3    .db   #4, #8      ;; Dimensiones (w,h)
   2647                       3     DefineMovableEnt  hero_mv, 0x00, 0x00                             ;;'
   0004                       1 hero_mv:
   2647 00 00                 2    .db   0x00, 0x00    ;; Variables de la velocidad
                              4 ;; Si tiene sprite
   2649 07 0F                 5     .dw   #_sp_hero_00
   264B 00 00                 6     .dw   0x0000        ;; Puntero a la funcion de update
                              7 
                              8 ;; Aqui falta saber el tamanyo de la entidad
                     000A     9 e_size = . - (hero)
                             25 
   264D 05                   26 HERO_LIVES:: .db #K_HERO_LIVES
                             27 
                             28 ;;======================================================================
                             29 ;;======================================================================
                             30 ;; FUNCIONES PUBLICAS
                             31 ;;======================================================================
                             32 ;;======================================================================
                             33 
                             34 
                             35 
                             36 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             37 ;; DIBUJADO DE LA ENTIDAD HERO
                             38 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   264E                      39 hero_draw::
   264E DD 21 43 26   [14]   40     ld   ix,   #hero    ;; ix apunta a los datos del heroe
                             41     ; ld   a, #0         ;; Por si las moscas
   2652 C3 24 2B      [10]   42     jp dw_draw
                             43 
   2655                      44 hero_update::
   2655 DD 21 43 26   [14]   45     ld    ix,   #hero   ; Se puede borrar si hero es el ultimo en hacer dro
   2659 DD 36 04 00   [19]   46     ld e_vx(ix), #0
   265D DD 36 05 00   [19]   47     ld e_vy(ix), #0
                             48 
   2661 CD 64 27      [17]   49     call checkTeleporter
                             50 
   2664 CD 64 3F      [17]   51     call cpct_scanKeyboard_asm
                             52 
...
Hexadecimal [16-Bits]
   ...
   2667 21 08 20      [10]   53     ld hl, #Key_A                           ;; Check Key A
   266A CD F2 34      [17]   54     call cpct_isKeyPressed_asm
                             55 
   266D 28 30         [12]   56     jr z, a_no_pulsada
                             57 
   266F 21 71 33      [10]   58         ld hl, #CoordMapMin
   2672 DD 7E 00      [19]   59         ld a, e_x(ix)                       ;; Pruebo la primera condicion
   2675 96            [ 7]   60         sub (hl)
   2676 FE 13         [ 7]   61         cp #LEFT+1
   2678 30 0C         [12]   62         jr nc, move_the_character_A         ;; Si no estoy en el centro, muevo el jugador
                             63 
   267A 3A 6F 33      [13]   64         ld a, (cam_min)                    ;;
   267D FE 00         [ 7]   65         cp #0                               ;; Borde izquierdo (0)
   267F 28 05         [12]   66         jr z, move_the_character_A          ;; Si se ha pulsado la A y no estoy en el borde
                             67                                             ;; muevo el mapa
                             68         ;;  Set Camera Target X
   2681 06 FD         [ 7]   69             ld b, #-CAMERA_TARGET_X
   2683 CD E5 33      [17]   70             call setTargetX
                             71 
   2686                      72         move_the_character_A:
                             73             ;; Actualizo el sprite del heroe
   2686 21 27 0F      [10]   74             ld hl, #_sp_hero_01
   2689 DD 75 06      [19]   75             ld e_spr_l(ix), l
   268C DD 74 07      [19]   76             ld e_spr_h(ix), h
                             77 
   268F 06 FF         [ 7]   78             ld b, #-1                       ;Speed
   2691 CD 60 2E      [17]   79             call checkLeftBorderForTilemapCollision
   2694 FE 01         [ 7]   80             cp #1
   2696 28 3F         [12]   81             jr z, d_no_pulsada
                             82 
   2698 06 FF         [ 7]   83             ld b, #-1                       ;; Cambio la velocidad del jugador a 2
   269A DD 70 04      [19]   84             ld e_vx(ix), b
                             85 
                             86 
                             87 
   269D 18 38         [12]   88     jr d_no_pulsada             ;; Si se ha pulsado no compruebes la tecla D
                             89 
   269F                      90     a_no_pulsada:
   269F 21 07 20      [10]   91         ld hl, #Key_D               ;; Comprueba tecla D
   26A2 CD F2 34      [17]   92         call cpct_isKeyPressed_asm
   26A5 28 30         [12]   93         jr z, d_no_pulsada
                             94 
   26A7 21 71 33      [10]   95             ld hl, #CoordMapMin             ;; Le resto el borde izq de la cámara
   26AA DD 7E 00      [19]   96             ld a, e_x(ix)
   26AD 96            [ 7]   97             sub (hl)
   26AE FE 2D         [ 7]   98             cp #RIGHT-1                       ;; Para comprobar si está en el punto dónde debe hacer scroll
   26B0 38 0C         [12]   99             jr c, move_the_character_D     ;; Si no es ese punto, simplemente mueve el personaje
                            100 
   26B2 3A 6F 33      [13]  101             ld a, (cam_min)                 ;; Estamos en el punto!
   26B5 FE 0E         [ 7]  102             cp #LimitRight                  ;; Comprobemos ahora si la cámara no está en el borde ya
   26B7 28 05         [12]  103             jr z, move_the_character_D      ;; Estamos en el borde!, simplemente mueve el personaje
                            104 
                            105             ;;  Set Camera Target X         ;; Estamos en el punto y la cámara no está en el borde
   26B9 06 03         [ 7]  106                 ld b, #CAMERA_TARGET_X      ;; Mueve la cámara 3 tiles a la derecha
   26BB CD E5 33      [17]  107                 call setTargetX
...
Hexadecimal [16-Bits]
                            ...
                            108 
   26BE                     109             move_the_character_D:
                            110                 ;; Actualizo el sprite del heroe
   26BE 21 47 0F      [10]  111                 ld hl, #_sp_hero_02
   26C1 DD 75 06      [19]  112                 ld e_spr_l(ix), l
   26C4 DD 74 07      [19]  113                 ld e_spr_h(ix), h
                            114 
   26C7 06 01         [ 7]  115                 ld b, #1                        ;Speed
   26C9 CD 6E 2E      [17]  116                 call checkRightBorderForTilemapCollision
   26CC FE 01         [ 7]  117                 cp #1
   26CE 28 07         [12]  118                 jr z, d_no_pulsada
                            119 
   26D0 06 01         [ 7]  120                 ld b, #1                    ;; Creo que esto no necesita explicación
   26D2 DD 70 04      [19]  121                 ld e_vx(ix), b              ;; Simplmente pon la velocidad a 1
   26D5 18 00         [12]  122             jr d_no_pulsada
                            123 
                            124 
                            125 
   26D7                     126     d_no_pulsada:
   26D7 21 07 08      [10]  127         ld hl, #Key_W
   26DA CD F2 34      [17]  128         call cpct_isKeyPressed_asm
   26DD 28 30         [12]  129         jr z, w_no_pulsada
                            130 
   26DF 21 72 33      [10]  131             ld hl, #CoordMapMin+1
   26E2 DD 7E 01      [19]  132             ld a, e_y(ix)
   26E5 96            [ 7]  133             sub (hl)
                            134 
   26E6 FE 2D         [ 7]  135             cp #TOP+1
   26E8 30 0C         [12]  136             jr nc, move_the_character_W
                            137 
   26EA 3A 70 33      [13]  138             ld a, (cam_min+1)
   26ED FE 00         [ 7]  139             cp #0
   26EF 28 05         [12]  140             jr z, move_the_character_W
                            141 
                            142             ;;  Set Camera Target Y
   26F1 06 FB         [ 7]  143                 ld b, #-CAMERA_TARGET_Y
   26F3 CD ED 33      [17]  144                 call setTargetY
                            145 
   26F6                     146             move_the_character_W:
                            147                 ;; Actualizo el sprite del heroe
   26F6 21 07 0F      [10]  148                 ld hl, #_sp_hero_00
   26F9 DD 75 06      [19]  149                 ld e_spr_l(ix), l
   26FC DD 74 07      [19]  150                 ld e_spr_h(ix), h
                            151 
   26FF 06 FC         [ 7]  152                 ld b, #-4                       ;Speed
   2701 CD 8E 2E      [17]  153                 call checkUpperBorderForTilemapCollision
   2704 FE 01         [ 7]  154                 cp #1
   2706 28 3F         [12]  155                 jr z, s_no_pulsada
                            156 
   2708 06 FC         [ 7]  157                 ld b, #-4
   270A DD 70 05      [19]  158                 ld e_vy(ix), b
                            159 
   270D 18 38         [12]  160         jr s_no_pulsada
                            161 
   270F                     162     w_no_pulsada:
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 56.
Hexadecimal [16-Bits]



   270F 21 07 10      [10]  163         ld hl, #Key_S
   2712 CD F2 34      [17]  164         call cpct_isKeyPressed_asm
   2715 28 30         [12]  165         jr z, s_no_pulsada
                            166 
   2717 21 72 33      [10]  167             ld hl, #CoordMapMin+1
   271A DD 7E 01      [19]  168             ld a, e_y(ix)
   271D 96            [ 7]  169             sub (hl)
                            170 
   271E FE 53         [ 7]  171             cp #BOTTOM-1
   2720 38 0C         [12]  172             jr c, move_the_character_S
                            173 
   2722 3A 70 33      [13]  174             ld a, (cam_min+1)
   2725 FE 0E         [ 7]  175             cp #LimitDown
   2727 28 05         [12]  176             jr z, move_the_character_S
                            177 
                            178             ;;  Set Camera Target Y
   2729 06 05         [ 7]  179                 ld b, #CAMERA_TARGET_Y
   272B CD ED 33      [17]  180                 call setTargetY
                            181 
   272E                     182             move_the_character_S:
                            183                 ;; Actualizo el sprite del heroe
   272E 21 67 0F      [10]  184                 ld hl, #_sp_hero_03
   2731 DD 75 06      [19]  185                 ld e_spr_l(ix), l
   2734 DD 74 07      [19]  186                 ld e_spr_h(ix), h
                            187 
   2737 06 04         [ 7]  188                 ld b, #4                       ;Speed
   2739 CD 9C 2E      [17]  189                 call checkLowerBorderForTilemapCollision
   273C FE 01         [ 7]  190                 cp #1
   273E 28 07         [12]  191                 jr z, s_no_pulsada
                            192 
   2740 06 04         [ 7]  193                 ld b, #4
   2742 DD 70 05      [19]  194                 ld e_vy(ix), b
                            195 
   2745 18 00         [12]  196             jr s_no_pulsada
   2747                     197     s_no_pulsada:
                            198 
   2747 DD 7E 00      [19]  199     ld  a, e_x(ix)
   274A DD 86 04      [19]  200     add a, e_vx(ix)
   274D DD 77 00      [19]  201     ld  e_x(ix), a
                            202 
   2750 DD 7E 01      [19]  203     ld a, e_y(ix)
   2753 DD 86 05      [19]  204     add a, e_vy(ix)
   2756 DD 77 01      [19]  205     ld e_y(ix), a
                            206 
                            207 
   2759 C3 F5 33      [10]  208     jp update_cam                   ;; Recusión de cola! Actualiza la cámara
                            209 
                            210 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            211 ;; CARGA EN LOS REGISTROS A,B LOS VALORES DE X,Y
                            212 ;; _______________________
                            213 ;; DESTRUYE: A, B
                            214 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   275C                     215 hero_get_position::
   275C 3A 44 26      [13]  216     ld    a,    (hero_y)
   275F 47            [ 4]  217     ld    b,    a
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 57.
Hexadecimal [16-Bits]



   2760 3A 43 26      [13]  218     ld    a,    (hero_x)
   2763 C9            [10]  219 ret
                            220 
                            221 ;;======================================================================
                            222 ;;======================================================================
                            223 ;; FUNCIONES PRIVADAS
                            224 ;;======================================================================
                            225 ;;======================================================================
                            226 
                            227 
   2764                     228 checkTeleporter::
   2764 3A 5F 05      [13]  229     ld a, (NumberOfEnemies)
   2767 FE 00         [ 7]  230         cp #0
   2769 C0            [11]  231     ret nz
                            232 
   276A DD 66 01      [19]  233     ld h, e_y(ix)
   276D DD 6E 00      [19]  234     ld l, e_x(ix)
   2770 CD 58 2B      [17]  235     call mapa_a_tile
                            236 
   2773 3A 6A 05      [13]  237     ld a, (Teleporter)
   2776 B9            [ 4]  238         cp c
   2777 C0            [11]  239     ret nz
   2778 3A 6B 05      [13]  240     ld a, (Teleporter+1)
   277B B8            [ 4]  241         cp b
   277C C0            [11]  242     ret nz
   277D DD E5         [15]  243     push ix
   277F CD 9E 27      [17]  244         call teleport_sfx
   2782 CD 29 2A      [17]  245         call loadNextLevel
   2785 DD E1         [14]  246     pop ix
   2787 C9            [10]  247 ret
                            248 
   2788                     249 resetHero::
   2788 21 6C 05      [10]  250     ld hl, #HeroSpawn
   278B DD 21 43 26   [14]  251     ld ix, #hero
   278F 7E            [ 7]  252     ld a, (hl)
   2790 DD 77 00      [19]  253     ld e_x(ix), a
   2793 23            [ 6]  254     inc hl
   2794 7E            [ 7]  255     ld a, (hl)
   2795 DD 77 01      [19]  256     ld e_y(ix), a
                            257     ; ld a, #K_HERO_LIVES
                            258     ; ld (HERO_LIVES), a
   2798 C9            [10]  259 ret
                            260 
   2799                     261 hero_get_iy::
   2799 FD 21 43 26   [14]  262   ld iy, #hero
   279D C9            [10]  263 ret
                            264 
   279E                     265 teleport_sfx::
                            266     ;SALVO TODOS LOS REGISTROS PARA NO SOBREESRIBIR NADA
                            267 
   279E DD E5         [15]  268     push ix
   27A0 F5            [11]  269     push af
   27A1 C5            [11]  270     push bc
   27A2 D5            [11]  271     push de
   27A3 E5            [11]  272     push hl
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 58.
Hexadecimal [16-Bits]



   27A4 FD E5         [15]  273     push iy
   27A6 2E 02         [ 7]  274     ld l, #2  ;INSRUMENTO
   27A8 26 0F         [ 7]  275     ld h, #15  ;VOLUMEN
   27AA 1E 16         [ 7]  276     ld e, #22 ;NOTA
   27AC 16 05         [ 7]  277     ld d, #05   ;VELOCIDAD
   27AE 01 00 00      [10]  278     ld bc, #0  ;PITCH
   27B1 3E 02         [ 7]  279     ld a, #2   ;CANAL
   27B3 CD BC 3C      [17]  280     call cpct_akp_SFXPlay_asm
                            281 
   27B6 FD E1         [14]  282     pop iy
   27B8 E1            [10]  283     pop hl
   27B9 D1            [10]  284     pop de
   27BA C1            [10]  285     pop bc
   27BB F1            [10]  286     pop af
   27BC DD E1         [14]  287     pop ix
                            288 
   27BE C9            [10]  289   ret
