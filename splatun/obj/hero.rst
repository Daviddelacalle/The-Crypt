...
Hexadecimal [16-Bits]
                     ...
                     0000    24 hero_x = .
                     0001    25 hero_y = . + 1
   45FA                      26 DefineEntity hero, #40, #50, 0x02, 0x08, 0x00, 0x00, 0x0F, 0x0000
   45FA                       1 hero:
   0000                       2    DefineDrawableEnt hero_dw, #40, #50, 0x02, 0x08                       ;;'
   0000                       1 hero_dw:
   45FA 28 32                 2    .db   #40, #50      ;; Posicion    (x,y)
   45FC 02 08                 3    .db   0x02, 0x08      ;; Dimensiones (w,h)
   45FE                       3    DefineMovableEnt  hero_mv, 0x00, 0x00                             ;;'
   0004                       1 hero_mv:
   45FE 00 00                 2    .db   0x00, 0x00    ;; Variables de la velocidad
                              4 ;; Si no tiene sprite
   4600 0F                    5    .db   0x0F        ;; Color
                              6 ;; Si tiene sprite
                              7 ;;.dw   _spr
   4601 00 00                 8    .dw   0x0000        ;; Puntero a la funcion de update
                              9 
                     ...
                     0009    11 e_size = . - (hero)
                             ...
                             29 ;;======================================================================
                             30 ;;======================================================================
                             31 ;; FUNCIONES PUBLICAS
                             32 ;;======================================================================
                             33 ;;======================================================================
                             34 
                             35 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             36 ;; DIBUJADO DE LA ENTIDAD HERO
                             37 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4603                      38 hero_draw::
   4603 DD 21 FA 45   [14]   39     ld    ix,   #hero    ;; ix apunta a los datos del heroe
   4607 C3 BF 45      [10]   40     jp dw_draw
                             41 
                             42 
   460A                      43 hero_clear::
   460A DD 21 FA 45   [14]   44     ld ix, #hero
   460E C3 EA 45      [10]   45     jp dw_clear
                             46 
   4611                      47 hero_update::
   4611 DD 36 04 00   [19]   48     ld e_vx(ix), #0
   4615 DD 36 05 00   [19]   49     ld e_vy(ix), #0
                             50 
   4619 CD 1F 49      [17]   51     call cpct_scanKeyboard_asm
   461C 21 08 20      [10]   52     ld hl, #Key_A                   ;; Comprueba tecla A
   461F CD 62 47      [17]   53     call cpct_isKeyPressed_asm
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 57.
Hexadecimal [16-Bits]



   4622 28 0C         [12]   54     jr z, a_no_pulsada
   4624 CD 9B 46      [17]   55         call move_camera_left
   4627 DD 7E 00      [19]   56         ld a, e_x(ix)
   462A 3D            [ 4]   57         dec a
   462B DD 77 00      [19]   58         ld e_x(ix), a
   462E 18 15         [12]   59         jr d_no_pulsada             ;; Si se ha pulsado no compruebes la tecla D
                             60 
   4630                      61     a_no_pulsada:
   4630 CD 1F 49      [17]   62         call cpct_scanKeyboard_asm
   4633 21 07 20      [10]   63         ld hl, #Key_D               ;; Comprueba tecla D
   4636 CD 62 47      [17]   64         call cpct_isKeyPressed_asm
   4639 28 0A         [12]   65         jr z, d_no_pulsada
   463B CD 93 46      [17]   66             call move_camera_right
   463E DD 7E 00      [19]   67             ld a, e_x(ix)
   4641 3C            [ 4]   68             inc a
   4642 DD 77 00      [19]   69             ld e_x(ix), a
                             70 
   4645                      71     d_no_pulsada:
   4645 CD 1F 49      [17]   72         call cpct_scanKeyboard_asm
   4648 21 07 08      [10]   73         ld hl, #Key_W
   464B CD 62 47      [17]   74         call cpct_isKeyPressed_asm
   464E 28 0C         [12]   75         jr z, w_no_pulsada
   4650 CD A3 46      [17]   76             call move_camera_up
   4653 DD 7E 01      [19]   77             ld a, e_y(ix)
   4656 90            [ 4]   78             sub b
   4657 DD 77 01      [19]   79             ld e_y(ix), a
   465A 18 15         [12]   80             jr s_no_pulsada
                             81 
   465C                      82     w_no_pulsada:
   465C CD 1F 49      [17]   83         call cpct_scanKeyboard_asm
   465F 21 07 10      [10]   84         ld hl, #Key_S
   4662 CD 62 47      [17]   85         call cpct_isKeyPressed_asm
   4665 28 0A         [12]   86         jr z, s_no_pulsada
   4667 CD AD 46      [17]   87             call move_camera_down
   466A DD 7E 01      [19]   88             ld a, e_y(ix)
   466D 80            [ 4]   89             add b
   466E DD 77 01      [19]   90             ld e_y(ix), a
                             91 
   4671                      92     s_no_pulsada:
                             93 
                             94 
   4671 C9            [10]   95 ret
                             96 
                             97 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             98 ;; CARGA EN LOS REGISTROS A,B LOS VALORES DE X,Y
                             99 ;; _______________________
                            100 ;; DESTRUYE: A, B
                            101 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4672                     102 hero_get_position::
   4672 3A FB 45      [13]  103    ld    a,    (hero_y)
   4675 47            [ 4]  104    ld    b,    a
   4676 3A FA 45      [13]  105    ld    a,    (hero_x)
   4679 C9            [10]  106    ret
                            107 
                            108 ;;======================================================================
