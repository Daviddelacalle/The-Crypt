...
Hexadecimal [16-Bits]
                             ...
                             19 ;;======================================================================
                             20 ;;======================================================================
                     000A    21 vector_size = 10
                     000A    22 bullet_size = 10                    ;; Debe de ser parametrizado, CUANTO ANTES!
                             23 
                     0002    24 K_VEL_X = 2
                     0004    25 K_VEL_Y = 4
                             26 
   35F1 00 00                27 vector_index:  .dw #0x0000
   35F3                      28 vector_init:                        ;; Marca el inicio de vector_bullets
   35F3                      29 DefineNBullets vector_bullets, vector_size
                     0000     1    _c = 0
                              2    .rept vector_size
                              3       DefineBulletDefault vector_bullets, \_c
                              4       _c = _c + 1
                              5    .endm
   35F3                       1       DefineBulletDefault vector_bullets, \_c
   ...
   35F3 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   35F5 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   35F7                       3    DefineMovableEnt  vector_bullets0_mv, 0, 0                             ;;'
   0006                       1 vector_bullets0_mv:
   35F7 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   35F9 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   35FA 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   35FB FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0001     2       _c = _c + 1
   35FD                       1       DefineBulletDefault vector_bullets, \_c
   35FD                       1    DefineBullet vector_bullets1, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   000C                       1 vector_bullets1:
   000C                       2    DefineDrawableEnt vector_bullets1_dw, 0xAA, 0, 0, 0                       ;;'
   000C                       1 vector_bullets1_dw:
   35FD AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   35FF 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   3601                       3    DefineMovableEnt  vector_bullets1_mv, 0, 0                             ;;'
   0010                       1 vector_bullets1_mv:
   3601 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   3603 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   3604 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   3605 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0002     2       _c = _c + 1
   3607                       1       DefineBulletDefault vector_bullets, \_c
   3607                       1    DefineBullet vector_bullets2, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
...
Hexadecimal [16-Bits]
   ...
   3607 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   3609 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   360B                       3    DefineMovableEnt  vector_bullets2_mv, 0, 0                             ;;'
   001A                       1 vector_bullets2_mv:
   360B 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   360D 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   360E 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   360F FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0003     2       _c = _c + 1
   3611                       1       DefineBulletDefault vector_bullets, \_c
   3611                       1    DefineBullet vector_bullets3, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   0020                       1 vector_bullets3:
   0020                       2    DefineDrawableEnt vector_bullets3_dw, 0xAA, 0, 0, 0                       ;;'
   0020                       1 vector_bullets3_dw:
   3611 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   3613 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   3615                       3    DefineMovableEnt  vector_bullets3_mv, 0, 0                             ;;'
   0024                       1 vector_bullets3_mv:
   3615 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   3617 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   3618 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   3619 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0004     2       _c = _c + 1
   361B                       1       DefineBulletDefault vector_bullets, \_c
   361B                       1    DefineBullet vector_bullets4, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   002A                       1 vector_bullets4:
   002A                       2    DefineDrawableEnt vector_bullets4_dw, 0xAA, 0, 0, 0                       ;;'
   002A                       1 vector_bullets4_dw:
   361B AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   361D 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   361F                       3    DefineMovableEnt  vector_bullets4_mv, 0, 0                             ;;'
   002E                       1 vector_bullets4_mv:
   361F 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   3621 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   3622 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   3623 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0005     2       _c = _c + 1
   3625                       1       DefineBulletDefault vector_bullets, \_c
   3625                       1    DefineBullet vector_bullets5, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   0034                       1 vector_bullets5:
   0034                       2    DefineDrawableEnt vector_bullets5_dw, 0xAA, 0, 0, 0                       ;;'
   0034                       1 vector_bullets5_dw:
   3625 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   3627 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   3629                       3    DefineMovableEnt  vector_bullets5_mv, 0, 0                             ;;'
   0038                       1 vector_bullets5_mv:
   3629 00 00                 2    .db   0, 0    ;; Variables de la velocidad
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 55.
Hexadecimal [16-Bits]



   362B 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   362C 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   362D FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0006     2       _c = _c + 1
   362F                       1       DefineBulletDefault vector_bullets, \_c
   362F                       1    DefineBullet vector_bullets6, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   003E                       1 vector_bullets6:
   003E                       2    DefineDrawableEnt vector_bullets6_dw, 0xAA, 0, 0, 0                       ;;'
   003E                       1 vector_bullets6_dw:
   362F AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   3631 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   3633                       3    DefineMovableEnt  vector_bullets6_mv, 0, 0                             ;;'
   0042                       1 vector_bullets6_mv:
   3633 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   3635 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   3636 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   3637 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0007     2       _c = _c + 1
   3639                       1       DefineBulletDefault vector_bullets, \_c
   3639                       1    DefineBullet vector_bullets7, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   0048                       1 vector_bullets7:
   0048                       2    DefineDrawableEnt vector_bullets7_dw, 0xAA, 0, 0, 0                       ;;'
   0048                       1 vector_bullets7_dw:
   3639 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   363B 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   363D                       3    DefineMovableEnt  vector_bullets7_mv, 0, 0                             ;;'
   004C                       1 vector_bullets7_mv:
   363D 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   363F 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   3640 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   3641 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0008     2       _c = _c + 1
   3643                       1       DefineBulletDefault vector_bullets, \_c
   3643                       1    DefineBullet vector_bullets8, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   0052                       1 vector_bullets8:
   0052                       2    DefineDrawableEnt vector_bullets8_dw, 0xAA, 0, 0, 0                       ;;'
   0052                       1 vector_bullets8_dw:
   3643 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   3645 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   3647                       3    DefineMovableEnt  vector_bullets8_mv, 0, 0                             ;;'
   0056                       1 vector_bullets8_mv:
   3647 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   3649 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   364A 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   364B FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0009     2       _c = _c + 1
   364D                       1       DefineBulletDefault vector_bullets, \_c
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 56.
Hexadecimal [16-Bits]



   364D                       1    DefineBullet vector_bullets9, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   005C                       1 vector_bullets9:
   005C                       2    DefineDrawableEnt vector_bullets9_dw, 0xAA, 0, 0, 0                       ;;'
   005C                       1 vector_bullets9_dw:
   364D AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   364F 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   3651                       3    DefineMovableEnt  vector_bullets9_mv, 0, 0                             ;;'
   0060                       1 vector_bullets9_mv:
   3651 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   3653 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   3654 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   3655 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     000A     2       _c = _c + 1
   3657                      30 DefineBullet bullet_copy 0xFF, 0xFF, #1, #4, 0, 4, #0x0F, #20, bullet_checkUpdate
   3657                       1 bullet_copy:
   0066                       2    DefineDrawableEnt bullet_copy_dw, 0xFF, 0xFF, #1, #4                       ;;'
   0066                       1 bullet_copy_dw:
   3657 FF FF                 2    .db   0xFF, 0xFF      ;; Posicion    (x,y)
   3659 01 04                 3    .db   #1, #4      ;; Dimensiones (w,h)
   365B                       3    DefineMovableEnt  bullet_copy_mv, 0, 4                             ;;'
   006A                       1 bullet_copy_mv:
   365B 00 04                 2    .db   0, 4    ;; Variables de la velocidad
   365D 0F                    4    .db   #0x0F        ;; Color / Sprite (cuando haya)
   365E 14                    5    .db   #20      ;; _alive>0? Se actualiza/dibuja
   365F 94 37                 6    .dw   bullet_checkUpdate        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                             31 
   3661 00                   32 save_a:        .db #0x00            ;; Guarda el valor de A
   3662 00                   33 flag_init:     .db #0x00            ;; if(flag_init==1) Hay una entidad bullet que se ha inicializado
                             34 
   3663                      35 vector_keys:
   3663 00 01 D8 36          36    .dw #Key_CursorUp,      #keyUp_ON      ;; Flecha de arriba
   3667 00 04 DE 36          37    .dw #Key_CursorDown,    #keyDown_ON    ;; Flecha de abajo
   366B 00 02 E4 36          38    .dw #Key_CursorRight,   #keyRight_ON   ;; Flecha de derecha
   366F 01 01 EA 36          39    .dw #Key_CursorLeft,    #keyLeft_ON    ;; Flecha de izquierda
   3673 FF                   40    .db #0xFF                              ;; Fin
   3674 00                   41 flag_vx:       .db #0
   3675 00                   42 flag_vy:       .db #0
   3676 00                   43 flag_shoot:    .db #0                     ;; Solo habra un disparo por cada vez que se pulse cada tecla
   3677 00                   44 flag_key:      .db #0                     ;; Si ha pulsado alguna de las 4 teclas de disparo, flag_key = 1
                             45 
                     0001    46 k_update_count = 1
   3678 01                   47 update_count:  .db #k_update_count        ;; Limita el update a cada 2 frames
                             48 
                             49 ;;======================================================================
                             50 ;;======================================================================
                             51 ;; FUNCIONES PUBLICAS
                             52 ;;======================================================================
                             53 ;;======================================================================
                             54 
                             55 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             56 ;; DIBUJADO DE LA ENTIDAD BULLET
...
Hexadecimal [16-Bits]
                             ...
                             59 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   3679                      60 bullet_draw::
   3679 21 38 37      [10]   61    ld    hl,   #bullet_checkDraw
   367C C3 1B 37      [10]   62    jp    bullet_search                 ;; Llamada al bucle
                             63 
                             64 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             65 ;; UPDATE DE TODAS LAS BALAS INICIALIZADAS
                             66 ;; _______________________
                             67 ;; DESTRUYE: HL
                             68 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   367F                      69 bullet_update::
   367F 3A 78 36      [13]   70    ld    a, (update_count)                ;; ======================== ;;
   3682 3D            [ 4]   71    dec   a                                ;;     POR SI AL FINAL      ;;
   3683 32 78 36      [13]   72    ld    (update_count), a                ;;    SE QUIERE LIMITAR     ;;
   3686 FE 01         [ 7]   73    cp    #1                               ;;  EL UPDATE DE LAS BALAS  ;;
   3688 C8            [11]   74    ret   z                                ;; ======================== ;;
                             75 
   3689 21 73 37      [10]   76    ld    hl,   #bullet_searchUpdate
   368C CD 1B 37      [17]   77    call    bullet_search                  ;; Llamada al bucle
                             78 
   368F 3E 01         [ 7]   79    ld    a, #k_update_count               ;; REINICIAR EL CONTADOR
   3691 32 78 36      [13]   80    ld    (update_count), a                ;;       DEL UPDATE
   3694 C9            [10]   81    ret
                             82 
                             83 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             84 ;; CLEAR
                             ...
                             86 ;; DESTRUYE: HL
                             87 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   3695                      88 bullet_clear::
   3695 21 AA 37      [10]   89    ld    hl,   #bullet_checkClear
   3698 C3 1B 37      [10]   90    jp    bullet_search
                             91 
                             92 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             93 ;; COMPRUEBA LOS INPUTS
                             94 ;; _______________________
                             95 ;; DESTRUYE: AF, BC, DE, HL, IX
                             96 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   369B                      97 bullet_inputs::
   369B CD 93 41      [17]   98    call cpct_scanKeyboard_asm
                             99 
                            100    ;; ¡¡¡¡¡¡¡¡HAY QUE ARREGLAR ESTO!!!!!!!!
                            101    ;;ld    hl,   #vector_keys         ;; IX apunta al vector de codigos de teclado
                            102    ;;loop:
                            103    ;;   ld     a,   (hl)              ;; A = 0(ix)
                            104    ;;   cp  #0xFF                     ;; El final del vector lo marca un FF
                            105    ;;   jr     z,   end_loop          ;; Sale del bucle en caso que A == FF
                            106    ;;      push  hl
                            107    ;;      call  cpct_isKeyPressed_asm   ;; CPC
                            108    ;;      pop   hl
                            109    ;;   inc   hl                      ;; HL ++
                            110    ;;   inc   hl                      ;; HL ++
                            111    ;;   ld     c,   (hl)              ;; Guardo en BC el valor al que apunta HL
...
Hexadecimal [16-Bits]
                            ...
                            112    ;;   inc   hl                      ;; HL ++
                            113    ;;   ld     b,   (hl)              ;; Guardo en BC el valor al que apunta HL
                            114    ;;   inc   hl                      ;; HL ++
                            115    ;;   ld (k_custom), bc             ;;
                            116    ;;      k_custom = . + 1           ;; CARGAR LA FUNCION PROPIA DE CADA KEY
                            117    ;;      call nz, (0x0000)          ;;
                            118    ;;   jr    loop                    ;; Vuelta arriba
                            119    ;;end_loop:
                            120 
                            121    ;; Bucle mas costoso
   369E DD 21 63 36   [14]  122    ld    ix,   #vector_keys         ;; IX apunta al vector de codigos de teclado
   36A2                     123    loop:
   36A2 DD 7E 00      [19]  124       ld     a,   0(ix)             ;; A = 0(ix)
   36A5 FE FF         [ 7]  125       cp  #0xFF                     ;; El final del vector lo marca un FF
   36A7 28 23         [12]  126       jr     z,   end_loop          ;; Sale del bucle en caso que A == FF
                            127 
   36A9 DD 6E 00      [19]  128       ld     l,   0(ix)             ;; Cargo el codigo de la tecla en HL
   36AC DD 66 01      [19]  129       ld     h,   1(ix)             ;; Cargo el codigo de la tecla en HL
   36AF CD BC 3E      [17]  130       call cpct_isKeyPressed_asm    ;; CPC
   36B2 DD 6E 02      [19]  131       ld     l,   2(ix)             ;; Cargo el codigo de la funcion en HL
   36B5 DD 66 03      [19]  132       ld     h,   3(ix)             ;; Cargo el codigo de la funcion en HL
   36B8 22 BC 36      [16]  133       ld (k_custom), hl
                     00CB   134          k_custom = . + 1
   36BB C4 00 00      [17]  135          call nz, (0x0000)          ;; CUSTOM
   36BE 28 05         [12]  136          jr z, keep_looping         ;; Si no se ha pulsado ninguna tecla, pasa
   36C0 3E 01         [ 7]  137             ld a, #1
   36C2 32 77 36      [13]  138             ld (flag_key), a        ;; flag_key = ON
   36C5                     139       keep_looping:
   36C5 11 04 00      [10]  140       ld    de,   #4                ;; Sumo 4 para ir a la siguiente tecla
   36C8 DD 19         [15]  141       add   ix,   de                ;; IX + 4
   36CA 18 D6         [12]  142       jr    loop
   36CC                     143    end_loop:
                            144 
                            145 
   36CC 3A 77 36      [13]  146    ld a, (flag_key)                 ;; A = flag_key
   36CF FE 00         [ 7]  147    cp #0                            ;; Si A == 1: SE HA PULSADO ALGUNA DE LAS 4 TECLAS DE DISPARO
   36D1 C2 FC 36      [10]  148    jp nz, bullet_init               ;; Si A == 0: NO SE HA PULSADO NINGUNA TECLA DE DISPARO
                            149 
   36D4 C3 F6 36      [10]  150    jp flag_shoot_off                ;; Volver flag_shoot a 0
   36D7 C9            [10]  151 ret
                            152 
                            153 ;;======================================================================
                            154 ;;======================================================================
                            155 ;; FUNCIONES PRIVADAS
                            156 ;;======================================================================
                            157 ;;======================================================================
                            158 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            159 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN Y
                            160 ;; _______________________
                            161 ;; DESTRUYE: A
                            162 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   36D8                     163 keyUp_ON:
   36D8 3E FC         [ 7]  164    ld a, #-K_VEL_Y
   36DA 32 75 36      [13]  165    ld (flag_vy), a
   36DD C9            [10]  166    ret
...
Hexadecimal [16-Bits]
                            ...
                            167 
                            168 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            169 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN Y
                            170 ;; _______________________
                            171 ;; DESTRUYE: A
                            172 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   36DE                     173 keyDown_ON:
   36DE 3E 04         [ 7]  174    ld a, #K_VEL_Y
   36E0 32 75 36      [13]  175    ld (flag_vy), a
   36E3 C9            [10]  176    ret
                            177 
                            178 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            179 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN X
                            180 ;; _______________________
                            181 ;; DESTRUYE: A
                            182 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   36E4                     183 keyRight_ON:
   36E4 3E 02         [ 7]  184    ld a, #K_VEL_X
   36E6 32 74 36      [13]  185    ld (flag_vx), a
   36E9 C9            [10]  186    ret
                            187 
                            188 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            189 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN X
                            190 ;; _______________________
                            191 ;; DESTRUYE: A
                            192 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   36EA                     193 keyLeft_ON:
   36EA 3E FE         [ 7]  194    ld a, #-K_VEL_X
   36EC 32 74 36      [13]  195    ld (flag_vx), a
   36EF C9            [10]  196    ret
                            197 
                            198 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            199 ;; CAMBIA flag_shoot A 1 E IMPIDE DISPARAR MAS, A MENOS QUE SUELTES LA TECLA
                            200 ;; _______________________
                            201 ;; DESTRUYE: A
                            202 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   36F0                     203 flag_shoot_on:
   36F0 3E 01         [ 7]  204    ld a, #1
   36F2 32 76 36      [13]  205    ld (flag_shoot), a
   36F5 C9            [10]  206    ret
                            207 
                            208 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            209 ;; CAMBIA flag_shoot A 0 Y PERMITE DISPARAR MAS VECES AL PULSAR
                            210 ;; _______________________
                            211 ;; DESTRUYE: A
                            212 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   36F6                     213 flag_shoot_off:
   36F6 3E 00         [ 7]  214    ld a, #0
   36F8 32 76 36      [13]  215    ld (flag_shoot), a
   36FB C9            [10]  216    ret
                            217 
                            218 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            219 ;; INICIALIZA UNA ENTIDAD BULLET
...
Hexadecimal [16-Bits]
                            ...
                            222 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   36FC                     223 bullet_init:
                            224    ;; Comprueba que solo se pueda disparar una vez por cada pulsacion de tecla
   36FC 3A 76 36      [13]  225    ld a, (flag_shoot)               ;; A = flag_shoot
   36FF FE 00         [ 7]  226    cp #0                            ;; A - 0 = A
   3701 20 09         [12]  227    jr nz, bullet_init_end           ;; Si flag_shoot == 1, vuelve
                            228 
   3703 21 41 37      [10]  229    ld    hl,   #bullet_checkInit
   3706 CD 1B 37      [17]  230    call  bullet_search              ;; Llamada al bucle
   3709 CD F0 36      [17]  231    call  flag_shoot_on              ;; Si llega aqui, es que se ha pulsado alguna tecla, entonces flag = ON
                            232 
   370C                     233    bullet_init_end:
                            234    ;; Reset de los flags
   370C 3E 00         [ 7]  235    ld     a,   #0
   370E 32 62 36      [13]  236       ld (flag_init), a
   3711 32 74 36      [13]  237       ld   (flag_vx), a
   3714 32 75 36      [13]  238       ld   (flag_vy), a
   3717 32 77 36      [13]  239       ld  (flag_key), a
   371A C9            [10]  240    ret
                            241 
                            242 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            243 ;; RECORRE vector_bullets
                            244 ;; _______________________
                            245 ;; ENTRADA:    HL -> Puntero a funcion custom
                            246 ;; DESTRUYE:   A, DE, IX
                            247 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   371B                     248 bullet_search:
   371B 3E 00         [ 7]  249    ld     a,   #0                ;; Cargo en A el valor inicial 0
   371D DD 21 F3 35   [14]  250    ld    ix,   #vector_init      ;; IX apunta al inicio de vector_bullets (a la primera entidad)
   3721 22 28 37      [16]  251    ld    (f_custom), hl          ;; Cargo en el call de abajo la funcion a la que quiero llamar en cada momento determinado
   3724                     252    search_loop:
   3724 32 61 36      [13]  253       ld (save_a),  a            ;; Guardo el valor de A, porque la llamada a la funcion puede destruirlo
                            254 
                     0137   255       f_custom = . +1                  ;; . apunta a 'call' y con el '+1' apunta a '(0x0000)' -> (valor arbitrario, puesto que siempre va a cambiar)
   3727 CD 00 00      [17]  256       call (0x0000)                    ;; LLAMADA A FUNCION PERSONALIZABLE
                            257 
   372A 11 0A 00      [10]  258       ld    de,   #bullet_size         ;; Cargo en DE el tamanyo de la entidad bullet para despues sumarlo a HL
   372D DD 19         [15]  259       add   ix,   de                   ;; IX + DE = Apunta a la siguiente entidad bullet
                            260 
   372F 3A 61 36      [13]  261       ld     a,   (save_a)             ;; Recupero el valor de a
   3732 3C            [ 4]  262       inc    a                         ;; A++
   3733 FE 0A         [ 7]  263    cp #vector_size
   3735 20 ED         [12]  264    jr nz, search_loop
   3737 C9            [10]  265    ret
                            266 
                            267 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            268 ;; COMPROBAR SI EN LA ENTIDAD BULLET alive > 0
                            269 ;; _______________________
                            270 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            271 ;; DESTRUYE:   A
                            272 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   3738                     273 bullet_checkDraw:
   3738 DD 7E 07      [19]  274    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   373B FE 00         [ 7]  275    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
                            276 
...
Hexadecimal [16-Bits]
                            ...
                            277 
                            278 
                            279    ; ld a, #0xAA                   ;; Se le manda A = AA a dw_draw ya que LAS COORDEADAS DE LAS BALAS ESTAN EN TILES
   373D C4 32 39      [17]  280    call  nz,   #dw_draw          ;; Llama a la funcion de dibujado
   3740 C9            [10]  281    ret
                            282 
                            283 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            284 ;; COMPROBAR SI EN LA ENTIDAD BULLET alive = 0
                            285 ;; _______________________
                            286 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            287 ;; DESTRUYE:   A, HL, DE, BC
                            288 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   3741                     289 bullet_checkInit:
   3741 3A 62 36      [13]  290    ld     a,   (flag_init)       ;; Si no se ha iniciado ninguna entidad bullet A==0
   3744 FE 00         [ 7]  291    cp    #0
   3746 C0            [11]  292    ret   nz                      ;; Si es 1 (1!=0), vuelve y no inicia mas entidades
                            293 
                            294    ;; Comprueba el atributo alive
   3747 DD 7E 07      [19]  295    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   374A FE 00         [ 7]  296    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1 -> INICIALIZO
   374C C0            [11]  297    ret   nz                      ;; Si ya esta inicializada, hago ret
                            298 
                            299    ;; REALIZA UNA COPIA DE LA ENTIDAD POR DEFECTO
   374D DD E5         [15]  300    push  ix                      ;; Guardo IX en la pila
   374F D1            [10]  301    pop   de                      ;; Entidad DESTINO
   3750 21 57 36      [10]  302    ld    hl,   #bullet_copy      ;; Entidad ORIGEN
   3753 01 0A 00      [10]  303    ld    bc,   #bullet_size      ;; Tamanyo de la entidad
   3756 ED B0         [21]  304    ldir
                            305 
                            306 
                            307    ;; DEBO CONSEGUIR UNAS POSICIONES DE TILE DEL HERO
   3758 CD E4 35      [17]  308    call hero_get_position        ;; A = hero_x // B = hero_y
                            309    ; ld l, a                       ;; L = X
                            310    ; ld h, b                       ;; H = Y
                            311    ; call mapa_a_tile              ;; Aplica el offset de la camara automaticamente
                            312 
                            313    ;; Si debo cambiar algo de la entidad, aqui
   375B DD 77 00      [19]  314    ld    b_x(ix), a              ;; Asigno X
   375E DD 70 01      [19]  315    ld    b_y(ix), b              ;; Asigno Y
                            316 
   3761 3A 74 36      [13]  317    ld    a,    (flag_vx)         ;;
   3764 DD 77 04      [19]  318    ld    b_vx(ix), a             ;; Asigno VX
   3767 3A 75 36      [13]  319    ld    a,    (flag_vy)         ;;
   376A DD 77 05      [19]  320    ld    b_vy(ix), a             ;; Asigno VX
                            321 
   376D 3E 01         [ 7]  322    ld     a,   #1                ;; flag_init = 1
   376F 32 62 36      [13]  323    ld (flag_init), a             ;; YA NO SE PODRA INICIALIZAR NINGUNA ENTIDAD MAS
                            324                                  ;;   EN EL RECORRIDO DE ESTE BUCLE, AHORA MISMO
   3772 C9            [10]  325    ret
                            326 
                            327 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            328 ;; LLAMA A CADA FUNCION DE ACTUALIZACION DE CADA ENTIDAD
                            329 ;; _______________________
                            330 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            331 ;; DESTRUYE:   HL, A
...
Hexadecimal [16-Bits]
                            ...
                            332 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   3773                     333 bullet_searchUpdate:
   3773 DD 7E 07      [19]  334    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   3776 FE 00         [ 7]  335    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
   3778 C8            [11]  336    ret    z                      ;; Si no se ha inicialiado, poco podemos hacer
                            337 
                            338    ; call checkTileCollision
   3779 CD 10 3D      [17]  339    call checkTileCollision_m
   377C 20 09         [12]  340    jr nz, no_tile_collision
   377E 21 B3 37      [10]  341       ld hl, #bullet_death
   3781 DD 74 09      [19]  342       ld b_up_h(ix), h
   3784 DD 75 08      [19]  343       ld b_up_l(ix), l
   3787                     344    no_tile_collision:
                            345 
   3787 CD B9 37      [17]  346    call bullet_checkBorderCollision
                            347 
   378A CD 14 38      [17]  348    call bullet_check_death
                            349 
   378D DD 6E 08      [19]  350    ld l, b_up_l(ix)           ;; Carga el byte bajo en L
   3790 DD 66 09      [19]  351    ld h, b_up_h(ix)           ;; Carga el byte alto en H
   3793 E9            [ 4]  352    jp (hl)                    ;; Llama a la funcion propia de cada entidad
                            353 
                            354 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            355 ;; COMPROBAR SI EN LA ENTIDAD BULLET alive > 0 Y LO ACTUALIZO
                            356 ;; _______________________
                            357 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            358 ;; DESTRUYE:   A
                            359 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   3794                     360 bullet_checkUpdate:
                            361    ;; UPDATE ALIVE
   3794 DD 35 07      [23]  362    dec   b_alive(ix)     ;; Decrementar el valor de alive y si llega a 1 matar la bala -> alive = 0
                            363 
                            364    ;; UPDATE POSICION
   3797 DD 7E 00      [19]  365    ld     a,   b_x(ix)           ;; Cargo en A la posicion en X
   379A DD 86 04      [19]  366    add b_vx(ix)                  ;; Le aumento la velocidad en X
   379D DD 77 00      [19]  367    ld  b_x(ix), a                ;; Guardo el dato actualizado
                            368 
   37A0 DD 7E 01      [19]  369    ld     a,   b_y(ix)           ;; Cargo en A la posicion en Y
   37A3 DD 86 05      [19]  370    add b_vy(ix)                  ;; Le aumento la velocidad en Y
   37A6 DD 77 01      [19]  371    ld  b_y(ix), a                ;; Guardo el dato actualizado
                            372 
   37A9 C9            [10]  373    ret
                            374 
                            375 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            376 ;; CAMBIA EL COLOR DE LA BALA AL DEL FONDO (SI NO HAY SPRITES)
                            377 ;; _______________________
                            378 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            379 ;; DESTRUYE:
                            380 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   37AA                     381 bullet_checkClear:
   37AA DD 7E 07      [19]  382     ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   37AD FE 00         [ 7]  383     cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
   37AF C4 7D 39      [17]  384     call nz, dw_clear
   37B2 C9            [10]  385 ret
                            386 
...
Hexadecimal [16-Bits]
                            ...
                            387 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            388 ;; MUERTE DE LA BALA
                            389 ;; ____________________________________________________
                            390 ;; ENTRADA:    IX -> Puntero a la entidad BULLET
                            391 ;; DESTRUYE:   A
                            392 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   37B3                     393 bullet_death:
   37B3 3E 00         [ 7]  394    ld a, #0
   37B5 DD 77 07      [19]  395    ld b_alive(ix), a
   37B8 C9            [10]  396    ret
                            397 
                            398 
                            399 
                            400 ;;;;;
   37B9                     401 bullet_checkBorderCollision:
   37B9 DD 7E 04      [19]  402    ld    a, e_vx(ix)
   37BC FE FE         [ 7]  403    cp    #-K_VEL_X
   37BE 20 10         [12]  404    jr nz , check_right
   37C0 3E 08         [ 7]  405       ld    a,    #8
   37C2 DD BE 00      [19]  406       cp    b_x(ix)
   37C5 D8            [11]  407       ret c
   37C6 21 B3 37      [10]  408          ld hl, #bullet_death
   37C9 DD 74 09      [19]  409          ld b_up_h(ix), h
   37CC DD 75 08      [19]  410          ld b_up_l(ix), l
   37CF C9            [10]  411          ret
   37D0                     412    check_right:
                            413 
   37D0 DD 7E 04      [19]  414    ld    a, e_vx(ix)
   37D3 FE 02         [ 7]  415    cp    #K_VEL_X
   37D5 20 10         [12]  416    jr nz , check_up
   37D7 3E 44         [ 7]  417       ld    a,    #68
   37D9 DD BE 00      [19]  418       cp    b_x(ix)
   37DC D0            [11]  419       ret nc
   37DD 21 B3 37      [10]  420          ld hl, #bullet_death
   37E0 DD 74 09      [19]  421          ld b_up_h(ix), h
   37E3 DD 75 08      [19]  422          ld b_up_l(ix), l
   37E6 C9            [10]  423          ret
   37E7                     424    check_up:
                            425 
   37E7 DD 7E 05      [19]  426    ld    a, e_vy(ix)
   37EA FE FC         [ 7]  427    cp    #-K_VEL_Y
   37EC 20 10         [12]  428    jr nz , check_down
   37EE 3E 22         [ 7]  429       ld    a,    #34
   37F0 DD BE 01      [19]  430       cp    b_y(ix)
   37F3 D8            [11]  431       ret c
   37F4 21 B3 37      [10]  432          ld hl, #bullet_death
   37F7 DD 74 09      [19]  433          ld b_up_h(ix), h
   37FA DD 75 08      [19]  434          ld b_up_l(ix), l
   37FD C9            [10]  435          ret
   37FE                     436    check_down:
                            437 
   37FE DD 7E 05      [19]  438    ld    a, e_vy(ix)
   3801 FE 04         [ 7]  439    cp    #K_VEL_Y
   3803 C0            [11]  440    ret nz
   3804 3E 98         [ 7]  441       ld    a,    #152
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 64.
Hexadecimal [16-Bits]



   3806 DD BE 01      [19]  442       cp    b_y(ix)
   3809 D0            [11]  443       ret nc
   380A 21 B3 37      [10]  444          ld hl, #bullet_death
   380D DD 74 09      [19]  445          ld b_up_h(ix), h
   3810 DD 75 08      [19]  446          ld b_up_l(ix), l
   3813 C9            [10]  447          ret
                            448 
                            449 
                            450 ;; COLISION ENEMIGO-BALA
   3814                     451 bullet_check_death::
                            452   ;;tengo que comparar las variables b_x(ix)/b_y(ix) con la posicion de cada enemigo y ver si coinciden
                            453 
   3814 CD 8F 3D      [17]  454    call enemy_load
   3817                     455    loop_bullet:
   3817 FD 7E 00      [19]  456    ld a, 0(iy)
   381A FE FF         [ 7]  457       cp #0xFF
   381C C8            [11]  458       ret z
                            459 
   381D FD 66 01      [19]  460    ld     h, e_y(iy)
   3820 FD 6E 00      [19]  461    ld     l, e_x(iy)
   3823 CD 8D 39      [17]  462    call tile_a_mapa
                            463 
   3826 DD 7E 00      [19]  464    ld     a, b_x(ix)
   3829 B9            [ 4]  465    cp c
   382A 30 02         [12]  466    jr nc, death_check_left ;; si el carry es mayor el numero de cp es mas grande
   382C 18 09         [12]  467         jr death_check_right
                            468 
   382E                     469    death_check_left:
   382E 79            [ 4]  470       ld a, c
   382F DD 4E 00      [19]  471       ld    c, b_x(ix)
   3832 B9            [ 4]  472       cp c
   3833 38 3B         [12]  473       jr c, end_loop_bullet
   3835 18 08         [12]  474            jr death_check_vertical
   3837                     475    death_check_right:
   3837 DD 7E 00      [19]  476       ld a, b_x(ix)
   383A B9            [ 4]  477       cp c
   383B 38 33         [12]  478       jr c, end_loop_bullet
   383D 18 00         [12]  479            jr death_check_vertical
                            480 
                            481 
   383F                     482    death_check_vertical:
   383F DD 7E 01      [19]  483    ld     a, b_y(ix)
   3842 B8            [ 4]  484    cp b
   3843 38 02         [12]  485    jr c, death_check_down ;; si el carry es mayor el numero de cp es mas grande
   3845 18 14         [12]  486         jr death_check_up
                            487 
   3847                     488    death_check_down:
   3847 DD 7E 01      [19]  489       ld a, b_y(ix)
   384A C6 08         [ 7]  490       add a,#8
   384C B8            [ 4]  491       cp b
   384D 38 21         [12]  492       jr c, end_loop_bullet
   384F CD 7C 38      [17]  493          call bullet_set_death
   3852 FD 36 01 0F   [19]  494          ld e_y(iy),#15
   3856 FD 36 00 0F   [19]  495          ld e_x(iy),#15
   385A C9            [10]  496          ret
...
Hexadecimal [16-Bits]
   ...
   385B                     497    death_check_up:
   385B 78            [ 4]  498       ld a, b
   385C C6 04         [ 7]  499       add a,#4
   385E DD 46 01      [19]  500       ld    b, b_y(ix)
   3861 B8            [ 4]  501       cp b
   3862 38 0C         [12]  502       jr c, end_loop_bullet
   3864 CD 7C 38      [17]  503          call bullet_set_death
   3867 FD 36 01 0F   [19]  504          ld e_y(iy),#15
   386B FD 36 00 0F   [19]  505          ld e_x(iy),#15
   386F C9            [10]  506          ret
                            507 
   3870                     508    end_loop_bullet:
   3870 CD 94 3D      [17]  509       call get_enemy_size
   3873 26 00         [ 7]  510       ld h, #0
   3875 6F            [ 4]  511       ld l, a
   3876 EB            [ 4]  512       ex de,hl
   3877 FD 19         [15]  513       add iy,de
   3879 18 9C         [12]  514    jr loop_bullet
   387B C9            [10]  515 ret
                            516 
                            517 
   387C                     518 bullet_set_death:
   387C 21 B3 37      [10]  519    ld hl, #bullet_death
   387F DD 74 09      [19]  520    ld b_up_h(ix), h
   3882 DD 75 08      [19]  521    ld b_up_l(ix), l
   3885 C9            [10]  522    ret
