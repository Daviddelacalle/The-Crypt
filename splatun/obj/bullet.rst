...
Hexadecimal [16-Bits]
                             ...
                             19 ;;======================================================================
                             20 ;;======================================================================
                     0002    21 vector_size = 2
                     000B    22 bullet_size = b_size                    ;; Debe de ser parametrizado, CUANTO ANTES!
                             23 
                     0002    24 K_VEL_X = 2
                     0008    25 K_VEL_Y = 8
                             26 
   27BF 00 00                27 vector_index:  .dw #0x0000
   27C1                      28 vector_init:                        ;; Marca el inicio de vector_bullets
   27C1                      29 DefineNBullets vector_bullets, vector_size
                     0000     1    _c = 0
                              2    .rept vector_size
                              3       DefineBulletDefault vector_bullets, \_c
                              4       _c = _c + 1
                              5    .endm
   27C1                       1       DefineBulletDefault vector_bullets, \_c
   0002                       1    DefineBullet vector_bullets0, 0xAA, 0, 0, 0, 0, 0, 0x0000, 0, 0xFFFF        ;;'
   0002                       1 vector_bullets0:
   0002                       2    DefineDrawableEnt vector_bullets0_dw, 0xAA, 0, 0, 0                       ;;'
   0002                       1 vector_bullets0_dw:
   27C1 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   27C3 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   27C5                       3    DefineMovableEnt  vector_bullets0_mv, 0, 0                             ;;'
   0006                       1 vector_bullets0_mv:
   27C5 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   27C7 00 00                 4    .dw   0x0000        ;; Color / Sprite (cuando haya)
   27C9 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   27CA FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     000B     9 b_size = . - (vector_bullets0)
                     0001     2       _c = _c + 1
   27CC                       1       DefineBulletDefault vector_bullets, \_c
   27CC                       1    DefineBullet vector_bullets1, 0xAA, 0, 0, 0, 0, 0, 0x0000, 0, 0xFFFF        ;;'
   000D                       1 vector_bullets1:
   000D                       2    DefineDrawableEnt vector_bullets1_dw, 0xAA, 0, 0, 0                       ;;'
   000D                       1 vector_bullets1_dw:
   27CC AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   27CE 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   27D0                       3    DefineMovableEnt  vector_bullets1_mv, 0, 0                             ;;'
   0011                       1 vector_bullets1_mv:
   27D0 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   27D2 00 00                 4    .dw   0x0000        ;; Color / Sprite (cuando haya)
   27D4 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   27D5 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     000B     9 b_size = . - (vector_bullets1)
                     0002     2       _c = _c + 1
   27D7                      30 DefineBullet bullet_copy 0xFF, 0xFF, #2, #4, #0, #4, #_sp_shot_0, #10, #bullet_checkUpdate
...
Hexadecimal [16-Bits]
   ...
   27D7                       1 bullet_copy:
   0018                       2    DefineDrawableEnt bullet_copy_dw, 0xFF, 0xFF, #2, #4                       ;;'
   0018                       1 bullet_copy_dw:
   27D7 FF FF                 2    .db   0xFF, 0xFF      ;; Posicion    (x,y)
   27D9 02 04                 3    .db   #2, #4      ;; Dimensiones (w,h)
   27DB                       3    DefineMovableEnt  bullet_copy_mv, #0, #4                             ;;'
   001C                       1 bullet_copy_mv:
   27DB 00 04                 2    .db   #0, #4    ;; Variables de la velocidad
   27DD C7 0E                 4    .dw   #_sp_shot_0        ;; Color / Sprite (cuando haya)
   27DF 0A                    5    .db   #10      ;; _alive>0? Se actualiza/dibuja
   27E0 1E 29                 6    .dw   #bullet_checkUpdate        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     000B     9 b_size = . - (bullet_copy)
                             31 
   27E2 00                   32 save_a:        .db #0x00            ;; Guarda el valor de A
   27E3 00                   33 flag_init:     .db #0x00            ;; if(flag_init==1) Hay una entidad bullet que se ha inicializado
                             34 
   27E4                      35 vector_keys:
   27E4 00 01 53 28          36    .dw #Key_CursorUp,      #keyUp_ON      ;; Flecha de arriba
   27E8 00 04 59 28          37    .dw #Key_CursorDown,    #keyDown_ON    ;; Flecha de abajo
   27EC 00 02 5F 28          38    .dw #Key_CursorRight,   #keyRight_ON   ;; Flecha de derecha
   27F0 01 01 65 28          39    .dw #Key_CursorLeft,    #keyLeft_ON    ;; Flecha de izquierda
   27F4 FF                   40    .db #0xFF                              ;; Fin
   27F5 00                   41 flag_vx:       .db #0
   27F6 00                   42 flag_vy:       .db #0
   27F7 00                   43 flag_shoot:    .db #0                     ;; Solo habra un disparo por cada vez que se pulse cada tecla
   27F8 00                   44 flag_key:      .db #0                     ;; Si ha pulsado alguna de las 4 teclas de disparo, flag_key = 1
                             45 
                     0001    46 k_update_count = 1
   27F9 01                   47 update_count:  .db #k_update_count        ;; Limita el update a cada 2 frames
                             48 
                             49 ;;======================================================================
                             50 ;;======================================================================
                             ...
                             59 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   27FA                      60 bullet_draw::
   27FA 21 B3 28      [10]   61    ld    hl,   #bullet_checkDraw
   27FD C3 96 28      [10]   62    jp    bullet_search                 ;; Llamada al bucle
                             63 
                             64 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             ...
                             67 ;; DESTRUYE: HL
                             68 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   2800                      69 bullet_update::
   2800 3A F9 27      [13]   70    ld    a, (update_count)                ;; ======================== ;;
   2803 3D            [ 4]   71    dec   a                                ;;     POR SI AL FINAL      ;;
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 55.
Hexadecimal [16-Bits]



   2804 32 F9 27      [13]   72    ld    (update_count), a                ;;    SE QUIERE LIMITAR     ;;
   2807 FE 01         [ 7]   73    cp    #1                               ;;  EL UPDATE DE LAS BALAS  ;;
   2809 C8            [11]   74    ret   z                                ;; ======================== ;;
                             75 
   280A 21 F1 28      [10]   76    ld    hl,   #bullet_searchUpdate
   280D CD 96 28      [17]   77    call    bullet_search                  ;; Llamada al bucle
                             78 
   2810 3E 01         [ 7]   79    ld    a, #k_update_count               ;; REINICIAR EL CONTADOR
   2812 32 F9 27      [13]   80    ld    (update_count), a                ;;       DEL UPDATE
   2815 C9            [10]   81    ret
                             82 
                             83 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             84 ;; COMPRUEBA LOS INPUTS
                             85 ;; _______________________
                             86 ;; DESTRUYE: AF, BC, DE, HL, IX
                             87 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   2816                      88 bullet_inputs::
   2816 CD 64 3F      [17]   89    call cpct_scanKeyboard_asm
                             90 
                             91    ;; Bucle mas costoso
   2819 DD 21 E4 27   [14]   92    ld    ix,   #vector_keys         ;; IX apunta al vector de codigos de teclado
   281D                      93    loop:
   281D DD 7E 00      [19]   94       ld     a,   0(ix)             ;; A = 0(ix)
   2820 FE FF         [ 7]   95       cp  #0xFF                     ;; El final del vector lo marca un FF
   2822 28 23         [12]   96       jr     z,   end_loop          ;; Sale del bucle en caso que A == FF
                             97 
   2824 DD 6E 00      [19]   98       ld     l,   0(ix)             ;; Cargo el codigo de la tecla en HL
   2827 DD 66 01      [19]   99       ld     h,   1(ix)             ;; Cargo el codigo de la tecla en HL
   282A CD F2 34      [17]  100       call cpct_isKeyPressed_asm    ;; CPC
   282D DD 6E 02      [19]  101       ld     l,   2(ix)             ;; Cargo el codigo de la funcion en HL
   2830 DD 66 03      [19]  102       ld     h,   3(ix)             ;; Cargo el codigo de la funcion en HL
   2833 22 37 28      [16]  103       ld (k_custom), hl
                     0078   104          k_custom = . + 1
   2836 C4 00 00      [17]  105          call nz, (0x0000)          ;; CUSTOM
   2839 28 05         [12]  106          jr z, keep_looping         ;; Si no se ha pulsado ninguna tecla, pasa
   283B 3E 01         [ 7]  107             ld a, #1
   283D 32 F8 27      [13]  108             ld (flag_key), a        ;; flag_key = ON
   2840                     109       keep_looping:
   2840 11 04 00      [10]  110       ld    de,   #4                ;; Sumo 4 para ir a la siguiente tecla
   2843 DD 19         [15]  111       add   ix,   de                ;; IX + 4
   2845 18 D6         [12]  112       jr    loop
   2847                     113    end_loop:
                            114 
   2847 3A F8 27      [13]  115    ld a, (flag_key)                 ;; A = flag_key
   284A FE 00         [ 7]  116    cp #0                            ;; Si A == 1: SE HA PULSADO ALGUNA DE LAS 4 TECLAS DE DISPARO
   284C C2 77 28      [10]  117    jp nz, bullet_init               ;; Si A == 0: NO SE HA PULSADO NINGUNA TECLA DE DISPARO
                            118 
   284F C3 71 28      [10]  119    jp flag_shoot_off                ;; Volver flag_shoot a 0
   2852 C9            [10]  120 ret
                            121 
                            122 ;;======================================================================
                            123 ;;======================================================================
                            124 ;; FUNCIONES PRIVADAS
                            125 ;;======================================================================
                            126 ;;======================================================================
...
Hexadecimal [16-Bits]
                            ...
                            127 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            128 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN Y
                            129 ;; _______________________
                            130 ;; DESTRUYE: A
                            131 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   2853                     132 keyUp_ON:
   2853 3E F8         [ 7]  133    ld a, #-K_VEL_Y
   2855 32 F6 27      [13]  134    ld (flag_vy), a
   2858 C9            [10]  135    ret
                            136 
                            137 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            138 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN Y
                            139 ;; _______________________
                            140 ;; DESTRUYE: A
                            141 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   2859                     142 keyDown_ON:
   2859 3E 08         [ 7]  143    ld a, #K_VEL_Y
   285B 32 F6 27      [13]  144    ld (flag_vy), a
   285E C9            [10]  145    ret
                            146 
                            147 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            148 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN X
                            149 ;; _______________________
                            150 ;; DESTRUYE: A
                            151 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   285F                     152 keyRight_ON:
   285F 3E 02         [ 7]  153    ld a, #K_VEL_X
   2861 32 F5 27      [13]  154    ld (flag_vx), a
   2864 C9            [10]  155    ret
                            156 
                            157 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            158 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN X
                            159 ;; _______________________
                            160 ;; DESTRUYE: A
                            161 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   2865                     162 keyLeft_ON:
   2865 3E FE         [ 7]  163    ld a, #-K_VEL_X
   2867 32 F5 27      [13]  164    ld (flag_vx), a
   286A C9            [10]  165    ret
                            166 
                            167 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            168 ;; CAMBIA flag_shoot A 1 E IMPIDE DISPARAR MAS, A MENOS QUE SUELTES LA TECLA
                            169 ;; _______________________
                            170 ;; DESTRUYE: A
                            171 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   286B                     172 flag_shoot_on:
   286B 3E 01         [ 7]  173    ld a, #1
   286D 32 F7 27      [13]  174    ld (flag_shoot), a
   2870 C9            [10]  175    ret
                            176 
                            177 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            178 ;; CAMBIA flag_shoot A 0 Y PERMITE DISPARAR MAS VECES AL PULSAR
...
Hexadecimal [16-Bits]
   ...
   2871                     182 flag_shoot_off:
   2871 3E 00         [ 7]  183    ld a, #0
   2873 32 F7 27      [13]  184    ld (flag_shoot), a
   2876 C9            [10]  185    ret
                            186 
                            187 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            188 ;; INICIALIZA UNA ENTIDAD BULLET
                            189 ;; _______________________
                            190 ;; DESTRUYE: HL, A
                            191 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   2877                     192 bullet_init:
                            193    ;; Comprueba que solo se pueda disparar una vez por cada pulsacion de tecla
   2877 3A F7 27      [13]  194    ld a, (flag_shoot)               ;; A = flag_shoot
   287A FE 00         [ 7]  195    cp #0                            ;; A - 0 = A
   287C 20 09         [12]  196    jr nz, bullet_init_end           ;; Si flag_shoot == 1, vuelve
                            197 
   287E 21 BC 28      [10]  198    ld    hl,   #bullet_checkInit
   2881 CD 96 28      [17]  199    call  bullet_search              ;; Llamada al bucle
   2884 CD 6B 28      [17]  200    call  flag_shoot_on              ;; Si llega aqui, es que se ha pulsado alguna tecla, entonces flag = ON
                            201 
   2887                     202    bullet_init_end:
                            203    ;; Reset de los flags
   2887 3E 00         [ 7]  204    ld     a,   #0
   2889 32 E3 27      [13]  205       ld (flag_init), a
   288C 32 F5 27      [13]  206       ld   (flag_vx), a
   288F 32 F6 27      [13]  207       ld   (flag_vy), a
   2892 32 F8 27      [13]  208       ld  (flag_key), a
   2895 C9            [10]  209    ret
                            210 
                            211 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            212 ;; RECORRE vector_bullets
                            213 ;; _______________________
                            214 ;; ENTRADA:    HL -> Puntero a funcion custom
                            215 ;; DESTRUYE:   A, DE, IX
                            216 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   2896                     217 bullet_search:
   2896 3E 00         [ 7]  218    ld     a,   #0                ;; Cargo en A el valor inicial 0
   2898 DD 21 C1 27   [14]  219    ld    ix,   #vector_init      ;; IX apunta al inicio de vector_bullets (a la primera entidad)
   289C 22 A3 28      [16]  220    ld    (f_custom), hl          ;; Cargo en el call de abajo la funcion a la que quiero llamar en cada momento determinado
   289F                     221    search_loop:
   289F 32 E2 27      [13]  222       ld (save_a),  a            ;; Guardo el valor de A, porque la llamada a la funcion puede destruirlo
                            223 
                     00E4   224       f_custom = . +1                  ;; . apunta a 'call' y con el '+1' apunta a '(0x0000)' -> (valor arbitrario, puesto que siempre va a cambiar)
   28A2 CD 00 00      [17]  225       call (0x0000)                    ;; LLAMADA A FUNCION PERSONALIZABLE
                            226 
   28A5 11 0B 00      [10]  227       ld    de,   #bullet_size         ;; Cargo en DE el tamanyo de la entidad bullet para despues sumarlo a HL
   28A8 DD 19         [15]  228       add   ix,   de                   ;; IX + DE = Apunta a la siguiente entidad bullet
                            229 
   28AA 3A E2 27      [13]  230       ld     a,   (save_a)             ;; Recupero el valor de a
   28AD 3C            [ 4]  231       inc    a                         ;; A++
   28AE FE 02         [ 7]  232    cp #vector_size
   28B0 20 ED         [12]  233    jr nz, search_loop
   28B2 C9            [10]  234    ret
                            235 
                            236 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
                            ...
                            237 ;; COMPROBAR SI EN LA ENTIDAD BULLET alive > 0
                            238 ;; _______________________
                            239 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            240 ;; DESTRUYE:   A
                            241 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   28B3                     242 bullet_checkDraw::
   28B3 DD 7E 08      [19]  243    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   28B6 FE 00         [ 7]  244    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
                            245    ; ld a, #0xAA                 ;; Se le manda A = AA a dw_draw ya que LAS COORDEADAS DE LAS BALAS ESTAN EN TILES
   28B8 C4 24 2B      [17]  246    call  nz,   #dw_draw          ;; Llama a la funcion de dibujado
   28BB C9            [10]  247    ret
                            248 
                            249 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            250 ;; COMPROBAR SI EN LA ENTIDAD BULLET alive = 0
                            251 ;; _______________________
                            252 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            253 ;; DESTRUYE:   A, HL, DE, BC
                            254 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   28BC                     255 bullet_checkInit:
   28BC 3A E3 27      [13]  256    ld     a,   (flag_init)       ;; Si no se ha iniciado ninguna entidad bullet A==0
   28BF FE 00         [ 7]  257    cp    #0
   28C1 C0            [11]  258    ret   nz                      ;; Si es 1 (1!=0), vuelve y no inicia mas entidades
                            259 
                            260    ;; Comprueba el atributo alive
   28C2 DD 7E 08      [19]  261    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   28C5 FE 00         [ 7]  262    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1 -> INICIALIZO
   28C7 C0            [11]  263    ret   nz                      ;; Si ya esta inicializada, hago ret
   28C8 CD A2 29      [17]  264    call shoot_sfx
                            265    ;; REALIZA UNA COPIA DE LA ENTIDAD POR DEFECTO
   28CB DD E5         [15]  266    push  ix                      ;; Guardo IX en la pila
   28CD D1            [10]  267    pop   de                      ;; Entidad DESTINO
   28CE 21 D7 27      [10]  268    ld    hl,   #bullet_copy      ;; Entidad ORIGEN
   28D1 01 0B 00      [10]  269    ld    bc,   #bullet_size      ;; Tamanyo de la entidad
   28D4 ED B0         [21]  270    ldir
                            271 
                            272 
                            273    ;; DEBO CONSEGUIR UNAS POSICIONES DE TILE DEL HERO
   28D6 CD 5C 27      [17]  274    call hero_get_position           ;; A = hero_x // B = hero_y
                            275 
                            276    ;; Si debo cambiar algo de la entidad, aqui
   28D9 DD 77 00      [19]  277    ld    b_x(ix), a              ;; Asigno X
   28DC DD 70 01      [19]  278    ld    b_y(ix), b              ;; Asigno Y
                            279 
   28DF 3A F5 27      [13]  280    ld    a,    (flag_vx)         ;;
   28E2 DD 77 04      [19]  281    ld    b_vx(ix), a             ;; Asigno VX
   28E5 3A F6 27      [13]  282    ld    a,    (flag_vy)         ;;
   28E8 DD 77 05      [19]  283    ld    b_vy(ix), a             ;; Asigno VX
                            284 
   28EB 3E 01         [ 7]  285    ld     a,   #1                ;; flag_init = 1
   28ED 32 E3 27      [13]  286    ld (flag_init), a             ;; YA NO SE PODRA INICIALIZAR NINGUNA ENTIDAD MAS
                            287                                  ;;   EN EL RECORRIDO DE ESTE BUCLE, AHORA MISMO
   28F0 C9            [10]  288    ret
                            289 
                            290 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            291 ;; LLAMA A CADA FUNCION DE ACTUALIZACION DE CADA ENTIDAD
...
Hexadecimal [16-Bits]
                            ...
                            293 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            294 ;; DESTRUYE:   HL, A
                            295 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   28F1                     296 bullet_searchUpdate::
   28F1 DD 7E 08      [19]  297    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   28F4 FE 00         [ 7]  298    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
   28F6 C8            [11]  299    ret    z                      ;; Si no se ha inicialiado, poco podemos hacer
                            300 
   28F7 DD 7E 01      [19]  301    ld a, b_y(ix)
   28FA DD 86 05      [19]  302    add b_vy(ix)
   28FD 67            [ 4]  303    ld h, a
                            304 
   28FE DD 7E 00      [19]  305    ld a, b_x(ix)
   2901 DD 86 04      [19]  306    add b_vx(ix)
   2904 6F            [ 4]  307    ld l, a
   2905 CD B9 32      [17]  308    call checkTileCollision_m
   2908 20 0A         [12]  309    jr nz, no_tile_collision
   290A 21 34 29      [10]  310       ld hl, #bullet_death
   290D DD 74 0A      [19]  311       ld b_up_h(ix), h
   2910 DD 75 09      [19]  312       ld b_up_l(ix), l
   2913 E9            [ 4]  313       jp (hl)
   2914                     314    no_tile_collision:
                            315 
                            316    ;; Checkear la colision con el enemigo
   2914 CD 3A 29      [17]  317    call bullet_check_death
                            318 
   2917 DD 6E 09      [19]  319    ld l, b_up_l(ix)           ;; Carga el byte bajo en L
   291A DD 66 0A      [19]  320    ld h, b_up_h(ix)           ;; Carga el byte alto en H
   291D E9            [ 4]  321    jp (hl)                    ;; Llama a la funcion de UPDATE propia de cada entidad
                            322 
                            323 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            324 ;; COMPROBAR SI EN LA ENTIDAD BULLET alive > 0 Y LO ACTUALIZO
                            325 ;; _______________________
                            326 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            327 ;; DESTRUYE:   A
                            328 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   291E                     329 bullet_checkUpdate:
                            330    ;; UPDATE ALIVE
   291E DD 35 08      [23]  331    dec   b_alive(ix)            ;; Decrementar el valor de alive y si llega a 1 matar la bala -> alive = 0
                            332 
                            333    ;; UPDATE POSICION
   2921 DD 7E 00      [19]  334    ld     a,   b_x(ix)           ;; Cargo en A la posicion en X
   2924 DD 86 04      [19]  335    add b_vx(ix)                  ;; Le aumento la velocidad en X
   2927 DD 77 00      [19]  336    ld  b_x(ix), a                ;; Guardo el dato actualizado
                            337 
   292A DD 7E 01      [19]  338    ld     a,   b_y(ix)           ;; Cargo en A la posicion en Y
   292D DD 86 05      [19]  339    add b_vy(ix)                  ;; Le aumento la velocidad en Y
   2930 DD 77 01      [19]  340    ld  b_y(ix), a                ;; Guardo el dato actualizado
                            341 
   2933 C9            [10]  342 ret
                            343 
                            344 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            345 ;; MUERTE DE LA BALA
...
Hexadecimal [16-Bits]
                            ...
                            347 ;; ENTRADA:    IX -> Puntero a la entidad BULLET
                            348 ;; DESTRUYE:   A
                            349 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   2934                     350 bullet_death:
   2934 3E 00         [ 7]  351    ld a, #0
   2936 DD 77 08      [19]  352    ld b_alive(ix), a
   2939 C9            [10]  353    ret
                            354 
                            355 ;; COLISION ENEMIGO-BALA
   293A                     356 bullet_check_death::
                            357 
   293A 3A 5F 05      [13]  358     ld a, (NumberOfEnemies)
   293D FE 00         [ 7]  359     cp #0
   293F C8            [11]  360     ret z
                            361   ;;tengo que comparar las variables b_x(ix)/b_y(ix) con la posicion de cada enemigo y ver si coinciden
                            362 
   2940 CD 10 33      [17]  363     call enemy_load
   2943                     364     loop_bullet:
   2943 FD 7E 00      [19]  365     ld a, 0(iy)
   2946 FE FF         [ 7]  366         cp #0xFF
   2948 C8            [11]  367         ret z
                            368 
   2949 FD 7E 1A      [19]  369     ld a, en_alv(iy)
   294C FE 00         [ 7]  370     cp #0
   294E 28 10         [12]  371     jr z, no_colision
                            372 
   2950 CD D9 2E      [17]  373     call checkEntityCollision
   2953 FE 00         [ 7]  374     cp #0
   2955 28 09         [12]  375     jr z, no_colision
                            376 
                            377     ; COLISION
   2957                     378     COLLISION::
   2957 CD C3 29      [17]  379     call enemy_death_sfx
   295A CD 6C 29      [17]  380     call bullet_set_death
                            381 
   295D C3 EB 2D      [10]  382     jp handleEnemyDeath
                            383 
                            384     ;ret
                            385 
   2960                     386     no_colision:
   2960 CD 15 33      [17]  387         call get_enemy_size
   2963 26 00         [ 7]  388         ld h, #0
   2965 6F            [ 4]  389         ld l, a
   2966 EB            [ 4]  390         ex de,hl
   2967 FD 19         [15]  391         add iy,de
   2969 18 D8         [12]  392     jr loop_bullet
   296B C9            [10]  393 ret
                            394 
                            395 
   296C                     396 bullet_set_death:
   296C 21 34 29      [10]  397    ld hl, #bullet_death
   296F DD 74 0A      [19]  398    ld b_up_h(ix), h
   2972 DD 75 09      [19]  399    ld b_up_l(ix), l
   2975 C9            [10]  400    ret
                            401 
...
Hexadecimal [16-Bits]
                            ...
                            402 
   2976                     403 spawnEnemies::
   2976 21 60 05      [10]  404     ld hl, #SpawnPoints
   2979 3A 06 2A      [13]  405     ld a, (SpawnOffset)
   297C 16 00         [ 7]  406     ld d, #0
   297E 5F            [ 4]  407     ld e, a
   297F 19            [11]  408     add hl, de
                            409 
   2980 3C            [ 4]  410     inc a
   2981 3C            [ 4]  411     inc a
   2982 FE 0A         [ 7]  412     cp #10
   2984 20 02         [12]  413     jr nz, no_last_coord
   2986 3E 00         [ 7]  414         ld a, #0
   2988                     415     no_last_coord:
   2988 32 06 2A      [13]  416     ld (SpawnOffset), a
                            417 
   298B 46            [ 7]  418     ld b, (hl)
   298C 23            [ 6]  419     inc hl
   298D 4E            [ 7]  420     ld c, (hl)
                            421 
   298E C5            [11]  422     push bc
   298F CD 77 2B      [17]  423     call checkViewport
   2992 C1            [10]  424     pop bc
   2993 FE 00         [ 7]  425     cp #0
                            426 
   2995 20 DF         [12]  427     jr nz, spawnEnemies
                            428 
   2997 FD 36 1A 01   [19]  429     ld en_alv(iy), #1
   299B FD 70 00      [19]  430     ld e_x(iy),b
   299E FD 71 01      [19]  431     ld e_y(iy),c
   29A1 C9            [10]  432 ret
                            433 
                            434 ;SONIDO DESPAROS
   29A2                     435 shoot_sfx::
                            436  ;SALVO TODOS LOS REGISTROS PARA NO SOBREESRIBIR NADA
                            437 
   29A2 DD E5         [15]  438   push ix
   29A4 F5            [11]  439   push af
   29A5 C5            [11]  440   push bc
   29A6 D5            [11]  441   push de
   29A7 E5            [11]  442   push hl
   29A8 FD E5         [15]  443   push iy
   29AA 2E 02         [ 7]  444   ld l, #2  ;INSRUMENTO
   29AC 26 0F         [ 7]  445   ld h, #15  ;VOLUMEN
   29AE 1E 30         [ 7]  446   ld e, #48  ;NOTA
   29B0 16 00         [ 7]  447   ld d, #0   ;VELOCIDAD
   29B2 01 00 00      [10]  448   ld bc, #0  ;PITCH
   29B5 3E 02         [ 7]  449   ld a, #2   ;CANAL
   29B7 CD BC 3C      [17]  450   call cpct_akp_SFXPlay_asm
                            451 
   29BA FD E1         [14]  452   pop iy
   29BC E1            [10]  453   pop hl
   29BD D1            [10]  454   pop de
   29BE C1            [10]  455   pop bc
   29BF F1            [10]  456   pop af
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 62.
Hexadecimal [16-Bits]



   29C0 DD E1         [14]  457   pop ix
                            458 
   29C2 C9            [10]  459   ret
                            460 
                            461   ;SONIDO MUERTE ENEMIGOS
   29C3                     462   enemy_death_sfx::
                            463    ;SALVO TODOS LOS REGISTROS PARA NO SOBREESRIBIR NADA
                            464 
   29C3 DD E5         [15]  465    push ix
   29C5 F5            [11]  466    push af
   29C6 C5            [11]  467    push bc
   29C7 D5            [11]  468    push de
   29C8 E5            [11]  469    push hl
   29C9 FD E5         [15]  470    push iy
                            471 
                            472 
   29CB 2E 01         [ 7]  473    ld l, #1 ;INSRUMENTO
   29CD 26 0F         [ 7]  474    ld h, #15  ;VOLUMEN
   29CF 1E 0A         [ 7]  475    ld e, #10  ;NOTA
   29D1 16 02         [ 7]  476    ld d, #2   ;VELOCIDAD
   29D3 01 00 00      [10]  477    ld bc, #0  ;PITCH
   29D6 3E 04         [ 7]  478    ld a, #4   ;CANAL
   29D8 CD BC 3C      [17]  479    call cpct_akp_SFXPlay_asm
                            480 
   29DB FD E1         [14]  481    pop iy
   29DD E1            [10]  482    pop hl
   29DE D1            [10]  483    pop de
   29DF C1            [10]  484    pop bc
   29E0 F1            [10]  485    pop af
   29E1 DD E1         [14]  486    pop ix
                            487 
                            488 
                            489 
   29E3 C9            [10]  490     ret
                            491 
   29E4                     492     hero_death_sfx::
                            493      ;SALVO TODOS LOS REGISTROS PARA NO SOBREESRIBIR NADA
                            494 
   29E4 DD E5         [15]  495      push ix
   29E6 F5            [11]  496      push af
   29E7 C5            [11]  497      push bc
   29E8 D5            [11]  498      push de
   29E9 E5            [11]  499      push hl
   29EA FD E5         [15]  500      push iy
                            501 
                            502 
   29EC 2E 02         [ 7]  503      ld l, #2 ;INSRUMENTO
   29EE 26 0F         [ 7]  504      ld h, #15  ;VOLUMEN
   29F0 1E 28         [ 7]  505      ld e, #40  ;NOTA
   29F2 16 02         [ 7]  506      ld d, #2   ;VELOCIDAD
   29F4 01 00 00      [10]  507      ld bc, #0  ;PITCH
   29F7 3E 01         [ 7]  508      ld a, #1   ;CANAL
   29F9 CD BC 3C      [17]  509      call cpct_akp_SFXPlay_asm
                            510 
   29FC FD E1         [14]  511      pop iy
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 63.
Hexadecimal [16-Bits]



   29FE E1            [10]  512      pop hl
   29FF D1            [10]  513      pop de
   2A00 C1            [10]  514      pop bc
   2A01 F1            [10]  515      pop af
   2A02 DD E1         [14]  516      pop ix
                            517 
                            518 
                            519 
   2A04 C9            [10]  520 ret
