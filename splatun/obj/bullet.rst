...
Hexadecimal [16-Bits]
                     ...
                     000A    22 bullet_size = 10                    ;; Debe de ser parametrizado, CUANTO ANTES!
                             23 
   97E5 00 00                24 vector_index:  .dw #0x0000
   97E7                      25 vector_init:                        ;; Marca el inicio de vector_bullets
   97E7                      26 DefineNBullets vector_bullets, vector_size
                     0000     1    _c = 0
                              2    .rept vector_size
                              3       DefineBulletDefault vector_bullets, \_c
                              4       _c = _c + 1
                              5    .endm
   97E7                       1       DefineBulletDefault vector_bullets, \_c
   ...
   97E7 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   97E9 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   97EB                       3    DefineMovableEnt  vector_bullets0_mv, 0, 0                             ;;'
   0006                       1 vector_bullets0_mv:
   97EB 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   97ED 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   97EE 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   97EF FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0001     2       _c = _c + 1
   97F1                       1       DefineBulletDefault vector_bullets, \_c
   97F1                       1    DefineBullet vector_bullets1, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   000C                       1 vector_bullets1:
   000C                       2    DefineDrawableEnt vector_bullets1_dw, 0xAA, 0, 0, 0                       ;;'
   000C                       1 vector_bullets1_dw:
   97F1 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   97F3 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   97F5                       3    DefineMovableEnt  vector_bullets1_mv, 0, 0                             ;;'
   0010                       1 vector_bullets1_mv:
   97F5 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   97F7 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   97F8 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   97F9 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0002     2       _c = _c + 1
   97FB                       1       DefineBulletDefault vector_bullets, \_c
   97FB                       1    DefineBullet vector_bullets2, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   0016                       1 vector_bullets2:
   0016                       2    DefineDrawableEnt vector_bullets2_dw, 0xAA, 0, 0, 0                       ;;'
   0016                       1 vector_bullets2_dw:
   97FB AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 54.
Hexadecimal [16-Bits]



   97FD 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   97FF                       3    DefineMovableEnt  vector_bullets2_mv, 0, 0                             ;;'
   001A                       1 vector_bullets2_mv:
   97FF 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   9801 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   9802 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   9803 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0003     2       _c = _c + 1
   9805                       1       DefineBulletDefault vector_bullets, \_c
   9805                       1    DefineBullet vector_bullets3, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   0020                       1 vector_bullets3:
   0020                       2    DefineDrawableEnt vector_bullets3_dw, 0xAA, 0, 0, 0                       ;;'
   0020                       1 vector_bullets3_dw:
   9805 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   9807 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   9809                       3    DefineMovableEnt  vector_bullets3_mv, 0, 0                             ;;'
   0024                       1 vector_bullets3_mv:
   9809 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   980B 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   980C 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   980D FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0004     2       _c = _c + 1
   980F                       1       DefineBulletDefault vector_bullets, \_c
   980F                       1    DefineBullet vector_bullets4, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   002A                       1 vector_bullets4:
   002A                       2    DefineDrawableEnt vector_bullets4_dw, 0xAA, 0, 0, 0                       ;;'
   002A                       1 vector_bullets4_dw:
   980F AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   9811 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   9813                       3    DefineMovableEnt  vector_bullets4_mv, 0, 0                             ;;'
   002E                       1 vector_bullets4_mv:
   9813 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   9815 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   9816 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   9817 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0005     2       _c = _c + 1
   9819                      27 DefineBullet bullet_copy 0xFF, 0xFF, #1, #4, 0, 4, #0x0F, #20, bullet_checkUpdate
   9819                       1 bullet_copy:
   0034                       2    DefineDrawableEnt bullet_copy_dw, 0xFF, 0xFF, #1, #4                       ;;'
   0034                       1 bullet_copy_dw:
   9819 FF FF                 2    .db   0xFF, 0xFF      ;; Posicion    (x,y)
   981B 01 04                 3    .db   #1, #4      ;; Dimensiones (w,h)
   981D                       3    DefineMovableEnt  bullet_copy_mv, 0, 4                             ;;'
   0038                       1 bullet_copy_mv:
   981D 00 04                 2    .db   0, 4    ;; Variables de la velocidad
   981F 0F                    4    .db   #0x0F        ;; Color / Sprite (cuando haya)
   9820 14                    5    .db   #20      ;; _alive>0? Se actualiza/dibuja
   9821 30 99                 6    .dw   bullet_checkUpdate        ;; Funcion de update
                              7 
...
Hexadecimal [16-Bits]
                              ...
                              8 ;; Saber tamanyo de entidad bala
                             28 
   9823 00                   29 save_a:        .db #0x00            ;; Guarda el valor de A
   9824 00                   30 flag_init:     .db #0x00            ;; if(flag_init==1) Hay una entidad bullet que se ha inicializado
                             31 
   9825                      32 vector_keys:
   9825 00 01 88 98          33    .dw #Key_CursorUp,      #keyUp_ON      ;; Flecha de arriba
   9829 00 04 8E 98          34    .dw #Key_CursorDown,    #keyDown_ON    ;; Flecha de abajo
   982D 00 02 94 98          35    .dw #Key_CursorRight,   #keyRight_ON   ;; Flecha de derecha
   9831 01 01 9A 98          36    .dw #Key_CursorLeft,    #keyLeft_ON    ;; Flecha de izquierda
   9835 FF                   37    .db #0xFF                              ;; Fin
   9836 00                   38 flag_vx:       .db #0
   9837 00                   39 flag_vy:       .db #0
   9838 00                   40 flag_shoot:    .db #0                     ;; Solo habra un disparo por cada vez que se pulse cada tecla
   9839 00                   41 flag_key:      .db #0                     ;; Si ha pulsado alguna de las 4 teclas de disparo, flag_key = 1
                             42 
                             43 ;;======================================================================
                             44 ;;======================================================================
                             ...
                             53 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   983A                      54 bullet_draw::
   983A 21 E8 98      [10]   55    ld    hl,   #bullet_checkDraw
   983D C3 CB 98      [10]   56    jp    bullet_search                 ;; Llamada al bucle
                             57 
                             58 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             ...
                             61 ;; DESTRUYE: HL
                             62 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9840                      63 bullet_update::
   9840 21 23 99      [10]   64    ld    hl,   #bullet_searchUpdate
   9843 C3 CB 98      [10]   65    jp    bullet_search                 ;; Llamada al bucle
                             66 
                             67 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             68 ;; CLEAR
                             ...
                             70 ;; DESTRUYE: HL
                             71 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9846                      72 bullet_clear::
   9846 21 46 99      [10]   73    ld    hl,   #bullet_checkClear
   9849 C3 CB 98      [10]   74    jp    bullet_search
                             75 
                             76 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             ...
                             80 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   984C                      81 bullet_inputs::
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 56.
Hexadecimal [16-Bits]



   984C CD 64 9F      [17]   82    call cpct_scanKeyboard_asm
                             83 
   ...
   984F DD 21 25 98   [14]  106    ld    ix,   #vector_keys         ;; IX apunta al vector de codigos de teclado
   9853                     107    loop:
   9853 DD 7E 00      [19]  108       ld     a,   0(ix)             ;; A = 0(ix)
   9856 FE FF         [ 7]  109       cp  #0xFF                     ;; El final del vector lo marca un FF
   9858 28 23         [12]  110       jr     z,   end_loop          ;; Sale del bucle en caso que A == FF
                            111 
   985A DD 6E 00      [19]  112       ld     l,   0(ix)             ;; Cargo el codigo de la tecla en HL
   985D DD 66 01      [19]  113       ld     h,   1(ix)             ;; Cargo el codigo de la tecla en HL
   9860 CD D6 9C      [17]  114       call cpct_isKeyPressed_asm    ;; CPC
   9863 DD 6E 02      [19]  115       ld     l,   2(ix)             ;; Cargo el codigo de la funcion en HL
   9866 DD 66 03      [19]  116       ld     h,   3(ix)             ;; Cargo el codigo de la funcion en HL
   9869 22 6D 98      [16]  117       ld (k_custom), hl
                     0088   118          k_custom = . + 1
   986C C4 00 00      [17]  119          call nz, (0x0000)          ;; CUSTOM
   986F 28 05         [12]  120          jr z, keep_looping         ;; Si no se ha pulsado ninguna tecla, pasa
   9871 3E 01         [ 7]  121             ld a, #1
   9873 32 39 98      [13]  122             ld (flag_key), a        ;; flag_key = ON
   9876                     123       keep_looping:
   9876 11 04 00      [10]  124       ld    de,   #4                ;; Sumo 4 para ir a la siguiente tecla
   9879 DD 19         [15]  125       add   ix,   de                ;; IX + 4
   987B 18 D6         [12]  126       jr    loop
   987D                     127    end_loop:
                            128 ;
...
Hexadecimal [16-Bits]
                            ...
                            159 ;   end_loop:
                            160 
   987D 3A 39 98      [13]  161    ld a, (flag_key)                 ;; A = flag_key
   9880 FE 00         [ 7]  162    cp #0                            ;; Si A == 1: SE HA PULSADO ALGUNA DE LAS 4 TECLAS DE DISPARO
   9882 C2 AC 98      [10]  163    jp nz, bullet_init               ;; Si A == 0: NO SE HA PULSADO NINGUNA TECLA DE DISPARO
                            164 
   9885 C3 A6 98      [10]  165    jp flag_shoot_off                ;; Volver flag_shoot a 0
                            166 
                            167 ;;======================================================================
                            168 ;;======================================================================
                            ...
                            176 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9888                     177 keyUp_ON:
   9888 3E FF         [ 7]  178    ld a, #-1
   988A 32 37 98      [13]  179    ld (flag_vy), a
   988D C9            [10]  180    ret
                            181 
                            182 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            186 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   988E                     187 keyDown_ON:
   988E 3E 01         [ 7]  188    ld a, #1
   9890 32 37 98      [13]  189    ld (flag_vy), a
   9893 C9            [10]  190    ret
                            191 
...
Hexadecimal [16-Bits]
                            ...
                            195 ;; DESTRUYE: A
                            196 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9894                     197 keyRight_ON:
   9894 3E 01         [ 7]  198    ld a, #1
   9896 32 36 98      [13]  199    ld (flag_vx), a
   9899 C9            [10]  200    ret
                            201 
                            202 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            206 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   989A                     207 keyLeft_ON:
   989A 3E FF         [ 7]  208    ld a, #-1
   989C 32 36 98      [13]  209    ld (flag_vx), a
   989F C9            [10]  210    ret
                            211 
                            212 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            215 ;; DESTRUYE: A
                            216 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   98A0                     217 flag_shoot_on:
   98A0 3E 01         [ 7]  218    ld a, #1
   98A2 32 38 98      [13]  219    ld (flag_shoot), a
   98A5 C9            [10]  220    ret
                            221 
                            222 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            225 ;; DESTRUYE: A
                            226 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   98A6                     227 flag_shoot_off:
   98A6 3E 00         [ 7]  228    ld a, #0
   98A8 32 38 98      [13]  229    ld (flag_shoot), a
   98AB C9            [10]  230    ret
                            231 
                            232 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            235 ;; DESTRUYE: HL, A
                            236 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   98AC                     237 bullet_init:
                            238    ;; Comprueba que solo se pueda disparar una vez por cada pulsacion de tecla
   98AC 3A 38 98      [13]  239    ld a, (flag_shoot)               ;; A = flag_shoot
   98AF FE 00         [ 7]  240    cp #0                            ;; A - 0 = A
   98B1 20 09         [12]  241    jr nz, bullet_init_end           ;; Si flag_shoot == 1, vuelve
                            242 
   98B3 21 F1 98      [10]  243    ld    hl,   #bullet_checkInit
   98B6 CD CB 98      [17]  244    call  bullet_search              ;; Llamada al bucle
   98B9 CD A0 98      [17]  245    call  flag_shoot_on              ;; Si llega aqui, es que se ha pulsado alguna tecla, entonces flag = ON
                            246 
...
Hexadecimal [16-Bits]
   ...
   98BC                     247    bullet_init_end:
                            248    ;; Reset de los flags
   98BC 3E 00         [ 7]  249    ld     a,   #0
   98BE 32 24 98      [13]  250       ld (flag_init), a
   98C1 32 36 98      [13]  251       ld   (flag_vx), a
   98C4 32 37 98      [13]  252       ld   (flag_vy), a
   98C7 32 39 98      [13]  253       ld  (flag_key), a
   98CA C9            [10]  254    ret
                            255 
                            256 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            261 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   98CB                     262 bullet_search:
   98CB 3E 00         [ 7]  263    ld     a,   #0                ;; Cargo en A el valor inicial 0
   98CD DD 21 E7 97   [14]  264    ld    ix,   #vector_init      ;; IX apunta al inicio de vector_bullets (a la primera entidad)
   98D1 22 D8 98      [16]  265    ld    (f_custom), hl          ;; Cargo en el call de abajo la funcion a la que quiero llamar en cada momento determinado
   98D4                     266    search_loop:
   98D4 32 23 98      [13]  267       ld (save_a),  a            ;; Guardo el valor de A, porque la llamada a la funcion puede destruirlo
                            268 
                     00F3   269       f_custom = . +1                  ;; . apunta a 'call' y con el '+1' apunta a '(0x0000)' -> (valor arbitrario, puesto que siempre va a cambiar)
   98D7 CD 00 00      [17]  270       call (0x0000)                    ;; LLAMADA A FUNCION PERSONALIZABLE
                            271 
   98DA 11 0A 00      [10]  272       ld    de,   #bullet_size         ;; Cargo en DE el tamanyo de la entidad bullet para despues sumarlo a HL
   98DD DD 19         [15]  273       add   ix,   de                   ;; IX + DE = Apunta a la siguiente entidad bullet
                            274 
   98DF 3A 23 98      [13]  275       ld     a,   (save_a)             ;; Recupero el valor de a
   98E2 3C            [ 4]  276       inc    a                         ;; A++
   98E3 FE 05         [ 7]  277    cp #vector_size
   98E5 20 ED         [12]  278    jr nz, search_loop
   98E7 C9            [10]  279    ret
                            280 
                            281 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            285 ;; DESTRUYE:   A
                            286 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   98E8                     287 bullet_checkDraw:
   98E8 DD 7E 07      [19]  288    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   98EB FE 00         [ 7]  289    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
   98ED C4 75 99      [17]  290    call  nz,   #dw_draw          ;; Llama a la funcion de dibujado
   98F0 C9            [10]  291    ret
                            292 
                            293 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            298 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   98F1                     299 bullet_checkInit:
   98F1 3A 24 98      [13]  300    ld     a,   (flag_init)       ;; Si no se ha iniciado ninguna entidad bullet A==0
   98F4 FE 00         [ 7]  301    cp    #0
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 60.
Hexadecimal [16-Bits]



   98F6 C0            [11]  302    ret   nz                      ;; Si es 1 (1!=0), vuelve y no inicia mas entidades
                            303 
                            304    ;; Comprueba el atributo alive
   98F7 DD 7E 07      [19]  305    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   98FA FE 00         [ 7]  306    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1 -> INICIALIZO
   98FC C0            [11]  307    ret   nz                      ;; Si ya esta inicializada, hago ret
                            308 
                            309    ;; REALIZA UNA COPIA DE LA ENTIDAD POR DEFECTO
   98FD DD E5         [15]  310    push  ix                      ;; Guardo IX en la pila
   98FF D1            [10]  311    pop   de                      ;; Entidad DESTINO
   9900 21 19 98      [10]  312    ld    hl,   #bullet_copy      ;; Entidad ORIGEN
   9903 01 0A 00      [10]  313    ld    bc,   #bullet_size      ;; Tamanyo de la entidad
   9906 ED B0         [21]  314    ldir
                            315 
                            316    ;; Si debo cambiar algo de la entidad, aqui
   9908 CD DD 97      [17]  317    call hero_get_position        ;; A = hero_x // B = hero_y
   990B DD 77 00      [19]  318    ld    b_x(ix), a              ;; Asigno X
   990E DD 70 01      [19]  319    ld    b_y(ix), b              ;; Asigno Y
                            320 
   9911 3A 36 98      [13]  321    ld    a,    (flag_vx)         ;;
   9914 DD 77 04      [19]  322    ld    b_vx(ix), a             ;; Asigno VX
   9917 3A 37 98      [13]  323    ld    a,    (flag_vy)         ;;
   991A DD 77 05      [19]  324    ld    b_vy(ix), a             ;; Asigno VX
                            325 
   991D 3E 01         [ 7]  326    ld     a,   #1                ;; flag_init = 1
   991F 32 24 98      [13]  327    ld (flag_init), a             ;; YA NO SE PODRA INICIALIZAR NINGUNA ENTIDAD MAS
   ...
   9922 C9            [10]  329    ret
                            ...
                            335 ;; DESTRUYE:   HL, A
                            336 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9923                     337 bullet_searchUpdate:
   9923 DD 7E 07      [19]  338    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   9926 FE 00         [ 7]  339    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
   9928 C8            [11]  340    ret    z                      ;; Si no se ha inicialiado, poco podemos hacer
                            341 
   9929 DD 6E 08      [19]  342    ld l, b_up_l(ix)           ;; Carga el byte bajo en L
   992C DD 66 09      [19]  343    ld h, b_up_h(ix)           ;; Carga el byte alto en H
   992F E9            [ 4]  344    jp (hl)                    ;; Llama a la funcion propia de cada entidad
                            345 
                            346 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            350 ;; DESTRUYE:   A
                            351 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9930                     352 bullet_checkUpdate:
                            353    ;; UPDATE ALIVE
   9930 DD 35 07      [23]  354    dec   b_alive(ix)     ;; Decrementar el valor de alive y si llega a 1 matar la bala -> alive = 0
                            355 
                            356    ;; UPDATE POSICION
...
Hexadecimal [16-Bits]
   ...
   9933 DD 7E 00      [19]  357    ld     a,   b_x(ix)           ;; Cargo en A la posicion en X
   9936 DD 86 04      [19]  358    add b_vx(ix)                  ;; Le aumento la velocidad en X
   9939 DD 77 00      [19]  359    ld  b_x(ix), a                ;; Guardo el dato actualizado
                            360 
   993C DD 7E 01      [19]  361    ld     a,   b_y(ix)           ;; Cargo en A la posicion en Y
   993F DD 86 05      [19]  362    add b_vy(ix)                  ;; Le aumento la velocidad en Y
   9942 DD 77 01      [19]  363    ld  b_y(ix), a                ;; Guardo el dato actualizado
                            364 
   9945 C9            [10]  365    ret
                            366 
                            367 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            371 ;; DESTRUYE:
                            372 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   9946                     373 bullet_checkClear:
   9946 DD 7E 07      [19]  374     ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   9949 FE 00         [ 7]  375     cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
   994B C4 AA 99      [17]  376     call nz, dw_clear
   994E C9            [10]  377 ret
                            378 
                            379 
                            380 
