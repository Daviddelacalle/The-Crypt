...
Hexadecimal [16-Bits]
                             ...
                             15 
                             16 .globl cpct_etm_setDrawTilemap4x8_ag_asm
                             17 .globl cpct_etm_drawTilemap4x8_ag_asm
...
Hexadecimal [16-Bits]
                             ...
                             22 ;;======================================================================
                             23 ;;======================================================================
                     0005    24 vector_size = 5
                     000A    25 bullet_size = 10                    ;; Debe de ser parametrizado, CUANTO ANTES!
                             26 
   4454 00 00                27 vector_index:  .dw #0x0000
   4456                      28 vector_init:                        ;; Marca el inicio de vector_bullets
   4456                      29 DefineNBullets vector_bullets, vector_size
                     0000     1    _c = 0
                              2    .rept vector_size
                              3       DefineBulletDefault vector_bullets, \_c
                              4       _c = _c + 1
                              5    .endm
   4456                       1       DefineBulletDefault vector_bullets, \_c
   ...
   4456 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   4458 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   445A                       3    DefineMovableEnt  vector_bullets0_mv, 0, 0                             ;;'
   0006                       1 vector_bullets0_mv:
   445A 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   445C 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   445D 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   445E FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0001     2       _c = _c + 1
   4460                       1       DefineBulletDefault vector_bullets, \_c
   4460                       1    DefineBullet vector_bullets1, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   000C                       1 vector_bullets1:
   000C                       2    DefineDrawableEnt vector_bullets1_dw, 0xAA, 0, 0, 0                       ;;'
   000C                       1 vector_bullets1_dw:
   4460 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   4462 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   4464                       3    DefineMovableEnt  vector_bullets1_mv, 0, 0                             ;;'
   0010                       1 vector_bullets1_mv:
   4464 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   4466 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   4467 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   4468 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0002     2       _c = _c + 1
   446A                       1       DefineBulletDefault vector_bullets, \_c
   446A                       1    DefineBullet vector_bullets2, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   0016                       1 vector_bullets2:
   0016                       2    DefineDrawableEnt vector_bullets2_dw, 0xAA, 0, 0, 0                       ;;'
   0016                       1 vector_bullets2_dw:
   446A AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 57.
Hexadecimal [16-Bits]



   446C 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   446E                       3    DefineMovableEnt  vector_bullets2_mv, 0, 0                             ;;'
   001A                       1 vector_bullets2_mv:
   446E 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   4470 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   4471 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   4472 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0003     2       _c = _c + 1
   4474                       1       DefineBulletDefault vector_bullets, \_c
   4474                       1    DefineBullet vector_bullets3, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   0020                       1 vector_bullets3:
   0020                       2    DefineDrawableEnt vector_bullets3_dw, 0xAA, 0, 0, 0                       ;;'
   0020                       1 vector_bullets3_dw:
   4474 AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   4476 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   4478                       3    DefineMovableEnt  vector_bullets3_mv, 0, 0                             ;;'
   0024                       1 vector_bullets3_mv:
   4478 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   447A 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   447B 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   447C FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0004     2       _c = _c + 1
   447E                       1       DefineBulletDefault vector_bullets, \_c
   447E                       1    DefineBullet vector_bullets4, 0xAA, 0, 0, 0, 0, 0, 0, 0, 0xFFFF        ;;'
   002A                       1 vector_bullets4:
   002A                       2    DefineDrawableEnt vector_bullets4_dw, 0xAA, 0, 0, 0                       ;;'
   002A                       1 vector_bullets4_dw:
   447E AA 00                 2    .db   0xAA, 0      ;; Posicion    (x,y)
   4480 00 00                 3    .db   0, 0      ;; Dimensiones (w,h)
   4482                       3    DefineMovableEnt  vector_bullets4_mv, 0, 0                             ;;'
   002E                       1 vector_bullets4_mv:
   4482 00 00                 2    .db   0, 0    ;; Variables de la velocidad
   4484 00                    4    .db   0        ;; Color / Sprite (cuando haya)
   4485 00                    5    .db   0      ;; _alive>0? Se actualiza/dibuja
   4486 FF FF                 6    .dw   0xFFFF        ;; Funcion de update
                              7 
                              8 ;; Saber tamanyo de entidad bala
                     0005     2       _c = _c + 1
   4488 FF                   30 vector_end:    .db #0xFF
   4489                      31 DefineBullet bullet_copy 0xFF, 0xFF, #1, #4, 0, 4, #0x0F, #20, bullet_checkUpdate
   4489                       1 bullet_copy:
   0035                       2    DefineDrawableEnt bullet_copy_dw, 0xFF, 0xFF, #1, #4                       ;;'
   0035                       1 bullet_copy_dw:
   4489 FF FF                 2    .db   0xFF, 0xFF      ;; Posicion    (x,y)
   448B 01 04                 3    .db   #1, #4      ;; Dimensiones (w,h)
   448D                       3    DefineMovableEnt  bullet_copy_mv, 0, 4                             ;;'
   0039                       1 bullet_copy_mv:
   448D 00 04                 2    .db   0, 4    ;; Variables de la velocidad
   448F 0F                    4    .db   #0x0F        ;; Color / Sprite (cuando haya)
   4490 14                    5    .db   #20      ;; _alive>0? Se actualiza/dibuja
   4491 99 45                 6    .dw   bullet_checkUpdate        ;; Funcion de update
...
Hexadecimal [16-Bits]
                              ...
                              8 ;; Saber tamanyo de entidad bala
                             32 
   4493 00                   33 flag_init:     .db #0x00            ;; if(flag_init==1) Hay una entidad bullet que se ha inicializado
                             34 
   4494                      35 vector_keys:
   4494 00 01 F7 44          36    .dw #Key_CursorUp,      #keyUp_ON      ;; Flecha de arriba
   4498 00 04 FD 44          37    .dw #Key_CursorDown,    #keyDown_ON    ;; Flecha de abajo
   449C 00 02 03 45          38    .dw #Key_CursorRight,   #keyRight_ON   ;; Flecha de derecha
   44A0 01 01 09 45          39    .dw #Key_CursorLeft,    #keyLeft_ON    ;; Flecha de izquierda
   44A4 FF                   40    .db #0xFF                              ;; Fin
   44A5 00                   41 flag_vx:       .db #0
   44A6 00                   42 flag_vy:       .db #0
   44A7 00                   43 flag_shoot:    .db #0                     ;; Solo habra un disparo por cada vez que se pulse cada tecla
   44A8 00                   44 flag_key:      .db #0                     ;; Si ha pulsado alguna de las 4 teclas de disparo, flag_key = 1
                             45 
                             46 ;;======================================================================
                             47 ;;======================================================================
                             ...
                             56 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   44A9                      57 bullet_draw::
   44A9 21 51 45      [10]   58    ld    hl,   #bullet_checkDraw
   44AC C3 3A 45      [10]   59    jp    bullet_search                 ;; Llamada al bucle
                             60 
                             61 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             ...
                             64 ;; DESTRUYE: HL
                             65 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   44AF                      66 bullet_update::
   44AF 21 8C 45      [10]   67    ld    hl,   #bullet_searchUpdate
   44B2 C3 3A 45      [10]   68    jp    bullet_search                 ;; Llamada al bucle
                             69 
                             70 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             71 ;; CLEAR
                             ...
                             73 ;; DESTRUYE: HL
                             74 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   44B5                      75 bullet_clear::
   44B5 21 AF 45      [10]   76    ld    hl,   #bullet_checkClear
   44B8 C3 3A 45      [10]   77    jp    bullet_search
                             78 
                             79 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
   ...
   44BE DD 21 94 44   [14]  109    ld    ix,   #vector_keys         ;; IX apunta al vector de codigos de teclado
   44C2                     110    loop:
   44C2 DD 7E 00      [19]  111       ld     a,   0(ix)             ;; A = 0(ix)
   44C5 FE FF         [ 7]  112       cp  #0xFF                     ;; El final del vector lo marca un FF
   44C7 28 23         [12]  113       jr     z,   end_loop          ;; Sale del bucle en caso que A == FF
                            114 
   44C9 DD 6E 00      [19]  115       ld     l,   0(ix)             ;; Cargo el codigo de la tecla en HL
   44CC DD 66 01      [19]  116       ld     h,   1(ix)             ;; Cargo el codigo de la tecla en HL
   44CF CD 62 47      [17]  117       call cpct_isKeyPressed_asm    ;; CPC
   44D2 DD 6E 02      [19]  118       ld     l,   2(ix)             ;; Cargo el codigo de la funcion en HL
   44D5 DD 66 03      [19]  119       ld     h,   3(ix)             ;; Cargo el codigo de la funcion en HL
   44D8 22 DC 44      [16]  120       ld (k_custom), hl
                     0088   121          k_custom = . + 1
   44DB C4 00 00      [17]  122          call nz, (0x0000)          ;; CUSTOM
   44DE 28 05         [12]  123          jr z, keep_looping         ;; Si no se ha pulsado ninguna tecla, pasa
   44E0 3E 01         [ 7]  124             ld a, #1
   44E2 32 A8 44      [13]  125             ld (flag_key), a        ;; flag_key = ON
   44E5                     126       keep_looping:
   44E5 11 04 00      [10]  127       ld    de,   #4                ;; Sumo 4 para ir a la siguiente tecla
   44E8 DD 19         [15]  128       add   ix,   de                ;; IX + 4
   44EA 18 D6         [12]  129       jr    loop
   44EC                     130    end_loop:
                            131 ;
                            132 ;   ld    ix,   #vector_keys         ;; IX apunta al vector de codigos de teclado
                            133 ;
                            134 ;
                            135 ;   ld de, #vector_keys
                            136 ;   ex de, hl
                            137 ;   ld hl, (de)
                            138 ;   loop:
                            139 ;      call cpct_isKeyPressed_asm    ;; CPC
...
Hexadecimal [16-Bits]
                            ...
                            143 ;      ld (k_custom), hl
                            144 ;         k_custom = . + 1
                            145 ;         call nz, (0x0000)          ;; CUSTOM
                            146 ;         jr z, keep_looping         ;; Si no se ha pulsado ninguna tecla, pasa
                            147 ;            ld a, #1
                            148 ;            ld (flag_key), a        ;; flag_key = ON
                            149 ;      keep_looping:
                            150 ;      inc hl
                            151 ;      inc hl
                            152 ;      ex de, hl
                            ...
                            154 ;
                            155 ;      ld     a,     l            ;; A = 0(ix)
                            156 ;      cp  #0xFF                     ;; El final del vector lo marca un FF
                            157 ;      jr     z,   end_loop          ;; Sale del bucle en caso que A == FF
                            158 ;
                            159 ;  jr    loop
                            160 ;
                            161 ;
                            162 ;   end_loop:
                            163 
   44EC 3A A8 44      [13]  164    ld a, (flag_key)                 ;; A = flag_key
   44EF FE 00         [ 7]  165    cp #0                            ;; Si A == 1: SE HA PULSADO ALGUNA DE LAS 4 TECLAS DE DISPARO
   44F1 C2 1B 45      [10]  166    jp nz, bullet_init               ;; Si A == 0: NO SE HA PULSADO NINGUNA TECLA DE DISPARO
                            167 
   44F4 C3 15 45      [10]  168    jp flag_shoot_off                ;; Volver flag_shoot a 0
                            169 
                            170 ;;======================================================================
                            171 ;;======================================================================
                            172 ;; FUNCIONES PRIVADAS
                            173 ;;======================================================================
                            174 ;;======================================================================
                            175 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            176 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN Y
                            177 ;; _______________________
                            178 ;; DESTRUYE: A
                            179 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   44F7                     180 keyUp_ON:
   44F7 3E FF         [ 7]  181    ld a, #-1
   44F9 32 A6 44      [13]  182    ld (flag_vy), a
   44FC C9            [10]  183    ret
                            184 
                            185 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            186 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN Y
                            187 ;; _______________________
                            188 ;; DESTRUYE: A
                            189 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   44FD                     190 keyDown_ON:
   44FD 3E 01         [ 7]  191    ld a, #1
   44FF 32 A6 44      [13]  192    ld (flag_vy), a
   4502 C9            [10]  193    ret
                            194 
...
Hexadecimal [16-Bits]
                            ...
                            195 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            196 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN X
                            197 ;; _______________________
                            198 ;; DESTRUYE: A
                            199 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4503                     200 keyRight_ON:
   4503 3E 01         [ 7]  201    ld a, #1
   4505 32 A5 44      [13]  202    ld (flag_vx), a
   4508 C9            [10]  203    ret
                            204 
                            205 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            206 ;; CAMBIA LOS FLAGS DE LA VELOCIDAD EN X
                            207 ;; _______________________
                            208 ;; DESTRUYE: A
                            209 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4509                     210 keyLeft_ON:
   4509 3E FF         [ 7]  211    ld a, #-1
   450B 32 A5 44      [13]  212    ld (flag_vx), a
   450E C9            [10]  213    ret
                            214 
                            215 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            216 ;; CAMBIA flag_shoot A 1 E IMPIDE DISPARAR MAS, A MENOS QUE SUELTES LA TECLA
                            217 ;; _______________________
                            218 ;; DESTRUYE: A
                            219 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   450F                     220 flag_shoot_on:
   450F 3E 01         [ 7]  221    ld a, #1
   4511 32 A7 44      [13]  222    ld (flag_shoot), a
   4514 C9            [10]  223    ret
                            224 
                            225 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            226 ;; CAMBIA flag_shoot A 0 Y PERMITE DISPARAR MAS VECES AL PULSAR
                            227 ;; _______________________
                            228 ;; DESTRUYE: A
                            229 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4515                     230 flag_shoot_off:
   4515 3E 00         [ 7]  231    ld a, #0
   4517 32 A7 44      [13]  232    ld (flag_shoot), a
   451A C9            [10]  233    ret
                            234 
                            235 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            236 ;; INICIALIZA UNA ENTIDAD BULLET
                            237 ;; _______________________
                            238 ;; DESTRUYE: HL, A
                            239 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   451B                     240 bullet_init:
                            241    ;; Comprueba que solo se pueda disparar una vez por cada pulsacion de tecla
   451B 3A A7 44      [13]  242    ld a, (flag_shoot)               ;; A = flag_shoot
   451E FE 00         [ 7]  243    cp #0                            ;; A - 0 = A
   4520 20 09         [12]  244    jr nz, bullet_init_end           ;; Si flag_shoot == 1, vuelve
                            245 
   4522 21 5A 45      [10]  246    ld    hl,   #bullet_checkInit
   4525 CD 3A 45      [17]  247    call  bullet_search              ;; Llamada al bucle
   4528 CD 0F 45      [17]  248    call  flag_shoot_on              ;; Si llega aqui, es que se ha pulsado alguna tecla, entonces flag = ON
                            249 
...
Hexadecimal [16-Bits]
   ...
   452B                     250    bullet_init_end:
                            251    ;; Reset de los flags
   452B 3E 00         [ 7]  252    ld     a,   #0
   452D 32 93 44      [13]  253       ld (flag_init), a
   4530 32 A5 44      [13]  254       ld   (flag_vx), a
   4533 32 A6 44      [13]  255       ld   (flag_vy), a
   4536 32 A8 44      [13]  256       ld  (flag_key), a
   4539 C9            [10]  257    ret
                            258 
                            259 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            260 ;; RECORRE vector_bullets
                            261 ;; _______________________
                            262 ;; ENTRADA:    HL -> Puntero a funcion custom
                            263 ;; DESTRUYE:   A, DE, IX
                            264 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   453A                     265 bullet_search:
   453A DD 21 56 44   [14]  266    ld    ix,   #vector_init      ;; IX apunta al inicio de vector_bullets (a la primera entidad)
   453E 22 48 45      [16]  267    ld    (f_custom), hl          ;; Cargo en el call de abajo la funcion a la que quiero llamar en cada momento determinado
   4541                     268    search_loop:
   4541 DD 7E 00      [19]  269       ld     a,   0(ix)                ;; Compruebo que no he llegado al final del vector
   4544 FE FF         [ 7]  270       cp    #0xFF                      ;; A - 0xFF
   4546 C8            [11]  271       ret z                            ;; if(A==0xFF) -> Sale del vector
                            272 
                     00F4   273       f_custom = . +1                  ;; . apunta a 'call' y con el '+1' apunta a '(0x0000)' -> (siempre va a cambiar)
   4547 CD 00 00      [17]  274       call (0x0000)                    ;; LLAMADA A FUNCION PERSONALIZABLE
   454A 11 0A 00      [10]  275       ld    de,   #bullet_size          ;; Cargo en DE el tamanyo de la entidad bullet para despues sumarlo a HL
   454D DD 19         [15]  276       add   ix,   de                   ;; IX + DE = Apunta a la siguiente entidad bullet
   454F 18 F0         [12]  277    jr search_loop
                            278 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            279 ;; COMPROBAR SI EN LA ENTIDAD BULLET alive > 0
                            280 ;; _______________________
                            281 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            282 ;; DESTRUYE:   A
                            283 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4551                     284 bullet_checkDraw:
   4551 DD 7E 07      [19]  285    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   4554 FE 00         [ 7]  286    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
   4556 C4 BF 45      [17]  287    call  nz,   #dw_draw          ;; Llama a la funcion de dibujado
   4559 C9            [10]  288    ret
                            289 
                            290 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            291 ;; COMPROBAR SI EN LA ENTIDAD BULLET alive = 0
                            292 ;; _______________________
                            293 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            294 ;; DESTRUYE:   A, HL, DE, BC
                            295 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   455A                     296 bullet_checkInit:
   455A 3A 93 44      [13]  297    ld     a,   (flag_init)       ;; Si no se ha iniciado ninguna entidad bullet A==0
   455D FE 00         [ 7]  298    cp    #0
   455F C0            [11]  299    ret   nz                      ;; Si es 1 (1!=0), vuelve y no inicia mas entidades
                            300 
                            301    ;; Comprueba el atributo alive
   4560 DD 7E 07      [19]  302    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   4563 FE 00         [ 7]  303    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1 -> INICIALIZO
   4565 C0            [11]  304    ret   nz                      ;; Si ya esta inicializada, hago ret
...
Hexadecimal [16-Bits]
                            ...
                            305 
                            306    ;; REALIZA UNA COPIA DE LA ENTIDAD POR DEFECTO
   4566 DD E5         [15]  307    push  ix                      ;; Guardo IX en la pila
   4568 D1            [10]  308    pop   de                      ;; Entidad DESTINO
   4569 21 89 44      [10]  309    ld    hl,   #bullet_copy      ;; Entidad ORIGEN
   456C 01 0A 00      [10]  310    ld    bc,   #bullet_size      ;; Tamanyo de la entidad
   456F ED B0         [21]  311    ldir
                            312 
                            313    ;; Si debo cambiar algo de la entidad, aqui
   4571 CD 72 46      [17]  314    call hero_get_position        ;; A = hero_x // B = hero_y
   4574 DD 77 00      [19]  315    ld    b_x(ix), a              ;; Asigno X
   4577 DD 70 01      [19]  316    ld    b_y(ix), b              ;; Asigno Y
                            317 
   457A 3A A5 44      [13]  318    ld    a,    (flag_vx)         ;;
   457D DD 77 04      [19]  319    ld    b_vx(ix), a             ;; Asigno VX
   4580 3A A6 44      [13]  320    ld    a,    (flag_vy)         ;;
   4583 DD 77 05      [19]  321    ld    b_vy(ix), a             ;; Asigno VX
                            322 
   4586 3E 01         [ 7]  323    ld     a,   #1                ;; flag_init = 1
   4588 32 93 44      [13]  324    ld (flag_init), a             ;; YA NO SE PODRA INICIALIZAR NINGUNA ENTIDAD MAS
                            325                                  ;;   EN EL RECORRIDO DE ESTE BUCLE, AHORA MISMO
   458B C9            [10]  326    ret
                            327 
                            328 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            329 ;; LLAMA A CADA FUNCION DE ACTUALIZACION DE CADA ENTIDAD
                            330 ;; _______________________
                            331 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            332 ;; DESTRUYE:   HL, A
                            333 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   458C                     334 bullet_searchUpdate:
   458C DD 7E 07      [19]  335    ld     a,   b_alive(ix)       ;; Cargo el valor de alive en A
   458F FE 00         [ 7]  336    cp    #0                      ;; Si el valor es 0 y le resto 0 -> Z=1
   4591 C8            [11]  337    ret    z                      ;; Si no se ha inicialiado, poco podemos hacer
                            338 
   4592 DD 6E 08      [19]  339    ld l, b_up_l(ix)           ;; Carga el byte bajo en L
   4595 DD 66 09      [19]  340    ld h, b_up_h(ix)           ;; Carga el byte alto en H
   4598 E9            [ 4]  341    jp (hl)                    ;; Llama a la funcion propia de cada entidad
                            342 
                            343 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            344 ;; COMPROBAR SI EN LA ENTIDAD BULLET alive > 0 Y LO ACTUALIZO
                            345 ;; _______________________
                            346 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            347 ;; DESTRUYE:   A
                            348 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4599                     349 bullet_checkUpdate:
                            350    ;; UPDATE ALIVE
   4599 DD 35 07      [23]  351    dec   b_alive(ix)     ;; Decrementar el valor de alive y si llega a 1 matar la bala -> alive = 0
                            352 
                            353    ;; UPDATE POSICION
   459C DD 7E 00      [19]  354    ld     a,   b_x(ix)           ;; Cargo en A la posicion en X
   459F DD 86 04      [19]  355    add b_vx(ix)                  ;; Le aumento la velocidad en X
   45A2 DD 77 00      [19]  356    ld  b_x(ix), a                ;; Guardo el dato actualizado
                            357 
   45A5 DD 7E 01      [19]  358    ld     a,   b_y(ix)           ;; Cargo en A la posicion en Y
   45A8 DD 86 05      [19]  359    add b_vy(ix)                  ;; Le aumento la velocidad en Y
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 64.
Hexadecimal [16-Bits]



   45AB DD 77 01      [19]  360    ld  b_y(ix), a                ;; Guardo el dato actualizado
                            361 
   45AE C9            [10]  362    ret
                            363 
                            364 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            365 ;; CAMBIA EL COLOR DE LA BALA AL DEL FONDO (SI NO HAY SPRITES)
                            366 ;; _______________________
                            367 ;; ENTRADA:    IX -> Puntero a entidad BULLET
                            368 ;; DESTRUYE:
                            369 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
   45AF                     370 bullet_checkClear:
                            371    ;; SI NO HAY SPRITES!!!!!
   45AF DD 7E 06      [19]  372    ld      a,  b_col(ix)            ;; Guardo el valor del color actual en A
   45B2 08            [ 4]  373    ex    af',  af              ;;'  ;; Intercambio registros
   45B3 DD 36 06 00   [19]  374    ld b_col(ix),  #0                ;; Guardo el valor del color fondo en la entidad
                            375 
   45B7 CD 51 45      [17]  376    call bullet_checkDraw            ;; Llamo al draw
                            377 
   45BA 08            [ 4]  378    ex    af',  af              ;;'  ;; Vuelvo a cargar el color anterior
   45BB DD 77 06      [19]  379    ld b_col(ix),  a                 ;; Guardo el valor del color fondo original en la entidad
   45BE C9            [10]  380    ret
                            381 
                            382 
                            383 
